...
class Frame:
    ...
    @property
    def compute_command_buffer(self) -> CommandBuffer | None: ...
    ...
    @property
    def transfer_command_buffer(self) -> CommandBuffer | None: ...

class Window:
    def __init__(self, ctx: Context, title: str, width: int, height: int, x: int | None = None, y: int | None = None) -> None: ...
...
class Queue(GfxObject):
    ...
    def submit(self, command_buffer: CommandBuffer, wait_semaphores: Sequence[tuple[Semaphore, PipelineStageFlags]] = [], wait_timeline_values: Sequence[int] = [], signal_semaphores: Sequence[Semaphore] = [], signal_timeline_values: Sequence[int] = [], fence: Fence | None = None) -> None: ...

    def begin_label(self, name: str, color: tuple[float, float, float, float] | None = None) -> None: ...

    def end_label(self) -> None: ...

    def insert_label(self, name: str, color: tuple[float, float, float, float] | None = None) -> None: ...
...
class QueryPool(GfxObject):
    def __init__(self, ctx: Context, type: QueryType, count: int, name: str | None = None) -> None: ...
...
class Buffer(GfxObject):
    def __init__(self, ctx: Context, size: int, usage_flags: BufferUsageFlags, alloc_type: AllocType, name: str | None = None) -> None: ...
    ...
    @staticmethod
    def from_data(ctx: Context, data: object, usage_flags: BufferUsageFlags, alloc_type: AllocType, name: str | None = None) -> Buffer: ...
...
class Image(GfxObject):
    def __init__(self, ctx: Context, width: int, height: int, format: Format, usage_flags: ImageUsageFlags, alloc_type: AllocType, samples: int = 1, name: str | None = None) -> None: ...
    ...
    @staticmethod
    def from_data(ctx: Context, data: object, usage: ImageLayout, width: int, height: int, format: Format, usage_flags: ImageUsageFlags, alloc_type: AllocType, samples: int = 1, name: str | None = None) -> Image: ...
...
class AccelerationStructure(GfxObject):
    def __init__(self, ctx: Context, meshes: Sequence[AccelerationStructureMesh], prefer_fast_build: bool = False, name: str | None = None) -> None: ...
...
class Fence(GfxObject):
    def __init__(self, ctx: Context, signaled: bool = False, name: str | None = None) -> None: ...
...
class TimelineSemaphore(Semaphore):
    def __init__(self, ctx: Context, initial_value: int = 0, name: str | None = None) -> None: ...
...
class RenderingAttachment:
    def __init__(self, image: Image, load_op: LoadOp = LoadOp.LOAD, store_op: StoreOp = StoreOp.STORE, clear: Sequence[float] = [0.0, 0.0, 0.0, 0.0], resolve_image: Image | None = None, resolve_mode: ResolveMode = ResolveMode.NONE) -> None: ...
...
class CommandBuffer(GfxObject):
    def __init__(self, ctx: Context, queue_family_index: int | None = None, name: str | None = None) -> None: ...
    ...
    def image_barrier(self, image: Image, dst_layout: ImageLayout, src_usage: MemoryUsage, dst_usage: MemoryUsage, src_queue_family_index: int = 4294967295, dst_queue_family_index: int = 4294967295, aspect_mask: ImageAspectFlags = 1) -> None: ...

    def begin_rendering(self, render_area: Sequence[int], color_attachments: Sequence[RenderingAttachment], depth: DepthAttachment | None = None) -> None: ...

    def end_rendering(self) -> None: ...

    def rendering(self, render_area: Sequence[int], color_attachments: Sequence[RenderingAttachment], depth: DepthAttachment | None = None) -> RenderingManager: ...

    def set_viewport(self, viewport: Sequence[int]) -> None: ...

    def set_scissors(self, scissors: Sequence[int]) -> None: ...

    def bind_graphics_pipeline(self, pipeline: GraphicsPipeline, descriptor_sets: Sequence[DescriptorSet] = [], dynamic_offsets: Sequence[int] = [], push_constants: bytes | None = None, vertex_buffers: Sequence[Buffer] = [], index_buffer: Buffer | None = None) -> None: ...

    def bind_compute_pipeline(self, pipeline: ComputePipeline, descriptor_sets: Sequence[DescriptorSet] = [], dynamic_offsets: Sequence[int] = [], push_constants: bytes | None = None) -> None: ...
    ...
    def copy_image_to_buffer(self, image: Image, buffer: Buffer, buffer_offset: int = 0) -> None: ...

    def copy_buffer_to_image(self, buffer: Buffer, image: Image, buffer_offset: int = 0) -> None: ...

    def clear_color_image(self, image: Image, color: Sequence[float]) -> None: ...

    def clear_depth_stencil_image(self, image: Image, depth: float | None = None, stencil: int | None = None) -> None: ...

    def blit_image(self, src: Image, dst: Image) -> None: ...
...
class Shader(GfxObject):
    def __init__(self, ctx: Context, code: bytes, name: str | None = None) -> None: ...
...
class Rasterization:
    def __init__(self, polygon_mode: PolygonMode = PolygonMode.FILL, cull_mode: CullMode = 0, front_face: FrontFace = FrontFace.COUNTER_CLOCKWISE, depth_bias_enable: bool = False, depth_clamp_enable: bool = False, dynamic_line_width: bool = False, line_width: float = 1.0) -> None: ...
...
class DescriptorSet(GfxObject):
    def __init__(self, ctx: Context, entries: Sequence[DescriptorSetEntry], flags: DescriptorBindingFlags = 0, name: str | None = None) -> None: ...
    ...
    def write_image(self, image: Image, usage: ImageLayout, type: DescriptorType, binding: int, element: int = 0) -> None: ...
...
class PushConstantsRange:
    def __init__(self, size: int, offset: int = 0, stages: Stage = 2147483647) -> None: ...
...
class ComputePipeline(GfxObject):
    def __init__(self, ctx: Context, shader: Shader, entry: str = 'main', push_constants_ranges: Sequence[PushConstantsRange] = [], descriptor_sets: Sequence[DescriptorSet] = [], name: str | None = None) -> None: ...
