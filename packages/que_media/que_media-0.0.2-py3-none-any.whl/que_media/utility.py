...
class Utility(BaseSDK):
    ...
    def get_health_check(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.HealthzResponse, http_res)
    ...
    async def get_health_check_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def get_trust_list(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetTrustListResponse(
                result=unmarshal_json_response(models.TrustListResponse, http_res),
                headers={},
            )
    ...
    async def get_trust_list_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
