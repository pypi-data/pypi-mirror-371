...
gg_temp = edotv_prp / ( np.abs( np.sum(edotv_prl*dvprp*dvprl) + np.sum(edotv_prp*dvprp*dvprl) ) ) 
#Qprp_vprp = np.sum(edotv_prp*dvprl,axis=1) / ( np.abs( np.sum(edotv_prl*dvprp*dvprl) + np.sum(edotv_prp*dvprp*dvprl) ) )
if cooling_corr:
  ...
  gg_temp -= edotv_prp_corr / ( np.abs( np.sum(edotv_prl_corr*dvprp*dvprl) + np.sum(edotv_prp_corr*dvprp*dvprl) ) ) 
  #Qprp_vprp -= np.sum(edotv_prp_corr*dvprl,axis=1) / ( np.abs( np.sum(edotv_prl_corr*dvprp*dvprl) + np.sum(edotv_prp_corr*dvprp*dvprl) ) )
#else:
#  Qprp_vprp = np.sum(edotv_prp*dvprl,axis=1)/(np.abs(np.sum(edotv_prl*dvprp*dvprl))+np.abs(np.sum(edotv_prp*dvprp*dvprl))) 
Qprp_vprp = np.sum(gg_temp*dvprl,axis=1)


#normalize Qprp_sim (after or before coputing Dprpprp?)
...
for ialpha in range(0,10):
  ...
  if (ialpha < 9):
    #
    # beta = 1/9
    alphaU = 1. + ialpha*1./6. #2./3. + ialpha/3.
    alphaB = 1. + ialpha*1./6. #2./3. + ialpha/3.
    alphaPHI = 1. + ialpha*1./6. #2./3. + ialpha/3. 
    #
    # beta = 0.3
    alphaU03 = 1. + ialpha*1./6. #2./3. + ialpha/3. 
    alphaB03 = 1. + ialpha*1./6. #2./3. + ialpha/3. 
    alphaPHI03 = 1. + ialpha*1./6. #2./3. + ialpha/3. 
  else:
    #
    # beta = 1/9
    alphaU = kappaU01 #1.3
...
if (not jumptopaperplots): 
  ...
  ax5a.errorbar(kprp_rho_sim,Qprp_k_sim,fmt='-',yerr=0.5*stdQk01,color='k',linewidth=line_thick,elinewidth=line_thick-1,capsize=1,label=r'simulation')
  ax5a.fill_between(kprp_rho_sim,Qprp_k_sim-0.5*stdQk01,Qprp_k_sim+0.5*stdQk01,facecolor='grey',alpha=0.25)
  ...
  ax5b.errorbar(kprp_rho_sim,Qprp_k_sim,fmt='-',yerr=0.5*stdQk01,color='k',linewidth=line_thick,elinewidth=line_thick-1,capsize=1,label=r'simulation')
  ax5b.fill_between(kprp_rho_sim,Qprp_k_sim-0.5*stdQk01,Qprp_k_sim+0.5*stdQk01,facecolor='grey',alpha=0.25)
  ...
  ax5c.errorbar(kprp_rho_sim,Qprp_k_sim,fmt='-',yerr=0.5*stdQk01,color='k',linewidth=line_thick,elinewidth=line_thick-1,capsize=1,label=r'simulation')
  ax5c.fill_between(kprp_rho_sim,Qprp_k_sim-0.5*stdQk01,Qprp_k_sim+0.5*stdQk01,facecolor='grey',alpha=0.25)
  ...
  ax5d.errorbar(kprp_rho_sim,Qprp_k_sim,fmt='-',yerr=0.5*stdQk01,color='k',linewidth=line_thick,elinewidth=line_thick-1,capsize=1,label=r'simulation')
  ax5d.fill_between(kprp_rho_sim,Qprp_k_sim-0.5*stdQk01,Qprp_k_sim+0.5*stdQk01,facecolor='grey',alpha=0.25)
  ...
  ax5e.errorbar(kprp_rho_sim,Qprp_k_sim,fmt='-',yerr=0.5*stdQk01,color='k',linewidth=line_thick,elinewidth=line_thick-1,capsize=1,label=r'simulation')
  ax5e.fill_between(kprp_rho_sim,Qprp_k_sim-0.5*stdQk01,Qprp_k_sim+0.5*stdQk01,facecolor='grey',alpha=0.25)
  ...
  ax5f.errorbar(kprp_rho_sim,Qprp_k_sim,fmt='-',yerr=0.5*stdQk01,color='k',linewidth=line_thick,elinewidth=line_thick-1,capsize=1,label=r'simulation')
  ax5f.fill_between(kprp_rho_sim,Qprp_k_sim-0.5*stdQk01,Qprp_k_sim+0.5*stdQk01,facecolor='grey',alpha=0.25)
  ...
  ax5g.errorbar(kprp_rho_sim,Qprp_k_sim,fmt='-',yerr=0.5*stdQk01,color='k',linewidth=line_thick,elinewidth=line_thick-1,capsize=1,label=r'simulation')
  ax5g.fill_between(kprp_rho_sim,Qprp_k_sim-0.5*stdQk01,Qprp_k_sim+0.5*stdQk01,facecolor='grey',alpha=0.25)
  ...
  ax5h.errorbar(kprp_rho_sim,Qprp_k_sim,fmt='-',yerr=0.5*stdQk01,color='k',linewidth=line_thick,elinewidth=line_thick-1,capsize=1,label=r'simulation')
  ax5h.fill_between(kprp_rho_sim,Qprp_k_sim-0.5*stdQk01,Qprp_k_sim+0.5*stdQk01,facecolor='grey',alpha=0.25)
  ...
  ax5i.errorbar(kprp_rho_sim,Qprp_k_sim,fmt='-',yerr=0.5*stdQk01,color='k',linewidth=line_thick,elinewidth=line_thick-1,capsize=1,label=r'simulation')
  ax5i.fill_between(kprp_rho_sim,Qprp_k_sim-0.5*stdQk01,Qprp_k_sim+0.5*stdQk01,facecolor='grey',alpha=0.25)
...
ax1c.tick_params(labelsize=font_size)
plt.text(1.125*xr_min_w,1.2,r'(c)',va='bottom',ha='left',color='k',rotation=0,fontsize=font_size+1,weight='bold')
#
# beta = 0.1
# 
...
ax2c.set_yticklabels('')
ax2c.tick_params(labelsize=font_size)
plt.text(1.125*xr_min_w,1.2,r'(f)',va='bottom',ha='left',color='k',rotation=0,fontsize=font_size+1,weight='bold')
#--show and/or save
if output_figure:
  plt.tight_layout()
  flnm = "diffusion_2"
