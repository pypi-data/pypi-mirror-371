...
it0 = 125      # initial time index
it1 = 130      # final time index
...
for ind in range(it0,it1+1):
  ...
  Ekin3 = E3 - Emhd3
  #
  flnm_save = path_out+prob+".E1.totKINcontribution.DIFFmethod."+"%05d"%ind+".npy"
  np.save(flnm_save,Ekin1)
  print " * Ekin1 saved in -> ",flnm_save
  flnm_save = path_out+prob+".E2.totKINcontribution.DIFFmethod."+"%05d"%ind+".npy"
  np.save(flnm_save,Ekin2)
  print " * Ekin2 saved in -> ",flnm_save
  flnm_save = path_out+prob+".E3.totKINcontribution.DIFFmethod."+"%05d"%ind+".npy"
