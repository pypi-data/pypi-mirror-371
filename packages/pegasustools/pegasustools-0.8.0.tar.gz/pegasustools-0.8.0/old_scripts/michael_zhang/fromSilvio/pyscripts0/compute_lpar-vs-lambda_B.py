...
def get_lpar_vs_lperp(jj,niter,mm,path_in,path_out):
  ...
  outfileS2_b = "lpar_vs_lambda-b-S2."+"%d"%jj+".dat"
  outfileS2_bperp = "lpar_vs_lambda-bperp-S2."+"%d"%jj+".dat"
  outfileS2_bpar = "lpar_vs_lambda-bpar-S2."+"%d"%jj+".dat"
  outfileS4_b = "lpar_vs_lambda-b-S4."+"%d"%jj+".dat"
  outfileS4_bperp = "lpar_vs_lambda-bperp-S4."+"%d"%jj+".dat"
  outfileS4_bpar = "lpar_vs_lambda-bpar-S4."+"%d"%jj+".dat"
