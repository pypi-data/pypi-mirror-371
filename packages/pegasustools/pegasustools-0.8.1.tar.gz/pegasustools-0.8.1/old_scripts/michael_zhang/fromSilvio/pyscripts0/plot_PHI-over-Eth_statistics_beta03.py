...
props = dict(boxstyle='round,pad=0.3', facecolor='whitesmoke', alpha=1.0)
...
txt_xigauss_tot1_b = r'$\xi_{\mathrm{tot}}^{\mathrm{(rms)}}=\,$%.3f'%xirms_tot1
...
txt_xigauss_tot2_b = r'$\xi_{\mathrm{tot}}^{\mathrm{(rms)}}=\,$%.3f'%xirms_tot2
...
txt_xigauss_tot3_b = r'$\xi_{\mathrm{tot}}^{\mathrm{(rms)}}=\,$%.3f'%xirms_tot3
...
fig1.set_figheight((np.sqrt(5.0)-1.0)/2.0 * width*2.0)
fig1.set_figwidth(width)
grid = plt.GridSpec(6, 3, hspace=0.0, wspace=0.0)
#
...
ax1b.plot(binsPHItot3,pdfPHItot3,c=clr_phitot,ls=ls_phitot,alpha=alpha_phitot,label=lbl_phitot)
ax1b.plot(binsPHItot3,gaussPHItot3,c=clr_gaussd,alpha=alpha_gaussd,ls=ls_phitot_gauss)
#ax1b.plot(binsPHImhd3,pdfPHImhd3,c=clr_phimhd,ls=ls_phimhd,alpha=alpha_phimhd,label=lbl_phimhd)
#ax1b.plot(binsPHImhd3,gaussPHImhd3,c=clr_gaussd,alpha=alpha_gaussd,ls=ls_phimhd_gauss)
#ax1b.plot(binsPHIkin3,pdfPHIkin3,c=clr_phikin,ls=ls_phikin,alpha=alpha_phikin,label=lbl_phikin)
#ax1b.plot(binsPHIkin3,gaussPHIkin3,c=clr_gaussd,alpha=alpha_gaussd,ls=ls_phikin_gauss)
...
if output_figure:
  plt.tight_layout()
  flnm = "PDF_TWO-kprp-bands_PHIcomponents_Eth-norm_beta03"
...
if output_figure:
  plt.tight_layout()
  flnm = "PDF_kprp-band."+"%f"%kfmin1+"-"+"%f"%kfmax1+"_PHIcomponents_Eth-norm_beta03"
  path_output = path_save+flnm+fig_frmt
  plt.savefig(path_output,bbox_to_inches='tight')#,pad_inches=-1)
  plt.close()
  print " -> figure saved in:",path_output
...
if output_figure:
  plt.tight_layout()
  flnm = "PDF_kprp-band."+"%f"%kfmin1+"-"+"%f"%kfmax1+"_PHIcomponents_Eth-norm_beta03_B"
  path_output = path_save+flnm+fig_frmt
  plt.savefig(path_output,bbox_to_inches='tight')#,pad_inches=-1)
  plt.close()
  print " -> figure saved in:",path_output
...
if output_figure:
  plt.tight_layout()
  flnm = "PDF_kprp-band."+"%f"%kfmin2+"-"+"%f"%kfmax2+"_PHIcomponents_Eth-norm_beta03"
  path_output = path_save+flnm+fig_frmt
  plt.savefig(path_output,bbox_to_inches='tight')#,pad_inches=-1)
  plt.close()
  print " -> figure saved in:",path_output
...
if output_figure:
  plt.tight_layout()
  flnm = "PDF_kprp-band."+"%f"%kfmin2+"-"+"%f"%kfmax2+"_PHIcomponents_Eth-norm_beta03_B"
  path_output = path_save+flnm+fig_frmt
  plt.savefig(path_output,bbox_to_inches='tight')#,pad_inches=-1)
  plt.close()
  print " -> figure saved in:",path_output
...
if output_figure:
  plt.tight_layout()
  flnm = "PDF_kprp-band."+"%f"%kfmin3+"-"+"%f"%kfmax3+"_PHIcomponents_Eth-norm_beta03"
  path_output = path_save+flnm+fig_frmt
  plt.savefig(path_output,bbox_to_inches='tight')#,pad_inches=-1)
  plt.close()
  print " -> figure saved in:",path_output
...
if output_figure:
  plt.tight_layout()
  flnm = "PDF_kprp-band."+"%f"%kfmin3+"-"+"%f"%kfmax3+"_PHIcomponents_Eth-norm_beta03_B"
  path_output = path_save+flnm+fig_frmt
  plt.savefig(path_output,bbox_to_inches='tight')#,pad_inches=-1)
  plt.close()
  print " -> figure saved in:",path_output
...
if output_figure:
  plt.tight_layout()
  flnm = "PDF_PHIcomponents_manyscales_Eth-norm_beta03"
  path_output = path_save+flnm+fig_frmt
  plt.savefig(path_output,bbox_to_inches='tight')#,pad_inches=-1)
  plt.close()
  print " -> figure saved in:",path_output
