...
#  ##PHI_mhd
#  #
#  filename = base+"."+"%05d"%ii+".spectrum2d.nkperp"+"%d"%nkshells+".nkpara"+"%d"%nkpara+".linear.PHI.UxBcontribution.dat"
#  print "  ->",filename
...
#  ##PHI_hall
#  #
#  filename = base+"."+"%05d"%ii+".spectrum2d.nkperp"+"%d"%nkshells+".nkpara"+"%d"%nkpara+".linear.PHI.JxBcontribution.dat"
#  print "  ->",filename
#  data = np.loadtxt(filename)
#  print " shape of data -> ",np.shape(data)
#  #
...
#  PHIhallkprl = np.sum(PHIhallk2D,axis=0)
  ...
  ##PHI_kin
  #
  filename = base+"."+"%05d"%ii+".spectrum2d.nkperp"+"%d"%nkshells+".nkpara"+"%d"%nkpara+".linear.PHI.KINcontribution.dat"
  print "  ->",filename
  data = np.loadtxt(filename)
  print " shape of data -> ",np.shape(data)
  #
...
#  ##PHI_mhd
#  #
#  filename_out = base+"."+"%05d"%ii+".spectrum1d.nkperp"+"%d"%nkshells+".linear.PHI.UxBcontribution.dat"
...
#  #
#  filename_out = base+"."+"%05d"%ii+".spectrum1d.nkpara"+"%d"%(nkpara/2+1)+".linear.PHI.UxBcontribution.dat"
#  out = open(filename_out,'w+')
...
#  ##PHI_hall
#  #
#  filename_out = base+"."+"%05d"%ii+".spectrum1d.nkperp"+"%d"%nkshells+".linear.PHI.JxBcontribution.dat"
#  out = open(filename_out,'w+')
#  for i in range(nkshells):
#    out.write(str(kperp[i]))
#    out.write("\t")
...
#  print " -> file written in: ",filename_out
#  #
#  filename_out = base+"."+"%05d"%ii+".spectrum1d.nkpara"+"%d"%(nkpara/2+1)+".linear.PHI.JxBcontribution.dat"
#  out = open(filename_out,'w+')
#  for i in range(nkpara/2+1):
#    out.write(str(kpara[i]))
#    out.write("\t")
...
#  print " -> file written in: ",filename_out
  ...
  ##PHI_kin
  #
  filename_out = base+"."+"%05d"%ii+".spectrum1d.nkperp"+"%d"%nkshells+".linear.PHI.KINcontribution.dat"
  out = open(filename_out,'w+')
  for i in range(nkshells):
    out.write(str(kperp[i]))
    out.write("\t")
  ...
  print " -> file written in: ",filename_out
  #
  filename_out = base+"."+"%05d"%ii+".spectrum1d.nkpara"+"%d"%(nkpara/2+1)+".linear.PHI.KINcontribution.dat"
  out = open(filename_out,'w+')
  for i in range(nkpara/2+1):
    out.write(str(kpara[i]))
    out.write("\t")
