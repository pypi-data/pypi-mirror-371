...
exp_corr = True 
c0exp = 0.03 #0.01 #0.001 #1.0
c0exp03 = 0.03 #0.01 #0.001

#shaded area: +/- c_pm_std*sigma (sigma = standard dev.)
c_pm_std = 1.0 #0.5

#--parameters for final plot
kappaU01 = 1.25 #1.33 #1.25 #1.3 #1.2 
kappaB01 = 1.25 #1.33 #1.25 #1.3 #1.2 
kappaPHI01 = 1.25 #1.33 #1.25 #1.3 #1.2 
#
kappaU03 = 1. #1.15 #1.0 
kappaB03 = 1. #1.15 #1.0
kappaPHI03 = 1. #1.15 #1.0 
