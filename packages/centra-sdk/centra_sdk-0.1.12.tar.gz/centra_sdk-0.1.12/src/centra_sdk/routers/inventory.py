...
def get_labels(
    ...
    return registry.call_handler(get_labels.__name__, token, cursor, page_size)
...
def get_inventory(
    ...
    token = credentials.credentials if credentials else None
    return registry.call_handler(get_inventory.__name__, token, cursor, page_size)
...
def get_asset_id(
    ...
    token = credentials.credentials if credentials else None
    return registry.call_handler(get_asset_id.__name__, token, body)
