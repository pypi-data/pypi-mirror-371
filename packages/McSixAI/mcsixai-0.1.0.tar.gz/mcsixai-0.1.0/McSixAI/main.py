...
from McSixAI.openrouter import OpenRouterAPI
from McSixAI.file_manager import FileManager
from McSixAI.commands import CommandProcessor
from McSixAI.config import OPENROUTER_API_KEY
...
def main():
    ...
    while True:
        try:
            ...
            # Добавляем контекст проекта к запросу
            enhanced_input = user_input
            if any(word in user_input.lower() for word in ['проект', 'project', 'файл', 'file', 'код', 'code']):
