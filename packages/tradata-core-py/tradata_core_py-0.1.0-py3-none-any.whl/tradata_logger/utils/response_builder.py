...
class ResponseBuilder:
    ...
    def with_performance_headers(self, total_duration_ms: float, **kwargs) -> 'ResponseBuilder':
    ...
    def with_cache_headers(self, cache_hit: bool, cache_key: str = None, **kwargs) -> 'ResponseBuilder':
...
def create_response(
    ...
    **kwargs
    ...
    business_headers = {k: v for k, v in kwargs.items() 
