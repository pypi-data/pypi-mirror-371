"""Basic tests for logger functionality"""

import pytest
from tradata_logger import get_logger, setup_logging, ModernLogger
...
async def test_logger_client_operation():
    ...
    logger = get_logger("test")
    # This should not raise an exception
    await logger.log_client_operation("TestStep", "test_client", "test_operation", 100.0)
