...
class AtmosphericRoutines:
    ...
    async def calculate_lifted_index(
        ...
        #     ]
        # ):
        #     return 0  # Something in the middle
        #     # return None
        ...
        if missing:
            _LOGGER.warning(f"calculate_lifted_index: The following variables are None: {', '.join(missing)}")
            return None
    ...
    async def magnitude_degradation(
        ...
        #     ]
        # ):
        #     return 0.5  # Something in the middle
        #     # return None
        ...
        if missing:
            _LOGGER.warning(f"magnitude_degradation: The following variables are None: {', '.join(missing)}")
            return None
    ...
    async def calculate_seeing(
        ...
        #     ]
        # ):
        #     return 1.5  # Something in the middle since values are missing
        #     # return None
        ...
        if missing:
            _LOGGER.warning(f"calculate_seeing: The following variables are None: {', '.join(missing)}")
            return None
