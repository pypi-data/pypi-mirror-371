...
class CloneCommand(BaseCommand):
    def add_arguments(self, parser):
        ...
        parser_start.add_argument(
            "--host",
            type=str,
            help="Host URL for the API server (CLI > BASESHIFT_HOST > config, defaults to https://app.baseshift.io)",
        )
        parser_start.add_argument(
            "-v", "--verbose",
            action="store_true",
    ...
    def start(self, args, server):
        ...
        try:
            api_host = utils.get_config_value(
                args.host, "BASESHIFT_HOST", "host", default="https://app.baseshift.io"
            )
        except ValueError as e:
