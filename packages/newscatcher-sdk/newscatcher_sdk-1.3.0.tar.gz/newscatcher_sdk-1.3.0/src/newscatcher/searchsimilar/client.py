...
from .raw_client import AsyncRawSearchsimilarClient, RawSearchsimilarClient
...
class SearchsimilarClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawSearchsimilarClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawSearchsimilarClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        RawSearchsimilarClient
        """
...
class AsyncSearchsimilarClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawSearchsimilarClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawSearchsimilarClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawSearchsimilarClient
        """
        return self._raw_client
