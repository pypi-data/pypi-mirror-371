...
class LatestheadlinesClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawLatestheadlinesClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawLatestheadlinesClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        RawLatestheadlinesClient
        """
...
class AsyncLatestheadlinesClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawLatestheadlinesClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawLatestheadlinesClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawLatestheadlinesClient
        """
        return self._raw_client
