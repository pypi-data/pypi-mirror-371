...
class BreakingNewsArticleEntity(UniversalBaseModel):
    """
    ...
    all_links: typing.Optional[BreakingNewsArticleEntityAllLinks] = pydantic.Field(default=None)
    """
    A list of all URLs mentioned in the article.
    """

    all_domain_links: typing.Optional[BreakingNewsArticleEntityAllDomainLinks] = pydantic.Field(default=None)
    """
