...
HUNDRED_WAD = BigInt(100000000000000000000)
...
class LogExpMath:
    ...
    MAX_NATURAL_EXPONENT = BigInt(130000000000000000000)
    MIN_NATURAL_EXPONENT = BigInt(-41000000000000000000)

    # Bounds for ln_36's argument. Both ln(0.9) and ln(1.1) can be represented with 36 decimal places in a fixed point
    # 256 bit integer.
    LN_36_LOWER_BOUND = BigInt(WAD - 100000000000000000)
    LN_36_UPPER_BOUND = BigInt(WAD + 100000000000000000)

    # MILD_EXPONENT_BOUND = 2 ** 254 / HUNDRED_WAD
    # Precomputed value of the above expression
    MILD_EXPONENT_BOUND = BigInt(
        289480223093290488558927462521719769633174961664101410098
    )

    # 18 decimal constants
    x0 = BigInt(128000000000000000000)  # 2ˆ7
    a0 = BigInt(
        38877084059945950922200000000000000000000000000000000000
    )  # eˆ(x0) (no decimals)
    x1 = BigInt(64000000000000000000)  # 2ˆ6
    a1 = BigInt(6235149080811616882910000000)  # eˆ(x1) (no decimals)

    # 20 decimal constants
    x2 = BigInt(3200000000000000000000)  # 2ˆ5
    a2 = BigInt(7896296018268069516100000000000000)  # eˆ(x2)
    x3 = BigInt(1600000000000000000000)  # 2ˆ4
    a3 = BigInt(888611052050787263676000000)  # eˆ(x3)
    x4 = BigInt(800000000000000000000)  # 2ˆ3
    a4 = BigInt(298095798704172827474000)  # eˆ(x4)
    x5 = BigInt(400000000000000000000)  # 2ˆ2
    a5 = BigInt(5459815003314423907810)  # eˆ(x5)
    x6 = BigInt(200000000000000000000)  # 2ˆ1
    a6 = BigInt(738905609893065022723)  # eˆ(x6)
    x7 = BigInt(100000000000000000000)  # 2ˆ0
    a7 = BigInt(271828182845904523536)  # eˆ(x7)
    x8 = BigInt(50000000000000000000)  # 2ˆ-1
    a8 = BigInt(164872127070012814685)  # eˆ(x8)
    x9 = BigInt(25000000000000000000)  # 2ˆ-2
    a9 = BigInt(128402541668774148407)  # eˆ(x9)
    x10 = BigInt(12500000000000000000)  # 2ˆ-3
    a10 = BigInt(113314845306682631683)  # eˆ(x10)
    x11 = BigInt(6250000000000000000)  # 2ˆ-4
    a11 = BigInt(106449445891785942956)  # eˆ(x11)
    ...
    def exp(x_: BigInt) -> BigInt:
        ...
        term = (term * x) // HUNDRED_WAD // BigInt(2)
        series_sum += term

        term = (term * x) // HUNDRED_WAD // BigInt(3)
        series_sum += term

        term = (term * x) // HUNDRED_WAD // BigInt(4)
        series_sum += term

        term = (term * x) // HUNDRED_WAD // BigInt(5)
        series_sum += term

        term = (term * x) // HUNDRED_WAD // BigInt(6)
        series_sum += term

        term = (term * x) // HUNDRED_WAD // BigInt(7)
        series_sum += term

        term = (term * x) // HUNDRED_WAD // BigInt(8)
        series_sum += term

        term = (term * x) // HUNDRED_WAD // BigInt(9)
        series_sum += term

        term = (term * x) // HUNDRED_WAD // BigInt(10)
        series_sum += term

        term = (term * x) // HUNDRED_WAD // BigInt(11)
        series_sum += term

        term = (term * x) // HUNDRED_WAD // BigInt(12)
        series_sum += term
        ...
        return (product * series_sum) // HUNDRED_WAD * first_an // BigInt(100)

    @staticmethod
    def _ln_36(x_: BigInt) -> BigInt:
        x = x_
        ...
        return series_sum * BigInt(2)

    @staticmethod
    def _ln(a_: BigInt) -> BigInt:
        a = a_
        if a < WAD:
            ...
            return BigInt(-1) * LogExpMath._ln((WAD * WAD) // a)
        ...
        if a >= LogExpMath.a0 * WAD:
            a = a // LogExpMath.a0  # Integer, not fixed point division
            sum_var += LogExpMath.x0

        if a >= LogExpMath.a1 * WAD:
            a = a // LogExpMath.a1  # Integer, not fixed point division
        ...
        return (sum_var + series_sum) // BigInt(100)
