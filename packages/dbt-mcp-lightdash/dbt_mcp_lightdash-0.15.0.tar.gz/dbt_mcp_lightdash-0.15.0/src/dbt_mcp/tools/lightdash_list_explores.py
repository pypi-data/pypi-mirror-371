...
async def handle_lightdash_list_explores(
    ...
    try:
        ...
        result_text += "\nNext steps:\n"
        result_text += "1. Use lightdash_list_metrics to see available metrics\n"
        result_text += "2. Use lightdash_get_dimensions to see dimensions for chosen metrics\n"
        result_text += "3. Use lightdash_query_metrics to run your analysis"
