...
from cotlette.core.checks import Error, Warning
from cotlette.core.checks.urls import check_resolver
from cotlette.core.exceptions import ImproperlyConfigured
from cotlette.utils.datastructures import MultiValueDict
from cotlette.utils.functional import cached_property
from cotlette.utils.http import RFC3986_SUBDELIMS, escape_leading_slashes
from cotlette.utils.regex_helper import _lazy_re_compile, normalize
from cotlette.utils.translation import get_language
...
def _route_to_regex(route, is_endpoint):
    ...
    and {'pk': <cotlette.urls.converters.IntConverter>}.
    """
    parts = ["^"]
        ...
        if "(?P<" in route or route.startswith("^") or route.endswith("$"):
            warnings.append(
                Warning(
                    ...
                    "when migrating to cotlette.urls.path().".format(self.describe()),
                    id="2_0.W001",
                )
            )
        return warnings
...
class URLPattern:
    ...
    def _check_callback(self):
        from cotlette.views import View
...
class URLResolver:
    ...
    def resolve_error_handler(self, view_type):
        ...
        if not callback:
            ...
            # cotlette.conf.urls imports this file.
            from cotlette.conf import urls
