...
# without having to first configure Cotlette, and (2) if some other code creates
...
class Trans:
    ...
    def __getattr__(self, real_name):
        ...
        if settings.USE_I18N:
            from cotlette.utils.translation import trans_real as trans
            from cotlette.utils.translation.reloader import (
            ...
            from cotlette.utils.translation import trans_null as trans
