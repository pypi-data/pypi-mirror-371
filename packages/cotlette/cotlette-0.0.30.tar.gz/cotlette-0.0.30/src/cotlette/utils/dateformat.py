...
from cotlette.utils.dates import (
    MONTHS,
    MONTHS_3,
    MONTHS_ALT,
    MONTHS_AP,
...
from cotlette.utils.timezone import (
    _datetime_ambiguous_or_imaginary,
    get_default_timezone,
    is_naive,
    make_aware,
)
from cotlette.utils.translation import gettext as _
...
class TimeFormat(Formatter):
    def __init__(self, obj):
        ...
        if isinstance(obj, datetime):
            ...
            # objects (against established cotlette policy).
            if is_naive(obj):
