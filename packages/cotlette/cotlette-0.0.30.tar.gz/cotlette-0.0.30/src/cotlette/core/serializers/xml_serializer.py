...
from cotlette.core.serializers import base
from cotlette.db import DEFAULT_DB_ALIAS, models
from cotlette.utils.xmlutils import SimplerXMLGenerator, UnserializableContentError
...
class Serializer(base.Serializer):
    ...
    def start_serialization(self):
        ...
        self.xml.startElement("cotlette-objects", {"version": "1.0"})
    ...
    def end_serialization(self):
        ...
        """
        self.indent(0)
        self.xml.endElement("cotlette-objects")
