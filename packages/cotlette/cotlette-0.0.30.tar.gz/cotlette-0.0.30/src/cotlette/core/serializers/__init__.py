...
from cotlette.core.serializers.base import SerializerDoesNotExist

# Built-in serializers
BUILTIN_SERIALIZERS = {
    "xml": "cotlette.core.serializers.xml_serializer",
    "python": "cotlette.core.serializers.python",
    "json": "cotlette.core.serializers.json",
    "yaml": "cotlette.core.serializers.pyyaml",
    "jsonl": "cotlette.core.serializers.jsonl",
}
