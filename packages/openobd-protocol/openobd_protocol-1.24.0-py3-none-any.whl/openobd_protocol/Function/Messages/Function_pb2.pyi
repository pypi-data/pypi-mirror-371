...
class VehicleList(_message.Message):
    __slots__ = ("vehicle",)
    VEHICLE_FIELD_NUMBER: _ClassVar[int]
    vehicle: _containers.RepeatedCompositeFieldContainer[Vehicle]
    def __init__(self, vehicle: _Optional[_Iterable[_Union[Vehicle, _Mapping]]] = ...) -> None: ...
