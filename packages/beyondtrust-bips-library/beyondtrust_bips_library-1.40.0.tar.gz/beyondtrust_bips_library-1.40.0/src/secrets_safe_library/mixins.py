...
class GetByIdMixin:
    ...
    def get_by_id(self, object_id: str, include_api_version=False) -> dict:
        """
...
class ListByKeyMixin:
    ...
    def list_by_key(self, key: str, value: str) -> list | dict:
        ...
        utils.print_log(
            self._logger, f"Calling list_by_key endpoint: {endpoint}", logging.DEBUG
        )
...
class DeleteByIdMixin:
    ...
    def delete_by_id(
        ...
        utils.print_log(
            self._logger, f"Calling delete_by_id endpoint: {endpoint}", logging.DEBUG
        )
...
class DeleteByKeyMixin:
    ...
    def delete_by_key(
        ...
        utils.print_log(
            self._logger, f"Calling delete_by_key endpoint: {endpoint}", logging.DEBUG
        )
