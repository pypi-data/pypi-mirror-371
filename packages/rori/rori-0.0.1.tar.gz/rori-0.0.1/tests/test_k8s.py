...
def test_kubernetes_port_forward_initialization(mock_kubernetes_config):
    ...
    from pof.k8s import KubernetesPortForward
...
@patch("pof.k8s.client.CoreV1Api")
...
@patch("pof.k8s.config.load_kube_config")
...
@patch("pof.k8s.config.list_kube_config_contexts")
