...
class Prereq:
    ...
    def parse_codes(self, parsable):
        ...
        for code, replacement in reversed(codes):
            while (
                True
            ):  # This is to overcome the problem with modifying a list as you iterate over it, kind of a hack but it works
    ...
    def __init__(self, prereq_str):
        ...
        self.prereqs = []
        self.subs = {"credit_count": "", "ForU": "", "for_special_program": ""}
