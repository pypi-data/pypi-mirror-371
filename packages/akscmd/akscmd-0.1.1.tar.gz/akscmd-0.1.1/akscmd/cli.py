...
DEFAULT_MODEL = os.getenv("AKSCMD_MODEL", "gemini-1.5-flash-latest")
API_KEY = os.getenv("AKSCMD_API_KEY") or os.getenv("AKSCMD_GEMINI_API_KEY") or os.getenv("GEMINI_API_KEY")
