...
class PrivateState(PClass):
    private_score = field(type=PrivatePlayerScore)
    ...
    def __todict__(self):
        return {
            "private_score": self.private_score.__todict__(),
    ...
    def __fromdict__(d):
        return PrivateState(
            private_score=PrivatePlayerScore.__fromdict__(d["private_score"]),
...
def getprivatestate(s, player_idx):
    ...
    return PrivateState(
        private_score=getprivateplayerscore(s, s.player_scores[player_idx]),
        player=s.players[player_idx],
