...
setup(
    ...
    description="Type annotations for boto3 QLDB 1.40.16 service generated with mypy-boto3-builder 8.11.0",
    classifiers=[
    ...
    keywords="boto3 qldb boto3-stubs type-annotations mypy typeshed autocomplete",
