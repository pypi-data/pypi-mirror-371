...
class GemGemRemote(BaseModel):
    ...
    prereleases: Optional[StrictBool] = False
    includes: Optional[Dict[str, Optional[StrictStr]]] = None
    excludes: Optional[Dict[str, Optional[StrictStr]]] = None
    __properties: ClassVar[List[str]] = ["name", "url", "ca_cert", "client_cert", "client_key", "tls_validation", "proxy_url", "proxy_username", "proxy_password", "username", "password", "pulp_labels", "download_concurrency", "max_retries", "policy", "total_timeout", "connect_timeout", "sock_connect_timeout", "sock_read_timeout", "headers", "rate_limit", "prereleases", "includes", "excludes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prereleases": obj.get("prereleases") if obj.get("prereleases") is not None else False,
