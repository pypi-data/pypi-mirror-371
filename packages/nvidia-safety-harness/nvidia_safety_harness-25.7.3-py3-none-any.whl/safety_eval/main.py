...
from safety_eval.aegis_v2 import handle_aegis_v2
from safety_eval.configs import LlamaNemoguardConfig, ModelConfig, WildguardConfig
from safety_eval.wildguard import handle_wildguard
...
def evaluate():
    ...
    if args.eval == "aegis_v2":
        ...
        handle_aegis_v2(model_config, judge_config, output_file, limit=args.limit)
