...
def s3_mapper(curr_env: Env) -> Env:
    return _s3filestore_compat(_s3_minio(_s3_clevercloud_cellar(curr_env)))


def _s3_clevercloud_cellar(curr_env: Env) -> Env:
    """ """
    return curr_env + {
...
def _s3_minio(curr_env: Env) -> Env:
    """ """
    return curr_env + {
...
def _s3filestore_compat(curr_env: Env) -> Env:
    """ """
    return curr_env + {
