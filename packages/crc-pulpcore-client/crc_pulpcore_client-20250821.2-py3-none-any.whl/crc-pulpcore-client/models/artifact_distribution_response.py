...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hidden", "pulp_created", "pulp_href", "pulp_labels", "base_url", "pulp_last_updated", "content_guard", "no_content_change_since", "name", "prn", "base_path"]
