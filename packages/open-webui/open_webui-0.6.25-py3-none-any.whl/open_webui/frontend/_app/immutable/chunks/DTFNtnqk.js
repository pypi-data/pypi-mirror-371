import{p as U}from"./Bf5Q4FCn.js";import{Y as y,P as z,aH as j,E as H,o as K,p as Y,s as Z,g as q,c as J,b as Q,_ as p,l as F,v as X,d as tt,F as et,K as at,a5 as rt,k as nt}from"./B5ZtvdYd.js";import{p as it}from"./BO25W81T.js";import{d as O}from"./C4mi25TV.js";import{o as st}from"./CmKTTxBW.js";function ot(t,a){return a<t?-1:a>t?1:a>=t?0:NaN}function lt(t){return t}function ct(){var t=lt,a=ot,h=null,o=y(0),g=y(z),x=y(0);function i(e){var r,l=(e=j(e)).length,c,A,m=0,u=new Array(l),n=new Array(l),v=+o.apply(this,arguments),w=Math.min(z,Math.max(-z,g.apply(this,arguments)-v)),f,T=Math.min(Math.abs(w)/l,x.apply(this,arguments)),$=T*(w<0?-1:1),d;for(r=0;r<l;++r)(d=n[u[r]=r]=+t(e[r],r,e))>0&&(m+=d);for(a!=null?u.sort(function(S,C){return a(n[S],n[C])}):h!=null&&u.sort(function(S,C){return h(e[S],e[C])}),r=0,A=m?(w-l*$)/m:0;r<l;++r,v=f)c=u[r],d=n[c],f=v+(d>0?d*A:0)+$,n[c]={data:e[c],index:r,value:d,startAngle:v,endAngle:f,padAngle:T};return n}return i.value=function(e){return arguments.length?(t=typeof e=="function"?e:y(+e),i):t},i.sortValues=function(e){return arguments.length?(a=e,h=null,i):a},i.sort=function(e){return arguments.length?(h=e,a=null,i):h},i.startAngle=function(e){return arguments.length?(o=typeof e=="function"?e:y(+e),i):o},i.endAngle=function(e){return arguments.length?(g=typeof e=="function"?e:y(+e),i):g},i.padAngle=function(e){return arguments.length?(x=typeof e=="function"?e:y(+e),i):x},i}var R=H.pie,G={sections:new Map,showData:!1,config:R},b=G.sections,P=G.showData,ut=structuredClone(R),pt=p(()=>structuredClone(ut),"getConfig"),gt=p(()=>{b=new Map,P=G.showData,X()},"clear"),dt=p(({label:t,value:a})=>{b.has(t)||(b.set(t,a),F.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ft=p(()=>b,"getSections"),ht=p(t=>{P=t},"setShowData"),mt=p(()=>P,"getShowData"),I={getConfig:pt,clear:gt,setDiagramTitle:K,getDiagramTitle:Y,setAccTitle:Z,getAccTitle:q,setAccDescription:J,getAccDescription:Q,addSection:dt,getSections:ft,setShowData:ht,getShowData:mt},vt=p((t,a)=>{U(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),St={parse:p(async t=>{const a=await it("pie",t);F.debug(a),vt(a,I)},"parse")},yt=p(t=>`
  .pieCircle{
...
//# sourceMappingURL=DTFNtnqk.js.map
