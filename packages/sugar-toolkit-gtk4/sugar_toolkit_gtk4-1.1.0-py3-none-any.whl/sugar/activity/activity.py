...
**Derive from the class**
    ...
    class.  See :class:`~sugar.bundle` for bundle metadata.

**Create a ToolbarBox**

    In your :func:`__init__` method create a
    :class:`~sugar.graphics.toolbarbox.ToolbarBox`, with an
    :class:`~sugar.activity.widgets.ActivityToolbarButton`, a
    :class:`~sugar.activity.widgets.StopButton`, and then call
    :func:`~sugar.graphics.window.Window.set_toolbar_box`.
...
**Journal methods**
    ...
    :func:`~sugar.activity.activity.Activity.read_file()` and
    :func:`~sugar.activity.activity.Activity.write_file()` methods.
    ...
    :func:`~sugar.activity.activity.Activity.read_file()` and
    :func:`~sugar.activity.activity.Activity.write_file()` will be
...
**Activity toolbars**
    ...
    :class:`~sugar.graphics.toolbarbox.ToolbarBox`, so that the
    :class:`~sugar.activity.widgets.StopButton` is aligned to the
    right.

    There are a number of standard Toolbars.

    You may need the :class:`~sugar.activity.widgets.EditToolbar`.
    This has copy and paste buttons.  You may derive your own
    class from
    :class:`~sugar.activity.widgets.EditToolbar`:
    ...
    See :class:`~sugar.activity.widgets.EditToolbar` for the
...
from sugar.profile import get_color, get_save_as
...
class Activity(Window):
    ...
    Args:
        handle (:class:`~sugar.activity.activityhandle.ActivityHandle`):
    ...
    **Signals:**
    ...
    def get_max_participants(self):
        ...
        See also
        :func:`~sugar.bundle.activitybundle.ActivityBundle.get_max_participants`
        in :class:`~sugar.bundle.activitybundle.ActivityBundle`.
        """
    ...
    def get_id(self):
        ...
        See also
        :meth:`~sugar.activity.activityfactory.create_activity_id`
        and :meth:`~sugar.util.unique_id`.
        """
    ...
    def get_preview(self):
        ...
        :attr:`~sugar.activity.activity.PREVIEW_SIZE` pixels.
    ...
    def get_shared_activity(self):
        ...
        :class:`sugar.presence.activity.Activity`, or None if the
        activity is not shared, or is shared and not yet joined.

        Returns:
            :class:`sugar.presence.activity.Activity`: instance of
    ...
    def share(self, private=False):
        ...
        :attr:`sugar.presence.activity.Activity` class.
        """
        raise NotImplementedError(
