...
class TestPowerBreakdownForecastResponse(unittest.TestCase):
    """PowerBreakdownForecastResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PowerBreakdownForecastResponse:
        """Test PowerBreakdownForecastResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PowerBreakdownForecastResponse`
        """
        model = PowerBreakdownForecastResponse()
        if include_optional:
            return PowerBreakdownForecastResponse(
                zone = '',
                data = [
    ...
    def testPowerBreakdownForecastResponse(self):
        """Test PowerBreakdownForecastResponse"""
