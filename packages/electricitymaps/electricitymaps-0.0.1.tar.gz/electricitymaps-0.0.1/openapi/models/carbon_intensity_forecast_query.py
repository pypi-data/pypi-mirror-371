...
class CarbonIntensityForecastQuery(BaseModel):
    """
    ...
    horizon_hours: Optional[Union[StrictFloat, StrictInt]] = Field(default=24, description="The number of hours ahead to forecast.", alias="horizonHours")
    environment: Optional[ForecastEnvironment] = None
    __properties: ClassVar[List[str]] = ["temporalGranularity", "zoneKey", "lat", "lon", "dataCenterProvider", "dataCenterRegion", "disableCallerLookup", "horizonHours", "environment"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CarbonIntensityForecastQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CarbonIntensityForecastQuery from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "horizonHours": obj.get("horizonHours") if obj.get("horizonHours") is not None else 24,
