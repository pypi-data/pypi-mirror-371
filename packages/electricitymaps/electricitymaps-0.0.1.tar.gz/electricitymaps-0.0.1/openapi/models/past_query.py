...
class PastQuery(BaseModel):
    ...
    PastQuery
    """ # noqa: E501
    dt: StrictStr = Field(description="The datetime to get the data for. By default this needs to be the specific hour unless another temporal granularity is requested.", alias="datetime")
    ...
    __properties: ClassVar[List[str]] = ["datetime", "temporalGranularity", "zoneKey", "lat", "lon", "dataCenterProvider", "dataCenterRegion", "disableCallerLookup", "disableEstimations", "emissionFactorType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PastQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PastQuery from a dict"""
        if obj is None:
            return None
