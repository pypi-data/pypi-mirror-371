...
class HistoryQuery(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["temporalGranularity", "zoneKey", "lat", "lon", "dataCenterProvider", "dataCenterRegion", "disableCallerLookup", "disableEstimations", "emissionFactorType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HistoryQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HistoryQuery from a dict"""
        if obj is None:
            return None
