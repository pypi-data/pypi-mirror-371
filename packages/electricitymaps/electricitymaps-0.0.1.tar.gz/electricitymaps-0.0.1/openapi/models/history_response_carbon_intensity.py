...
class HistoryResponseCarbonIntensity(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HistoryResponseCarbonIntensity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HistoryResponseCarbonIntensity from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "zone": obj.get("zone"),
            "history": [CarbonIntensity.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None,
