...
class NetLoadAPI:
    ...
    def get_net_load_forecast(
        ...
        Get the net load forecast for a zone
        ...
        _param = self._get_net_load_forecast_serialize(
    ...
    @validate_call
    def get_net_load_forecast_with_http_info(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
    ...
    @validate_call
    def get_net_load_forecast_without_preload_content(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
    ...
    def _get_net_load_forecast_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/net-load/forecast',
    ...
    def get_net_load_history(
        ...
        Get the last 24 hours of net load for a zone
        ...
        _param = self._get_net_load_history_serialize(
            temporal_granularity=temporal_granularity,
            zone_key=zone_key,
            lat=lat,
            lon=lon,
    ...
    @validate_call
    def get_net_load_history_with_http_info(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
    ...
    @validate_call
    def get_net_load_history_without_preload_content(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
    ...
    def _get_net_load_history_serialize(
        self,
        temporal_granularity,
        zone_key,
        lat,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/net-load/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_net_load_latest(
        ...
        Get the latest net load for a zone
        ...
        _param = self._get_net_load_latest_serialize(
            temporal_granularity=temporal_granularity,
            zone_key=zone_key,
            lat=lat,
            lon=lon,
    ...
    @validate_call
    def get_net_load_latest_with_http_info(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
    ...
    @validate_call
    def get_net_load_latest_without_preload_content(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
    ...
    def _get_net_load_latest_serialize(
        self,
        temporal_granularity,
        zone_key,
        lat,
    ...
    def get_net_load_past(
        ...
        Get the net load for a zone at a given datetime
        ...
        _param = self._get_net_load_past_serialize(
            dt=dt,
            temporal_granularity=temporal_granularity,
            zone_key=zone_key,
            lat=lat,
    ...
    @validate_call
    def get_net_load_past_with_http_info(
        self,
        dt: Annotated[StrictStr, Field(description="The datetime to get the data for. By default this needs to be the specific hour unless another temporal granularity is requested.")],
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
    ...
    @validate_call
    def get_net_load_past_without_preload_content(
        self,
        dt: Annotated[StrictStr, Field(description="The datetime to get the data for. By default this needs to be the specific hour unless another temporal granularity is requested.")],
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
    ...
    def _get_net_load_past_serialize(
        self,
        dt,
        temporal_granularity,
        zone_key,
    ...
    def get_net_load_past_range(
        ...
        Get the net load for a zone at a given datetime range
        ...
        _param = self._get_net_load_past_range_serialize(
            start=start,
            end=end,
            temporal_granularity=temporal_granularity,
            zone_key=zone_key,
    ...
    @validate_call
    def get_net_load_past_range_with_http_info(
        self,
        start: Annotated[StrictStr, Field(description="The start datetime to get the data for.")],
        end: Annotated[StrictStr, Field(description="The end datetime to get the data for.")],
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
    ...
    @validate_call
    def get_net_load_past_range_without_preload_content(
        self,
        start: Annotated[StrictStr, Field(description="The start datetime to get the data for.")],
        end: Annotated[StrictStr, Field(description="The end datetime to get the data for.")],
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
    ...
    def _get_net_load_past_range_serialize(
        self,
        start,
        end,
        temporal_granularity,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/net-load/past-range',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
