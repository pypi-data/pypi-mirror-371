...
class PriceDayAheadAPI:
    ...
    @validate_call
    def get_price_day_ahead_forecast(
        self,
        ...
        Get the price day ahead forecast for a zone
        ...
        _param = self._get_price_day_ahead_forecast_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PriceDayAheadForecastResponse",
            '400': "InputError",
    ...
    @validate_call
    def get_price_day_ahead_forecast_with_http_info(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PriceDayAheadForecastResponse]:
        """Price Day Ahead Forecast
    ...
    @validate_call
    def get_price_day_ahead_forecast_without_preload_content(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
    ...
    def _get_price_day_ahead_forecast_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/price-day-ahead/forecast',
    ...
    @validate_call
    def get_price_day_ahead_history(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
        ...
        Get the last 24 hours of price day ahead for a zone
        ...
        _param = self._get_price_day_ahead_history_serialize(
            temporal_granularity=temporal_granularity,
            zone_key=zone_key,
            lat=lat,
            lon=lon,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "HistoryResponsePriceDayAhead",
            '400': "InputError",
            '401': "UnauthorizedError",
            '404': "NoDataError",
        }
    ...
    @validate_call
    def get_price_day_ahead_history_with_http_info(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HistoryResponsePriceDayAhead]:
        """Price Day Ahead History
    ...
    @validate_call
    def get_price_day_ahead_history_without_preload_content(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
    ...
    def _get_price_day_ahead_history_serialize(
        self,
        temporal_granularity,
        zone_key,
        lat,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/price-day-ahead/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_price_day_ahead_latest(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
        ...
        Get the latest price day ahead for a zone
        ...
        _param = self._get_price_day_ahead_latest_serialize(
            temporal_granularity=temporal_granularity,
            zone_key=zone_key,
            lat=lat,
            lon=lon,
    ...
    @validate_call
    def get_price_day_ahead_latest_with_http_info(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
    ...
    @validate_call
    def get_price_day_ahead_latest_without_preload_content(
        self,
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        lat: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Latitude of the location to get the data for.")] = None,
    ...
    def _get_price_day_ahead_latest_serialize(
        self,
        temporal_granularity,
        zone_key,
        lat,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/price-day-ahead/latest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_price_day_ahead_past(
        ...
        Get the price day ahead for a zone at a given datetime
        ...
        _param = self._get_price_day_ahead_past_serialize(
            dt=dt,
            temporal_granularity=temporal_granularity,
            zone_key=zone_key,
            lat=lat,
    ...
    @validate_call
    def get_price_day_ahead_past_with_http_info(
        self,
        dt: Annotated[StrictStr, Field(description="The datetime to get the data for. By default this needs to be the specific hour unless another temporal granularity is requested.")],
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PastResponsePriceDayAhead]:
        """Price Day Ahead Past
    ...
    @validate_call
    def get_price_day_ahead_past_without_preload_content(
        self,
        dt: Annotated[StrictStr, Field(description="The datetime to get the data for. By default this needs to be the specific hour unless another temporal granularity is requested.")],
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        zone_key: Annotated[Optional[StrictStr], Field(description="An Electricity Maps zone key.")] = None,
    ...
    def _get_price_day_ahead_past_serialize(
        self,
        dt,
        temporal_granularity,
        zone_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/price-day-ahead/past',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_price_day_ahead_past_range(
        self,
        ...
        Get the price day ahead for a zone at a given datetime range
        ...
        _param = self._get_price_day_ahead_past_range_serialize(
            start=start,
            end=end,
            temporal_granularity=temporal_granularity,
            zone_key=zone_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PastRangeResponsePriceDayAhead",
            '400': "InputError",
            '401': "UnauthorizedError",
            '404': "NoDataError",
        }
    ...
    @validate_call
    def get_price_day_ahead_past_range_with_http_info(
        self,
        start: Annotated[StrictStr, Field(description="The start datetime to get the data for.")],
        end: Annotated[StrictStr, Field(description="The end datetime to get the data for.")],
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PastRangeResponsePriceDayAhead]:
        """Price Day Ahead Past Range
    ...
    @validate_call
    def get_price_day_ahead_past_range_without_preload_content(
        self,
        start: Annotated[StrictStr, Field(description="The start datetime to get the data for.")],
        end: Annotated[StrictStr, Field(description="The end datetime to get the data for.")],
        temporal_granularity: Annotated[Optional[TemporalGranularity], Field(description="The temporal granularity of the data to get.")] = None,
    ...
    def _get_price_day_ahead_past_range_serialize(
        self,
        start,
        end,
        temporal_granularity,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/price-day-ahead/past-range',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
