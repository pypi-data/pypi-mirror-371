...
class TestFileFileRemoteResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FileFileRemoteResponse:
        """Test FileFileRemoteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileFileRemoteResponse`
        """
        model = FileFileRemoteResponse()
        if include_optional:
            return FileFileRemoteResponse(
                ...
                rate_limit = 56,
                hidden_fields = [
                    crc-pulp_file-client.models.file_file_remote_response_hidden_fields_inner.file_FileRemoteResponse_hidden_fields_inner(
                        name = '', 
                        is_set = True, )
                    ]
            )
