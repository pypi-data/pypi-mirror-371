...
class TestPaginatedfileFileRepositoryResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedfileFileRepositoryResponseList:
        """Test PaginatedfileFileRepositoryResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedfileFileRepositoryResponseList`
        """
        model = PaginatedfileFileRepositoryResponseList()
        if include_optional:
            return PaginatedfileFileRepositoryResponseList(
                ...
                results = [
                    crc-pulp_file-client.models.file/file_repository_response.file.FileRepositoryResponse(
                        pulp_href = '', 
                        prn = '', 
