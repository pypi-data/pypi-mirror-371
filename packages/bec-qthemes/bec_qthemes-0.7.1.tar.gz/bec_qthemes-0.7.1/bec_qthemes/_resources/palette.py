...
def q_palette(
    ...
    if not for_stylesheet:
        # base
        palette.setColor(
            QPalette.ColorRole.WindowText, _mk_q_color("{{ foreground|color|palette }}")
        )
        palette.setColor(
            QPalette.ColorRole.Button,
            _mk_q_color("{{ treeSectionHeader.background|color|palette }}"),
        )
        ...
        palette.setColor(
            ...
            _mk_q_color('{{ background|color(state="popup")|palette }}'),
        )
        palette.setColor(
            QPalette.ColorRole.ToolTipText, _mk_q_color("{{ foreground|color|palette }}")
        )
