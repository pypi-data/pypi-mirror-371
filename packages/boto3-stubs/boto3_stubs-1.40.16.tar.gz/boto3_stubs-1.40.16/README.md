...
Type annotations for [boto3 1.40.16](https://pypi.org/project/boto3/)
...
- `boto3-stubs[full]` - Type annotations for all 415 services in one package
  (recommended).
- `boto3-stubs[all]` - Type annotations for all 415 services in separate
  packages.
