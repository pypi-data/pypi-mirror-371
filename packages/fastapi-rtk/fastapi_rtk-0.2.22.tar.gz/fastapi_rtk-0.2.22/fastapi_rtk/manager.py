    ...
    async def oauth_callback(
        ...
        *,
        ...
        try:
            ...
            try:
                ...
                if on_before_register:
                    ...
                    user_dict = await self._handle_role_keys(
                        user_dict, user_dict.pop("role_keys", None)
                    )
                ...
                if on_after_register:
                    ...
                    user = await self._handle_role_keys(
                        user, user_dict.pop("role_keys", None)
                    )
        ...
        if on_before_login:
            ...
            user = await self._handle_role_keys(user, user_dict.pop("role_keys", None))
        return user
