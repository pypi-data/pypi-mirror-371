...
from soa_kafka_python.utils.schema_registry_utils import SchemaRegistryHTTPClient
from soa_kafka_python.utils.serialization_utils import AvroSerializer
...
class BaseKafkaConsumer(ABC):
    ...
    def __init__(self, consumer_id: str, partitions: Optional[List[int]] = None):
        ...
        self.bootstrap_servers = "kafka-soa-dev-kafka-bootstrap.dev.svc:9092"
