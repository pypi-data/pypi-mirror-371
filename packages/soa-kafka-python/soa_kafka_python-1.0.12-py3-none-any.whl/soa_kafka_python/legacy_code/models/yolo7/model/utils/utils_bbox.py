...
def DecodeBox(outputs,
            ...
            input_shape,
            #-----------------------------------------------------------#
            #   13x13 feature:anchor [116,90],[156,198],[373,326]
            #   26x26 feature:anchor [30,61],[62,45],[59,119]
            #   52x52 feature:anchor [10,13],[16,30],[33,23]
            #-----------------------------------------------------------#
    ...
    # tf.print(boxes)
    # tf.print(tf.reduce_max(box_confidence))
    # tf.print(box_class_probs)
