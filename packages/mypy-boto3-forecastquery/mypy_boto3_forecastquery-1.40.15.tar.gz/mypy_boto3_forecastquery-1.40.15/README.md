...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-forecastquery)](https://pypistats.org/packages/mypy-boto3-forecastquery)
...
`mypy-boto3-forecastquery` dependency in production. However, there is an issue
