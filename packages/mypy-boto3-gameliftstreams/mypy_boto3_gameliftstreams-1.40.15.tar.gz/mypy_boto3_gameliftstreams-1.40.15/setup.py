"""
Setup script for mypy-boto3-gameliftstreams.
...
setup(
    ...
    version="1.40.15",
    packages=["mypy_boto3_gameliftstreams"],
    url="https://github.com/youtype/mypy_boto3_builder",
    license="MIT License",
    author="Vlad Emelianov",
    author_email="vlad.emelianov.nz@gmail.com",
    description="Type annotations for boto3 GameLiftStreams 1.40.15 service generated with mypy-boto3-builder 8.11.0",
    classifiers=[
    ...
    package_data={"mypy_boto3_gameliftstreams": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
