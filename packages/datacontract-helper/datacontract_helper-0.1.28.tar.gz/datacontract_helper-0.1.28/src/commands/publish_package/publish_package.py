...
class PublishPackage(CommandBase):
    ...
    def create_proto_from_yaml(self):
        ...
        """
        # command: str = """echo "$(uv run datacontract export vertica_datacontract.yaml --format protobuf | perl -0777 -nle "print \$1 if /'protobuf':\\s*'(.*?)'/s" )" > vertica_datacontract.proto"""
