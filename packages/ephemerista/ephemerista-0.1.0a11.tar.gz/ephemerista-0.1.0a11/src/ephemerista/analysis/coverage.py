    ...
    def plot(
        ...
        **kwargs,
        ...
        return self.plot_plotly(
            data_to_plot=data_to_plot, mapbox_style=mapbox_style, zoom=zoom, opacity=opacity, **kwargs
        )
    ...
    def plot_plotly(
        ...
        **kwargs,
        ...
        try:
            ...
            fig.update_layout(
                mapbox={"style": mapbox_style, "center": {"lat": center_lat, "lon": center_lon}, "zoom": zoom},
