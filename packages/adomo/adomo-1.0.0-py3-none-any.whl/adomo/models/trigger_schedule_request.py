...
class TriggerScheduleRequest(BaseModel):
    """
    Request model for triggering a schedule immediately.
    """  # noqa: E501

    overlap_policy: Optional[StrictStr] = Field(
        default="allow_all", description="Policy for handling overlapping executions"
    )
    __properties: ClassVar[List[str]] = ["overlap_policy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TriggerScheduleRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TriggerScheduleRequest from a dict"""
        if obj is None:
            return None
