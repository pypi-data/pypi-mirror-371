...
class ActivityStatementInput(BaseModel):
    """
    ActivityStatementInput
    """  # noqa: E501

    activity: ActivityInvocationInput
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActivityStatementInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActivityStatementInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "activity": (
                    ActivityInvocationInput.from_dict(obj["activity"])
