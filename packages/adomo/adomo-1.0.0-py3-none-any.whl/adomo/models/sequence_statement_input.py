...
class SequenceStatementInput(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SequenceStatementInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SequenceStatementInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "sequence": (
                    SequenceInput.from_dict(obj["sequence"])
...
SequenceStatementInput.model_rebuild(raise_errors=False)
