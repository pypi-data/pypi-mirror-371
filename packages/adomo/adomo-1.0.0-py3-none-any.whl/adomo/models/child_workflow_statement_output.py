...
class ChildWorkflowStatementOutput(BaseModel):
    """
    ChildWorkflowStatementOutput
    """  # noqa: E501

    workflow: ChildWorkflowInvocationOutput
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChildWorkflowStatementOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChildWorkflowStatementOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "workflow": (
                    ChildWorkflowInvocationOutput.from_dict(obj["workflow"])
