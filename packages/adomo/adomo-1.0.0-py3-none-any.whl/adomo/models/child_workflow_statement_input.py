...
class ChildWorkflowStatementInput(BaseModel):
    """
    ChildWorkflowStatementInput
    """  # noqa: E501

    workflow: ChildWorkflowInvocationInput
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChildWorkflowStatementInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChildWorkflowStatementInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "workflow": (
                    ChildWorkflowInvocationInput.from_dict(obj["workflow"])
