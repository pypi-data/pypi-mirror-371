...
class TestScheduleActionExecutionStartWorkflow(unittest.TestCase):
    """ScheduleActionExecutionStartWorkflow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleActionExecutionStartWorkflow:
        """Test ScheduleActionExecutionStartWorkflow
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ScheduleActionExecutionStartWorkflow`
        """
        model = ScheduleActionExecutionStartWorkflow()
        if include_optional:
    ...
    def testScheduleActionExecutionStartWorkflow(self):
        """Test ScheduleActionExecutionStartWorkflow"""
