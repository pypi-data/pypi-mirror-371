...
class TestChildWorkflowStatementOutput(unittest.TestCase):
    """ChildWorkflowStatementOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChildWorkflowStatementOutput:
        """Test ChildWorkflowStatementOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ChildWorkflowStatementOutput`
        """
        model = ChildWorkflowStatementOutput()
        if include_optional:
            return ChildWorkflowStatementOutput(
    ...
    def testChildWorkflowStatementOutput(self):
        """Test ChildWorkflowStatementOutput"""
