...
class TestMcpStdioConfig(unittest.TestCase):
    """McpStdioConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> McpStdioConfig:
        """Test McpStdioConfig
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `McpStdioConfig`
        """
        model = McpStdioConfig()
        if include_optional:
