...
class TestScheduleIntervalSpec(unittest.TestCase):
    """ScheduleIntervalSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleIntervalSpec:
        """Test ScheduleIntervalSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ScheduleIntervalSpec`
        """
        model = ScheduleIntervalSpec()
        if include_optional:
    ...
    def testScheduleIntervalSpec(self):
        """Test ScheduleIntervalSpec"""
