...
class TestAgentConfigInput(unittest.TestCase):
    """AgentConfigInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentConfigInput:
        """Test AgentConfigInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AgentConfigInput`
        """
        model = AgentConfigInput()
        if include_optional:
