...
class TestSequenceInput(unittest.TestCase):
    """SequenceInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SequenceInput:
        """Test SequenceInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SequenceInput`
        """
        model = SequenceInput()
        if include_optional:
