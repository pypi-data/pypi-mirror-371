...
class TestParallelInput(unittest.TestCase):
    """ParallelInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParallelInput:
        """Test ParallelInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ParallelInput`
        """
        model = ParallelInput()
        if include_optional:
