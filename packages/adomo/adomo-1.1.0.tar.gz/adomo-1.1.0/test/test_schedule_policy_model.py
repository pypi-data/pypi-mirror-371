...
class TestSchedulePolicyModel(unittest.TestCase):
    """SchedulePolicyModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SchedulePolicyModel:
        """Test SchedulePolicyModel
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SchedulePolicyModel`
        """
        model = SchedulePolicyModel()
        if include_optional:
            return SchedulePolicyModel(
                overlap = 'skip',
                catchup_window = '',
    ...
    def testSchedulePolicyModel(self):
        """Test SchedulePolicyModel"""
