...
class TestSleepStatementInput(unittest.TestCase):
    """SleepStatementInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SleepStatementInput:
        """Test SleepStatementInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SleepStatementInput`
        """
        model = SleepStatementInput()
        if include_optional:
            return SleepStatementInput(
    ...
    def testSleepStatementInput(self):
        """Test SleepStatementInput"""
