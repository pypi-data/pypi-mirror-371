...
class TestScheduleStateModel(unittest.TestCase):
    """ScheduleStateModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleStateModel:
        """Test ScheduleStateModel
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ScheduleStateModel`
        """
        model = ScheduleStateModel()
        if include_optional:
    ...
    def testScheduleStateModel(self):
        """Test ScheduleStateModel"""
