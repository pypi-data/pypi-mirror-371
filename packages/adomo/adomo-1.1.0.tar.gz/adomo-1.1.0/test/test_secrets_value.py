...
class TestSecretsValue(unittest.TestCase):
    """SecretsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SecretsValue:
        """Test SecretsValue
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SecretsValue`
        """
        model = SecretsValue()
        if include_optional:
            return SecretsValue(
