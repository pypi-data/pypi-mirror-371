...
class TestConditionStatementOutput(unittest.TestCase):
    """ConditionStatementOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConditionStatementOutput:
        """Test ConditionStatementOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ConditionStatementOutput`
        """
        model = ConditionStatementOutput()
        if include_optional:
            return ConditionStatementOutput(
    ...
    def testConditionStatementOutput(self):
        """Test ConditionStatementOutput"""
