...
class ScheduleListInfo(BaseModel):
    """
    ScheduleListInfo
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["recent_actions", "next_action_times"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduleListInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduleListInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "recent_actions": (
                    [
                        ScheduleActionResult.from_dict(_item)
