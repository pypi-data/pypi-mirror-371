...
class ModelField(BaseModel):
    ...
    type: Optional[FieldType] = Field(default=None, description="type of the field")
    required: Optional[StrictBool] = Field(
        default=False, description="field is required"
    )
    nullable: Optional[StrictBool] = Field(
        default=True, description="field can be empty"
    )
