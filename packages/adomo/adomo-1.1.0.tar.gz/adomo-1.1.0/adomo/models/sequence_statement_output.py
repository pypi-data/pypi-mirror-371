...
class SequenceStatementOutput(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SequenceStatementOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SequenceStatementOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "sequence": (
                    SequenceOutput.from_dict(obj["sequence"])
...
SequenceStatementOutput.model_rebuild(raise_errors=False)
