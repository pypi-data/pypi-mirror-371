...
class ParallelInput(BaseModel):
    ...
    branches: List[ParallelInputBranchesInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ParallelInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ParallelInput from a dict"""
        if obj is None:
            return None
...
ParallelInput.model_rebuild(raise_errors=False)
