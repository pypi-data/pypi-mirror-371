...
class ConditionStatementOutput(BaseModel):
    """
    ConditionStatementOutput
    """  # noqa: E501

    condition: ConditionInvocationOutput
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConditionStatementOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConditionStatementOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "condition": (
                    ConditionInvocationOutput.from_dict(obj["condition"])
