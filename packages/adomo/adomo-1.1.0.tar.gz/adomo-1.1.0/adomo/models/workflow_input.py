...
class WorkflowInput(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dsl
        if self.dsl:
            _dict["dsl"] = self.dsl.to_dict()
        # set to None if description (nullable) is None
        # and model_fields_set contains the field
        if self.description is None and "description" in self.model_fields_set:
            _dict["description"] = None

        # set to None if dsl (nullable) is None
        # and model_fields_set contains the field
        if self.dsl is None and "dsl" in self.model_fields_set:
            _dict["dsl"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "dsl": (
                    Dsl.from_dict(obj["dsl"]) if obj.get("dsl") is not None else None
                ),
            }
        )
        return _obj
