...
from adomo.configuration import Configuration
from adomo.api_response import ApiResponse, T as ApiResponseT
import adomo.models
from adomo import rest
from adomo.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(adomo.models, klass)
