...
class SequenceOutput(BaseModel):
    ...
    elements: List[ParallelOutputBranchesInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SequenceOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SequenceOutput from a dict"""
        if obj is None:
            return None
...
SequenceOutput.model_rebuild(raise_errors=False)
