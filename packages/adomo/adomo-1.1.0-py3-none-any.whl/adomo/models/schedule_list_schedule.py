...
class ScheduleListSchedule(BaseModel):
    """
    ...
    state: Optional[Any]
    __properties: ClassVar[List[str]] = ["action", "spec", "state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduleListSchedule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduleListSchedule from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "action": (
                    ScheduleListActionStartWorkflow.from_dict(obj["action"])
