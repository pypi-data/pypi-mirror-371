...
class ConditionStatementInput(BaseModel):
    """
    ConditionStatementInput
    """  # noqa: E501

    condition: ConditionInvocationInput
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConditionStatementInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConditionStatementInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "condition": (
                    ConditionInvocationInput.from_dict(obj["condition"])
