...
class SleepStatementInput(BaseModel):
    """
    SleepStatementInput
    """  # noqa: E501

    sleep: SleepInvocationInput
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SleepStatementInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SleepStatementInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "sleep": (
                    SleepInvocationInput.from_dict(obj["sleep"])
