...
class GraphqlApi:
    ...
    def handle_http_post_graphql_post(
        ...
        _param = self._handle_http_post_graphql_post_serialize(
    ...
    @validate_call
    def handle_http_post_graphql_post_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def handle_http_post_graphql_post_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _handle_http_post_graphql_post_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
