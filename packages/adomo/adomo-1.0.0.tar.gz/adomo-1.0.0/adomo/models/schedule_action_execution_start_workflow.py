...
class ScheduleActionExecutionStartWorkflow(BaseModel):
    """
    ScheduleActionExecutionStartWorkflow
    """  # noqa: E501

    workflow_id: StrictStr
    first_execution_run_id: StrictStr
    __properties: ClassVar[List[str]] = ["workflow_id", "first_execution_run_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduleActionExecutionStartWorkflow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduleActionExecutionStartWorkflow from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "first_execution_run_id": obj.get("first_execution_run_id"),
            }
        )
        return _obj
