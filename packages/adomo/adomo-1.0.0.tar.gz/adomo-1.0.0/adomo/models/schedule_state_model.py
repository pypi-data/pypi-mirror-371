...
class ScheduleStateModel(BaseModel):
    """
    Model for schedule state.
    """  # noqa: E501

    note: Optional[StrictStr] = None
    paused: Optional[StrictBool] = False
    limited_actions: Optional[StrictBool] = False
    remaining_actions: Optional[StrictInt] = 0
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduleStateModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduleStateModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "limited_actions": (
                    obj.get("limited_actions")
                    if obj.get("limited_actions") is not None
                    else False
                ),
                "remaining_actions": (
                    obj.get("remaining_actions")
                    if obj.get("remaining_actions") is not None
                    else 0
                ),
            }
        )
