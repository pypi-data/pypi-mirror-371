...
class SleepStatementOutput(BaseModel):
    """
    SleepStatementOutput
    """  # noqa: E501

    sleep: SleepInvocationOutput
    __properties: ClassVar[List[str]] = ["sleep"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SleepStatementOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SleepStatementOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "sleep": (
                    SleepInvocationOutput.from_dict(obj["sleep"])
