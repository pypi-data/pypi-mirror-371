...
class StartWorkflowExecutionResponse(BaseModel):
    ...
    run_id: StrictStr
    type: StrictStr
    status: Optional[Annotated[List[Any], Field(min_length=2, max_length=2)]]
    __properties: ClassVar[List[str]] = ["id", "run_id", "type", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartWorkflowExecutionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartWorkflowExecutionResponse from a dict"""
        if obj is None:
            return None
