...
class ActivityStatementOutput(BaseModel):
    """
    ActivityStatementOutput
    """  # noqa: E501

    activity: ActivityInvocationOutput
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActivityStatementOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActivityStatementOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "activity": (
                    ActivityInvocationOutput.from_dict(obj["activity"])
