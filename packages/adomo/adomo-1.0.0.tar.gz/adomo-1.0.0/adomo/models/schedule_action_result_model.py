...
class ScheduleActionResultModel(BaseModel):
    """
    Model for schedule action results.
    """  # noqa: E501

    scheduled_at: datetime
    started_at: datetime
    action: ScheduleActionExecutionStartWorkflowModel
    __properties: ClassVar[List[str]] = ["scheduled_at", "started_at", "action"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduleActionResultModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduleActionResultModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "action": (
                    ScheduleActionExecutionStartWorkflowModel.from_dict(obj["action"])
