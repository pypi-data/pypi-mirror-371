...
class TestSequenceOutput(unittest.TestCase):
    """SequenceOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SequenceOutput:
        """Test SequenceOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SequenceOutput`
        """
        model = SequenceOutput()
        if include_optional:
