...
class TestActivityInvocationOutput(unittest.TestCase):
    """ActivityInvocationOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityInvocationOutput:
        """Test ActivityInvocationOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ActivityInvocationOutput`
        """
        model = ActivityInvocationOutput()
        if include_optional:
    ...
    def testActivityInvocationOutput(self):
        """Test ActivityInvocationOutput"""
