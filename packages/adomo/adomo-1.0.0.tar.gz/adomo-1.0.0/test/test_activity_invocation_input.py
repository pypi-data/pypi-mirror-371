...
class TestActivityInvocationInput(unittest.TestCase):
    """ActivityInvocationInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityInvocationInput:
        """Test ActivityInvocationInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ActivityInvocationInput`
        """
        model = ActivityInvocationInput()
        if include_optional:
            return ActivityInvocationInput(
                id = '',
                name = '',
                description = '',
                arguments = [
    ...
    def testActivityInvocationInput(self):
        """Test ActivityInvocationInput"""
