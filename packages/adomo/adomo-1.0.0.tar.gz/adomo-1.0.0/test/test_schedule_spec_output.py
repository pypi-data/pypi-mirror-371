...
class TestScheduleSpecOutput(unittest.TestCase):
    """ScheduleSpecOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleSpecOutput:
        """Test ScheduleSpecOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ScheduleSpecOutput`
        """
        model = ScheduleSpecOutput()
        if include_optional:
            return ScheduleSpecOutput(
                calendars = [
    ...
    def testScheduleSpecOutput(self):
        """Test ScheduleSpecOutput"""
