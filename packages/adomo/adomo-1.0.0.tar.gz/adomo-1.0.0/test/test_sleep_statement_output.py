...
class TestSleepStatementOutput(unittest.TestCase):
    """SleepStatementOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SleepStatementOutput:
        """Test SleepStatementOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SleepStatementOutput`
        """
        model = SleepStatementOutput()
        if include_optional:
            return SleepStatementOutput(
    ...
    def testSleepStatementOutput(self):
        """Test SleepStatementOutput"""
