...
class TestStateInput(unittest.TestCase):
    """StateInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StateInput:
        """Test StateInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StateInput`
        """
        model = StateInput()
        if include_optional:
            return StateInput(
