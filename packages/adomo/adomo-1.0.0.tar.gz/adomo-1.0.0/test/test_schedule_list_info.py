...
class TestScheduleListInfo(unittest.TestCase):
    """ScheduleListInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleListInfo:
        """Test ScheduleListInfo
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ScheduleListInfo`
        """
        model = ScheduleListInfo()
        if include_optional:
