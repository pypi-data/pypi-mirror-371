...
class TestParallelStatementOutput(unittest.TestCase):
    """ParallelStatementOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParallelStatementOutput:
        """Test ParallelStatementOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ParallelStatementOutput`
        """
        model = ParallelStatementOutput()
        if include_optional:
            return ParallelStatementOutput(
    ...
    def testParallelStatementOutput(self):
        """Test ParallelStatementOutput"""
