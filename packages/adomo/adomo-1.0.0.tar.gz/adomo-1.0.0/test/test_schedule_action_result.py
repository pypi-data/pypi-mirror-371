...
class TestScheduleActionResult(unittest.TestCase):
    """ScheduleActionResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleActionResult:
        """Test ScheduleActionResult
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ScheduleActionResult`
        """
        model = ScheduleActionResult()
        if include_optional:
    ...
    def testScheduleActionResult(self):
        """Test ScheduleActionResult"""
