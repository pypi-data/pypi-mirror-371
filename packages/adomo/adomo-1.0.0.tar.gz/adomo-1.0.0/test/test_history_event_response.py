...
class TestHistoryEventResponse(unittest.TestCase):
    """HistoryEventResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HistoryEventResponse:
        """Test HistoryEventResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HistoryEventResponse`
        """
        model = HistoryEventResponse()
        if include_optional:
    ...
    def testHistoryEventResponse(self):
        """Test HistoryEventResponse"""
