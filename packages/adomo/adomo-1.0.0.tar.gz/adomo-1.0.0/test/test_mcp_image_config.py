...
class TestMcpImageConfig(unittest.TestCase):
    """McpImageConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> McpImageConfig:
        """Test McpImageConfig
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `McpImageConfig`
        """
        model = McpImageConfig()
        if include_optional:
            return McpImageConfig(
                image = '',
