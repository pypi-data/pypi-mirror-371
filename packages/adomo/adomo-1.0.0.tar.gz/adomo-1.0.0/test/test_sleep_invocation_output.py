...
class TestSleepInvocationOutput(unittest.TestCase):
    """SleepInvocationOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SleepInvocationOutput:
        """Test SleepInvocationOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SleepInvocationOutput`
        """
        model = SleepInvocationOutput()
        if include_optional:
            return SleepInvocationOutput(
                id = None,
                delay = 1.337
            )
        else:
    ...
    def testSleepInvocationOutput(self):
        """Test SleepInvocationOutput"""
