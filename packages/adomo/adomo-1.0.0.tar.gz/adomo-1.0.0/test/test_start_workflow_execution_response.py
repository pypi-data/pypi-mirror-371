...
class TestStartWorkflowExecutionResponse(unittest.TestCase):
    """StartWorkflowExecutionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartWorkflowExecutionResponse:
        """Test StartWorkflowExecutionResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StartWorkflowExecutionResponse`
        """
        model = StartWorkflowExecutionResponse()
        if include_optional:
    ...
    def testStartWorkflowExecutionResponse(self):
        """Test StartWorkflowExecutionResponse"""
