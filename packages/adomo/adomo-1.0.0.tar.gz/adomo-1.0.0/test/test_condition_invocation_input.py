...
class TestConditionInvocationInput(unittest.TestCase):
    """ConditionInvocationInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConditionInvocationInput:
        """Test ConditionInvocationInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ConditionInvocationInput`
        """
        model = ConditionInvocationInput()
        if include_optional:
            return ConditionInvocationInput(
                id = '',
                fn = '',
                timeout = None,
                timeout_summary = ''
    ...
    def testConditionInvocationInput(self):
        """Test ConditionInvocationInput"""
