...
#yes | pkg update -y && pkg upgrade -y && pkg install python-pip -y && pkg install x11-repo -y && pkg install tur-repo -y && pkg install chromium -y && pkg install python python-pip tmate android-tools libjpeg-turbo libpng zlib tesseract opencv-python -y && pip install pycountry phonenumbers uiautomator requests Pillow pytesseract telethon setuptools mailosaur names selenium==4.9.1 beautifulsoup4 2captcha-python
