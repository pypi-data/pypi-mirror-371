...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-apigatewaymanagementapi)](https://pypistats.org/packages/mypy-boto3-apigatewaymanagementapi)
...
`mypy-boto3-apigatewaymanagementapi` dependency in production. However, there
