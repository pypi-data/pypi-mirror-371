...
def test_configure_for_streaming_usage():
    ...
    assert invoke.configure_for_streaming_usage({"abc": "def"}) == {
        "abc": "def",
        "stream_options": {"include_usage": True},
    }

    assert invoke.configure_for_streaming_usage(
        {"abc": "def", "stream_options": {}}
    ) == {"abc": "def", "stream_options": {"include_usage": True}}

    assert invoke.configure_for_streaming_usage(
        {"abc": "def", "stream_options": {"include_usage": False}}
    ) == {"abc": "def", "stream_options": {"include_usage": True}}
