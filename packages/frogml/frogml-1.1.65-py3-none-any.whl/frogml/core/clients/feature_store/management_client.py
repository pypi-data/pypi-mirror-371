...
from frogml._proto.qwak.feature_store.v1.internal.data_source.data_source_service_pb2_grpc import (
...
class FeatureRegistryClient:
    ...
    def list_feature_sets(self) -> ListFeatureSetsResponse:
        ...
        try:
            ...
            raise FrogmlException(f"Failed to list features, error is {e.details()}")
    ...
    def delete_feature_set(self, feature_set_id: str) -> DeleteFeatureSetResponse:
        ...
        try:
            ...
            raise FrogmlException(f"Failed to delete feature, error is {e.details()}")
    ...
    def delete_entity(self, entity_id: str) -> DeleteEntityResponse:
        ...
        try:
            ...
            raise FrogmlException(f"Failed to delete entity, error is {e.details()}")
    ...
    def delete_data_source(self, data_source_id: str) -> DeleteDataSourceResponse:
        ...
        try:
            ...
            raise FrogmlException(
                f"Failed to delete data source, error is {e.details()}"
            )
    ...
    def run_feature_set(self, feature_set_name: str) -> RunBatchFeatureSetResponse:
        ...
        try:
            ...
            raise FrogmlException(f"Failed to run feature, error is {e.details()}")
    ...
    def update_entity(
        ...
        try:
            ...
            raise FrogmlException(f"Failed to update entity, error is {e.details()}")
    ...
    def create_entity(self, proto_entity_spec: EntitySpec) -> CreateEntityResponse:
        ...
        try:
            ...
            raise FrogmlException(f"Failed to create entity, error is {e.details()}")
    ...
    def list_entities(self) -> ListEntitiesResponse:
        ...
        try:
            ...
            raise FrogmlException(f"Failed to list entities, error is {e.details()}")
    ...
    def list_data_sources(self) -> ListDataSourcesResponse:
        ...
        try:
            ...
            raise FrogmlException(
                f"Failed to list data sources, error is {e.details()}"
            )
    ...
    def update_data_source(
        ...
        try:
            ...
            raise FrogmlException(
                f"Failed to update data source, error is {e.details()}"
            )
    ...
    def create_data_source(
        ...
        try:
            ...
            raise FrogmlException(
                f"Failed to create data source, error is {e.details()}"
            )
    ...
    def update_feature_set(
        ...
        try:
            ...
            raise FrogmlException(
                f"Failed to update feature set, error is {e.details()}"
            )
    ...
    def create_feature_set(
        ...
        try:
            ...
            raise FrogmlException(
                f"Failed to create feature set, error is {e.details()}"
            )
    ...
    def get_data_source_presigned_url(
        ...
        """
        create a pre-sign url for data source according to frogml path convention
        Args:
    ...
    def get_data_source_presigned_url_v1(
        ...
        """
        create a pre-sign url for data source according to frogml path convention that includes a timestamp millis
