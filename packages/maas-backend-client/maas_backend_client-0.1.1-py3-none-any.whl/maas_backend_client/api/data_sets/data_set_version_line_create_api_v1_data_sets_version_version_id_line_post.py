...
from ...models.data_set_version_line_create_req import DataSetVersionLineCreateReq
...
def _get_kwargs(
    version_id: int,
    *,
    body: DataSetVersionLineCreateReq,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/v1/data_sets/version/{version_id}/line",
    }
