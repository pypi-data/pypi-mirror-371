...
def plot_3d_surface_comparison(
    ...
    ----------
    c2_data_dict : Dict[str, np.ndarray]
        Dictionary with dataset names as keys and C2 data arrays as values.
        Example: {'experimental': c2_exp, 'fitted': c2_fit, 'residuals': c2_res}
    phi_angle : float, optional
        Angle in degrees for this data slice (default: 0.0)
    outdir : Union[str, Path], optional
        Output directory for saved plots (default: "./")
...
if __name__ == "__main__":
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        print("3D plotting tests completed!")
