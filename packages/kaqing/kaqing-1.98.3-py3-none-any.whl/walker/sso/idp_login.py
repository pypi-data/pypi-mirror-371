...
class IdpLogin:
    def __init__(self, app_login_url: str, id_token: str, state: str, user: str = None, idp_uri: str = None, session: requests.Session = None):
    ...
    def deser(idp_token: str):
        ...
        return IdpLogin(j['r'], j['id_token'], j['state'], idp_uri=j['idp_uri'] if 'idp_uri' in j else None)
