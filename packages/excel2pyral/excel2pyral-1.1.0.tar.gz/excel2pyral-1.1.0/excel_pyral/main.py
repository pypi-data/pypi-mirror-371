"""
Command Line Interface for Excel-PyRAL Converter
...
For more information, visit: https://github.com/SanCodex/excel-pyral
        """
    )
    ...
    parser.add_argument(
        "--version",
        action="version", 
        version=f"excel-pyral {__version__}"
    )
...
def main():
    ...
    try:
        ...
        if not args.quiet:
            print(f"🚀 Excel-PyRAL Converter v{__version__}")
