...
class LoadBalancerConfig:
    def __init__(
        ...
        *,
        ...
        target_group_attributes: typing.Optional[typing.Union["TargetGroupAttributesConfig", typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        :param target_group_attributes: Target group attributes configuration.
        ...
        if isinstance(target_group_attributes, dict):
            target_group_attributes = TargetGroupAttributesConfig(**target_group_attributes)
        if __debug__:
    ...
    @builtins.property
    def target_group_attributes(self) -> typing.Optional["TargetGroupAttributesConfig"]:
        '''Target group attributes configuration.'''
        result = self._values.get("target_group_attributes")
        return typing.cast(typing.Optional["TargetGroupAttributesConfig"], result)
...
@jsii.data_type(
    jsii_type="must-cdk.TargetGroupAttributesConfig",
    jsii_struct_bases=[],
    name_mapping={
        "custom_attributes": "customAttributes",
        "load_balancing_algorithm_type": "loadBalancingAlgorithmType",
        "stickiness_enabled": "stickinessEnabled",
    },
)
class TargetGroupAttributesConfig:
    def __init__(
        self,
        *,
        ...
        stickiness_enabled: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Configuration for target group attributes.

        :param custom_attributes: Additional custom attributes as key-value pairs.
        :param load_balancing_algorithm_type: Load balancing algorithm type (default: "round_robin").
        :param stickiness_enabled: Enable or disable sticky sessions (default: true).
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5b51c62f5d00d8ccd28174291608e10c0af3c34ae6398875559b3c129af3130a)
            ...
            check_type(argname="argument stickiness_enabled", value=stickiness_enabled, expected_type=type_hints["stickiness_enabled"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        ...
        if stickiness_enabled is not None:
            self._values["stickiness_enabled"] = stickiness_enabled
    ...
    def load_balancing_algorithm_type(self) -> typing.Optional[builtins.str]:
        '''Load balancing algorithm type (default: "round_robin").'''
        result = self._values.get("load_balancing_algorithm_type")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def stickiness_enabled(self) -> typing.Optional[builtins.bool]:
        '''Enable or disable sticky sessions (default: true).'''
        result = self._values.get("stickiness_enabled")
        return typing.cast(typing.Optional[builtins.bool], result)
    ...
    def __repr__(self) -> str:
        return "TargetGroupAttributesConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
def _typecheckingstub__5b51c62f5d00d8ccd28174291608e10c0af3c34ae6398875559b3c129af3130a(
    *,
    custom_attributes: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
    load_balancing_algorithm_type: typing.Optional[builtins.str] = None,
    stickiness_enabled: typing.Optional[builtins.bool] = None,
