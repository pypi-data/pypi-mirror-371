...
from lino.modlib.publisher.choicelists import PageFillers, SpecialPages
...
filler = PageFillers.add_item(LatestEntries)

SpecialPages.add_item(
    "blog", filler=filler, body=_("This page is our blog."),
    title=_("Blog"),
    parent='home')
