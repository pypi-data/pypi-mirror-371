...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_qrotate(self):
        ...
        correct = np.array([[ 0.,0.,0.38268343],
                         [ 0.,0.,-0.38268343]])
    ...
    def test_rotate_vector(self):
        x = [[1,0,0], [0, 1, 0], [0,0,1]]
        result = vector.rotate_vector(x, [0, 0, np.sin(0.1)])
        correct = np.array([[ 0.98006658,  0.19866933,  0.        ],
