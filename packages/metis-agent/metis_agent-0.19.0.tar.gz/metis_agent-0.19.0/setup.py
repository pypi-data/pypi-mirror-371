...
setup(
    ...
    description="Advanced AI agent framework with composable assets (personas, instructions, workflows, skills), Claude Code-style CLI, multi-agent orchestration, 36+ tools, and enterprise security",
