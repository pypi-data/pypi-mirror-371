...
def init(format: str, output: Optional[str], force: bool):
    ...
    try:
        ...
        console.print(f"Use 'sandroid-config show' to view the current configuration.")
...
def show(config: Optional[str], environment: Optional[str], format: str):
...
def validate(config: Optional[str], environment: Optional[str]):
...
def set(key: str, value: str, config: Optional[str], format: str):
...
def get(key: str, config: Optional[str], environment: Optional[str]):
