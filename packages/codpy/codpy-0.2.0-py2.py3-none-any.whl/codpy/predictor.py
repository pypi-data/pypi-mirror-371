...
class greedy_nys_predictor:
    ...
    def __init__(self, **kwargs):
        ...
        self.knm_inv, self.indices = alg.HybridGreedyNystroem(
            x=self.x, fx=self.fx, **self.params
        )
        ...
        if self.z is not None:
            self.mappedz = kernel.map(self.z)
    ...
    def __call__(self, **kwargs):
        ...
        # return KerOp.projection(**{**self.params,**{'x':y,'y':y,'z':z,'fx':kwargs['fx']}}) #for debug
