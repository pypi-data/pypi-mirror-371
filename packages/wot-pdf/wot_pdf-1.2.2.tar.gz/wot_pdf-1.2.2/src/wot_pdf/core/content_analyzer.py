...
import logging
import re
from .engine_selector import EngineType
...
class ContentAnalysisResults:
    ...
    recommended_engine: EngineType = EngineType.TYPST
    confidence: int = 95
...
class ContentAnalyzer:
    ...
    def analyze(self, content: str) -> ContentAnalysisResults:
        ...
        # Select recommended engine
        recommended_engine = self.engine_selector.select_engine(analysis)
        ...
        complexity_score = complexity_mapping.get(analysis['complexity'], 50.0)
