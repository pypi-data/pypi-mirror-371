...
import crc-pulp_rpm-client
from crc-pulp_rpm-client.rest import ApiException
...
configuration = crc-pulp_rpm-client.Configuration(
...
with crc-pulp_rpm-client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = crc-pulp_rpm-client.AcsRpmApi(api_client)
    rpm_rpm_alternate_content_source_href = 'rpm_rpm_alternate_content_source_href_example' # str | 
    nested_role = crc-pulp_rpm-client.NestedRole() # NestedRole | 
