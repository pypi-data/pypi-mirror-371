...
class RpmModulemdDefaultsResponse(BaseModel):
    """
    ...
    module: StrictStr = Field(description="Modulemd name.")
    stream: StrictStr = Field(description="Modulemd default stream.")
    profiles: Optional[Any] = Field(description="Default profiles for modulemd streams.")
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "pulp_labels", "module", "stream", "profiles"]
