...
def markdown_to_bbcode(md: str, parser: str = "html.parser") -> str:
    plugins = [
        # Default:
        "strikethrough",
        "footnotes",
    ...
    markdown = Markdown(renderer=BbcodeRenderer(parser), inline=inline, plugins=real_plugins)
...
class BbcodeRenderer(BaseRenderer):
    ...
    NAME: ClassVar[Literal["text"]] = "bbcode"
