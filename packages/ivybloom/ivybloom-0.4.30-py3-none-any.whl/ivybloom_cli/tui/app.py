...
class IvyBloomTUI(App):
    ...
    def _visualize_protein_structure(self, job_id: str) -> None:
        """Visualize protein structure as ASCII art."""
        if self.details_visualization:
    ...
    def _visualize_best_artifact(self, job_id: str) -> None:
        ...
        try:
            ...
            for artifact_type in ["pdb", "sdf", "mol", "json", "csv"]:
                ...
                if artifact:
                    ...
                    if url:
                        if artifact_type in ["pdb"]:
                            ...
                            content = self._artifacts.fetch_bytes(url)
                            preview = self._artifacts.preview_json(content, str(artifact.get("filename") or "data.json"))
                            if self.details_visualization:
