...
class ProteinVisualizer:
    ...
    def _pdb_to_xyz(self, pdb_content: str) -> str:
        ...
        # Read the PDB file using ASE (lazy import to avoid hard dependency if unused)
        try:
    ...
    def render_pdb_as_text(self, pdb_content: str, width: int = 80, height: int = 30) -> str:
        ...
        try:
            ...
            return f"Error rendering protein: missing dependency ({e}). Ensure 'asciimol' is installed."
        except Exception as e:
