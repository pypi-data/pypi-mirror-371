...
try:
    from scripts.get_version import get_netsplit_version, get_release_display_name
except Exception:
    get_netsplit_version = None
...
if not version and get_netsplit_version:
    try:
        version = get_netsplit_version()
    except Exception:
        version = None
