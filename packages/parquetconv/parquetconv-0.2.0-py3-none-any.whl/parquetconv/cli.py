...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  parquetconv input.parquet          # Convert Parquet to CSV
  parquetconv input.csv              # Convert CSV to Parquet
  parquetconv input.parquet -o output.csv    # Specify output file
  parquetconv input.csv -o output.parquet    # Specify output file
        """
    )
