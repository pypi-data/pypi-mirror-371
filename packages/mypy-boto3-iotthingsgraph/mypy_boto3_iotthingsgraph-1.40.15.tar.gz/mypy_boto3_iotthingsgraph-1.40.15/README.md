...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-iotthingsgraph)](https://pypistats.org/packages/mypy-boto3-iotthingsgraph)
...
`mypy-boto3-iotthingsgraph` dependency in production. However, there is an
