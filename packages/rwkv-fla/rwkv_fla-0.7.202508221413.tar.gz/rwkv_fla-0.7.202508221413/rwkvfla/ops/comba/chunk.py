...
from rwkvfla.ops.comba.utils import chunk_comba_cumsum_scalar_bwd, chunk_comba_cumsum_scalar_fwd
from rwkvfla.ops.comba.wy_fast import chunk_scaled_dot_comba_pkt_fwd, prepare_wy_repr_bwd, recompute_w_u_fwd
...
def chunk_comba(
    ...
    Examples::
        ...
        >>> from rwkvfla.ops.comba import chunk_comba
