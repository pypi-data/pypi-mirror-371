...
from rwkvfla.modules.layernorm_gated import RMSNormGated
...
if TYPE_CHECKING:
    from rwkvfla.models.mamba2.modeling_mamba2 import Mamba2Cache
...
class Mamba2(nn.Module):
    ...
    def __init__(
        ...
        if backend == 'cuda' and causal_conv1d_fn is None:
            ...
            backend = 'triton'
        if backend == 'triton':
            from rwkvfla.modules.convolution import causal_conv1d as causal_conv1d_triton
            from rwkvfla.modules.convolution import causal_conv1d_update as causal_conv1d_update_triton
