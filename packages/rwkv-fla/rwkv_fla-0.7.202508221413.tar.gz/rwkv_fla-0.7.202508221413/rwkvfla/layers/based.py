...
from rwkvfla.modules.feature_map import TaylorFeatureMap
from rwkvfla.ops.based import parallel_based
from rwkvfla.ops.linear_attn import chunk_linear_attn, fused_chunk_linear_attn
