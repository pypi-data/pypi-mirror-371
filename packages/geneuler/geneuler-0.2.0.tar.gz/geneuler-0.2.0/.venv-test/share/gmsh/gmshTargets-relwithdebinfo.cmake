...
set_target_properties(gmsh::shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libgmsh.4.14.0.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libgmsh.4.14.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gmsh::shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_gmsh::shared "${_IMPORT_PREFIX}/lib/libgmsh.4.14.0.dylib" )
