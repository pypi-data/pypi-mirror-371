...
def process_sub_result(args):
    ...
    jcfg = tmcx.make.dir_state(sub_result, post_build=1, append_str="_" + str(i))
...
def simulate(jcfg: dict, delta_cfgs: dict,
    ...
    tmcx.util.verb(f"Sim States: {len(delta_cfgs)}, offloader nodes: {offloader_cfg['num_nodes']}, tasks per node: {offloader_cfg['num_tasks_per_node']}",
                   jcfg["Expt"]["verb"],
                   0)
    ...
    settings.add_file(
        Path("c://dev/mcx/Software/tmcx/__init__.py"), Path("Software/tmcx")
    )
    settings.add_file(Path("c://dev/mcx/Software/tmcx/anly.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/buil.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/calc.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/conv.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/exec.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/grap.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/impo.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/make.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/modi.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/offl.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/proc.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/stas.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/util.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/Software/tmcx/writ.py"), Path("Software/tmcx"))
    settings.add_file(Path("c://dev/mcx/projects/offloader/offload.py"))
    settings.add_file(
        Path("c://dev/mcx/Software/tmcx/z_extras.py"), Path("Software/tmcx")
    )
    ...
    tmcx.util.verb("Starting offload simulation", jcfg["Expt"]["verb"], 0)
    if detach is False:
