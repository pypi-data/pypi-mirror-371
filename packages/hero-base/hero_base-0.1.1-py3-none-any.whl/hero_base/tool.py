...
class CommonToolWrapper(Generic[T]):
    def __init__(self, name: str, prefix: str, memory_hint: str, options: T | None, doc: str, func: Callable[..., ToolResult | Coroutine[Any, Any, ToolResult] | AsyncGenerator[Any, ToolResult]], options_type: Optional[Type[T]] = None):
        if prefix:
...
class Tool:
    ...
    def __call__(self, name: str, memory_hint: str = "", options: T | None = None, options_type: Optional[Type[T]] = None):
        """
        工具装饰器
        ...
        def decorator(func: Callable[..., (ToolSuccess | ToolFailed | ToolError | ToolEnd) | Coroutine[Any, Any, (ToolSuccess | ToolFailed | ToolError | ToolEnd)] | AsyncGenerator[Any, (ToolSuccess | ToolFailed | ToolError | ToolEnd)]]) -> CommonToolWrapper[T]:
            return CommonToolWrapper[T](name, self.prefix, memory_hint, options, func.__doc__ or "", func, options_type)
