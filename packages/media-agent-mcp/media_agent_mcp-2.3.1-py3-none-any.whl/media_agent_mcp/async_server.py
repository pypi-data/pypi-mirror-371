...
This server provides 10 async tools for media processing using threading:
...
@mcp.tool()
@async_retry()
async def add_subtitles_to_video(video_url: str, subtitles_input: str, font_name: Optional[str] = None, font_color: Optional[str] = None) -> dict:
    """
    ...
    """
    result = await async_add_subtitles_to_video_tool(video_url, subtitles_input, font_name, font_color)
    return result
