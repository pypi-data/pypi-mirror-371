...
class McpAuthClient:
    ...
    def disable_client_id_for_server(self, client_id: str, server_name: str) -> Dict[str, Any]:
        """
        Disable/remove a client ID association with a specific server.
        
        Args:
            client_id: The client identifier to disable
            server_name: The server name to remove the client from
        ...
        Raises:
            McpAuthError: If the request fails or returns an error
        """
        url = f"{self.base_url}/servers_by_client/delete"
        body = {
            "OBSERVEE_API_KEY": self.api_key,
            "client_id": client_id,
...
def disable_client_id_for_server(client_id: str, server_name: str, api_key: Optional[str] = None) -> Dict[str, Any]:
    """
    Disable/remove a client ID association with a specific server.
    ...
    """
    client = McpAuthClient(api_key=api_key)
    return client.disable_client_id_for_server(client_id, server_name)
