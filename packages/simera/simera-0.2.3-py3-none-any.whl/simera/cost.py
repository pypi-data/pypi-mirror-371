...
class Cost:
    ...
    def __repr__(self):
        return f'ShipmentCost: {self.sh}{self.rs}'
    ...
    def _get_shipment_summary(self):
        ...
        total_packages = (self.sh_units_max_size.get('full', {}).get('total_shipments', 0) * self.sh_units_max_size.get('full', {}).get('package', 0) +
                          self.sh_units_max_size.get('rest', {}).get('total_shipments', 0) * self.sh_units_max_size.get('rest', {}).get('package', 0))
