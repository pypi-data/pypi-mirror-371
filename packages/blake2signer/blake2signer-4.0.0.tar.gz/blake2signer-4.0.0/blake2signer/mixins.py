...
class SerializerMixin(Mixin, ABC):
    ...
    def _unserialize(self, data: bytes, **kwargs: typing.Any) -> typing.Any:
        ...
        """
        try:
            return self._serializer.unserialize(data, **kwargs)
        except Exception as exc:
...
class EncoderMixin(Mixin, ABC):
    ...
    @staticmethod
    def _validate_encoder(encoder_class: type[EncoderInterface]) -> EncoderInterface:
