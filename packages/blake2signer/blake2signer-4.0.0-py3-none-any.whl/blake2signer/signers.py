...
# When adding a new signer, or a new public method to a signer, please add a fuzzer for it
# in `fuzz.py`, and update the `fuzz` invoke task accordingly.
...
class Blake2SerializerSigner(
    ...
    def __init__(  # pylint: disable=R0801
        ...
        *,
        ...
        encoder: type[EncoderInterface] = B64URLEncoder,
        serializer: type[SerializerInterface] = JSONSerializer,
    ...
    def _dumps(self, data: typing.Any, **kwargs: typing.Any) -> bytes:
        ...
        serializer_kwargs: dict[str, typing.Any] = kwargs.get('serializer_kwargs') or {}
    ...
    def _loads(self, dumped_data: bytes, **kwargs: typing.Any) -> typing.Any:
        ...
        unserizalized = self._unserialize(decompressed, **serializer_kwargs)
    ...
    def dumps(
        ...
        *,
        ...
        serializer_kwargs: typing.Optional[dict[str, typing.Any]] = None,
    ) -> str:
    ...
    def loads(
        ...
        *,
        ...
        return self._loads(self._proper_unsign(parts), serializer_kwargs=serializer_kwargs)
    ...
    def loads_parts(
        ...
        *,
        ...
        return self.loads(signed_data, serializer_kwargs=serializer_kwargs)
    ...
    def load(
        ...
        *,
        ...
        """
        return self.loads(self._read(file), serializer_kwargs=serializer_kwargs)
