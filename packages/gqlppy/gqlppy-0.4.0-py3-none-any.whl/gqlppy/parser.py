...
class Parser():
   ...
   def __init__(self, kind: str ='earley', strict: bool=False, starting_productions: list[str] = None, grammar_file: str = None):
      ...
      self._parser = Lark.open(
         'gql.lark' if grammar_file is None else grammar_file,
