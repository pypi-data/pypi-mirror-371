...
def redirect_cmd(file, log, use_powershell=False):
    ...
    use_powershell : bool
        If True on Windows, uses PowerShell redirection.
    """
...
def autorun(
    ...
    date_fmt :      str  ='%Y%m%d_%H%M%S', log_limit:      bool | None = None,
