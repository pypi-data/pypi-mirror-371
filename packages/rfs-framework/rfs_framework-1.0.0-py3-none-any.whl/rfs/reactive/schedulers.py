...
class Scheduler:
    ...
    def __init__(self, scheduler_type: SchedulerType = SchedulerType.IMMEDIATE):
        ...
        if scheduler_type == SchedulerType.IO:
            self._executor = ThreadPoolExecutor(max_workers=10, thread_name_prefix="rfs-io")
        elif scheduler_type == SchedulerType.PARALLEL:
            self._executor = ThreadPoolExecutor(max_workers=None, thread_name_prefix="rfs-parallel")
