    ...
    def score_batch(
        ...
        **kwargs,
        ...
        # Augment local workspace metastore tables from 2L to 3L,
            ...
            print(f"feature_spec-wedata: {feature_spec}")
        ...
        # 构建 udf 函数
            ...
            model_creation_timestamp_ms = (
                uc_utils.utc_timestamp_ms_from_iso_datetime_string(
        ...
        print(f"wedata feature_input_keys:{feature_input_keys}")

        print(f"feature_spec.source_data_column_infos:{feature_spec.source_data_column_infos}")
        source_data_names = [
        ...
        print(f"wedata feature_output_names:{feature_output_names}")
        ...
        print(f"wedata all_output_names:{all_output_names}")
        ...
        print(f"feature_table_metadata_map:{feature_table_metadata_map},key:{dir(feature_table_metadata_map)}")
        feature_table_data_map = training_set_utils.load_feature_data_for_tables(
            self._spark_client, table_names=table_names
        )

        print(f"feature_table_data_map:{feature_table_data_map}")
