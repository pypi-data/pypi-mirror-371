...
def totalDBItems():
    with Session(ENGINE) as session:
        ...
        for i in a:
            ...
            total+=1
            ttl_qty_itm+=qty
        return f"List(TTL Lines:{Fore.light_red}{total}{Fore.light_yellow},CRV Lines:{Fore.light_red}{crv_items}{Fore.light_yellow},CRV QTY ITM:{Fore.light_red}{crv_qty_items}{Fore.light_yellow},TTL ITM PRCHSD:{Fore.light_red}{ttl_qty_itm}{Fore.light_yellow})\n"
