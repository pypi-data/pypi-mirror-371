...
def totalDBItems():
    with Session(ENGINE) as session:
        ...
        for i in a:
            ...
            for f in BooleanAnswers.location_fields:
                value=getattr(i,f)
            ...
            ttl_qty_itm+=qty
            ttl_qty+=qty
        return f"""List(TTL LN+CRV LN:{Fore.light_red}{total}{Fore.light_yellow},CRV LN:{Fore.light_red}{crv_items}{Fore.light_yellow},CRV QTY ITM:{Fore.light_red}{crv_qty_items}{Fore.light_yellow},
TTL ITM PRCHSD:{Fore.light_red}{ttl_qty_itm}{Fore.light_yellow},TTL QTY w/o CRV QTY ITM:{Fore.light_red}{ttl_qty}{Fore.light_yellow})\n"""
