...
def _reset_odoo_tools():
    odoo.tools.config.casts = {}
    odoo.tools.config.misc = {}
    odoo.tools.config.options = {}
    odoo.tools.config.config_file = None
    # Copy all optparse options (i.e. MyOption) into self.options.
    for group in odoo.tools.config.parser.option_groups:
        for option in group.option_list:
            if option.dest not in odoo.tools.config.options:
                odoo.tools.config.options[option.dest] = option.my_default
                odoo.tools.config.casts[option.dest] = option

    # generate default config
    odoo.tools.config._parse_config()  # noqa: SLF001
