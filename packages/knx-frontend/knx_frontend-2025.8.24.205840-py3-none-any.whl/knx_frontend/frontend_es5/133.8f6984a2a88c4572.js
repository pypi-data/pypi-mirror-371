"use strict";(self.webpackChunkknx_frontend=self.webpackChunkknx_frontend||[]).push([["133"],{85163:function(t,e,i){i.d(e,{wZ:function(){return a},jL:function(){return s}});i(26847),i(81738),i(94814),i(6989),i(20655),i(27530);var n=i(28105),o=i(31298);i(67886),i(65451),i(46015),i(38334),i(94880),i(75643),i(29761);const s=t=>{var e;return null===(e=t.name_by_user||t.name)||void 0===e?void 0:e.trim()},a=(t,e,i)=>s(t)||i&&r(e,i)||e.localize("ui.panel.config.devices.unnamed_device",{type:e.localize(`ui.panel.config.devices.type.${t.entry_type||"device"}`)}),r=(t,e)=>{for(const i of e||[]){const e="string"==typeof i?i:i.entity_id,n=t.states[e];if(n)return(0,o.C)(n)}};(0,n.Z)((t=>function(t){const e=new Set,i=new Set;for(const n of t)i.has(n)?e.add(n):i.add(n);return e}(Object.values(t).map((t=>s(t))).filter((t=>void 0!==t)))))},10996:function(t,e,i){i.d(e,{K:function(){return r}});var n=i(85163),o=i(31298);i(26847),i(44261),i(27530);const s=[" ",": "," - "],a=t=>t.toLowerCase()!==t,r=(t,e)=>{const i=e.entities[t.entity_id];return i?d(i,e):(0,o.C)(t)},d=(t,e)=>{const i=t.name||("original_name"in t?t.original_name:void 0),r=t.device_id?e.devices[t.device_id]:void 0;if(!r){if(i)return i;const n=e.states[t.entity_id];return n?(0,o.C)(n):void 0}const d=(0,n.jL)(r);if(d!==i)return d&&i&&((t,e)=>{const i=t.toLowerCase(),n=e.toLowerCase();for(const o of s){const e=`${n}${o}`;if(i.startsWith(e)){const i=t.substring(e.length);if(i.length)return a(i.substr(0,i.indexOf(" ")))?i:i[0].toUpperCase()+i.slice(1)}}})(i,d)||i}},66027:function(t,e,i){i.d(e,{U:function(){return n}});const n=(t,e)=>{const i=e.entities[t.entity_id];return i?o(i,e):{entity:null,device:null,area:null,floor:null}},o=(t,e)=>{const i=e.entities[t.entity_id],n=null==t?void 0:t.device_id,o=n?e.devices[n]:void 0,s=(null==t?void 0:t.area_id)||(null==o?void 0:o.area_id),a=s?e.areas[s]:void 0,r=null==a?void 0:a.floor_id;return{entity:i,device:o||null,area:a||null,floor:(r?e.floors[r]:void 0)||null}}},27087:function(t,e,i){i.d(e,{T:function(){return o}});i(64455),i(32192);const n=/^(\w+)\.(\w+)$/,o=t=>n.test(t)},39711:function(t,e,i){i.a(t,(async function(t,e){try{i(39710),i(26847),i(73042),i(81738),i(94814),i(6989),i(1455),i(56389),i(44261),i(27530);var n=i(73742),o=i(59048),s=i(7616),a=i(28105),r=i(29740),d=i(71188),l=i(85163),c=i(76151),u=i(10996),h=i(31298),p=i(66027),_=i(27087),y=i(80913),v=i(47469),b=i(56845),f=i(37596),m=(i(57264),i(33321)),g=(i(40830),i(37351)),C=t([m,g]);[m,g]=C.then?(await C)():C;let $,w,j,O,I,k,x,L,E,B=t=>t;const V="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",D="M11,13.5V21.5H3V13.5H11M12,2L17.5,11H6.5L12,2M17.5,13C20,13 22,15 22,17.5C22,20 20,22 17.5,22C15,22 13,20 13,17.5C13,15 15,13 17.5,13Z",H="___create-new-entity___";class A extends o.oi{firstUpdated(t){super.firstUpdated(t),this.hass.loadBackendTranslation("title")}get _showEntityId(){var t;return this.showEntityId||(null===(t=this.hass.userData)||void 0===t?void 0:t.showEntityIdPicker)}render(){var t;const e=null!==(t=this.placeholder)&&void 0!==t?t:this.hass.localize("ui.components.entity.entity-picker.placeholder"),i=this.hass.localize("ui.components.entity.entity-picker.no_match");return(0,o.dy)($||($=B`
      <ha-generic-picker
        .hass=${0}
        .disabled=${0}
        .autofocus=${0}
    ...
    `),this.hass,this.disabled,this.autofocus,this.allowCustomEntity,this.label,this.helper,this.searchLabel,i,e,this.value,this._rowRenderer,this._getItems,this._getAdditionalItems,this.hideClearIcon,this._searchFn,this._valueRenderer,this._valueChanged)}async open(){var t;await this.updateComplete,await(null===(t=this._picker)||void 0===t?void 0:t.open())}_valueChanged(t){t.stopPropagation();const e=t.detail.value;if(e)if(e.startsWith(H)){const t=e.substring(H.length);(0,f.j)(this,{domain:t,dialogClosedCallback:t=>{t.entityId&&this._setValue(t.entityId)}})}else(0,_.T)(e)&&this._setValue(e);else this._setValue(void 0)}_setValue(t){this.value=t,(0,r.B)(this,"value-changed",{value:t}),(0,r.B)(this,"change")}constructor(...t){super(...t),this.autofocus=!1,this.disabled=!1,this.required=!1,this.showEntityId=!1,this.hideClearIcon=!1,this._valueRenderer=t=>{const e=t||"",i=this.hass.states[e];if(!i)return(0,o.dy)(w||(w=B`
      ...
      `),D,e);const{area:n,device:s}=(0,p.U)(i,this.hass),a=(0,u.K)(i,this.hass),r=s?(0,l.jL)(s):void 0,c=n?(0,d.D)(n):void 0,h=(0,y.HE)(this.hass),_=a||r||e,v=[c,a?r:void 0].filter(Boolean).join(h?" ◂ ":" ▸ ");return(0,o.dy)(j||(j=B`
      <state-badge
        .hass=${0}
        .stateObj=${0}
        slot="start"
    ...
    `),this.hass,i,_,v)},this._rowRenderer=(t,{index:e})=>{const i=this._showEntityId;return(0,o.dy)(O||(O=B`
