...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , weight_we_i{vlSymsp->TOP.weight_we_i}
    , bias_we_i{vlSymsp->TOP.bias_we_i}
    , valid_o{vlSymsp->TOP.valid_o}
    , debug_flags_o{vlSymsp->TOP.debug_flags_o}
    , weight_addr_i{vlSymsp->TOP.weight_addr_i}
    , weight_data_i{vlSymsp->TOP.weight_data_i}
    , input_data_i{vlSymsp->TOP.input_data_i}
    , bias_addr_i{vlSymsp->TOP.bias_addr_i}
    , bias_data_i{vlSymsp->TOP.bias_data_i}
    , output_data_o{vlSymsp->TOP.output_data_o}
    , debug_accumulator_o{vlSymsp->TOP.debug_accumulator_o}
    , debug_addr_counter_o{vlSymsp->TOP.debug_addr_counter_o}
