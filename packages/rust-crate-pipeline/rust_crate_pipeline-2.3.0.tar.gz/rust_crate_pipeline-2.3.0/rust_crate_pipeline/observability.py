...
class StructuredLogger:
    ...
    def _log(self, level: str, message: str, **kwargs):
        ...
        self.logger.log(getattr(logging, level.upper()), json.dumps(context, default=str))
...
def observe_function(metric_prefix: str, log_args: bool = False, trace_enabled: bool = True):
    """
    ...
    def decorator(func: Callable[..., T]) -> Callable[..., T]:
        ...
        def wrapper(*args, **kwargs) -> T:
            ...
            try:
                ...
                duration = time.time() - start_time
                func_logger.error(f"Failed {func_name}", error=e, duration=duration, status="error")
