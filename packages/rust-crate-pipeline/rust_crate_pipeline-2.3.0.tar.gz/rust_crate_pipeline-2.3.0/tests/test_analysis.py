...
class TestSourceAnalyzer:
    ...
    @patch("requests.get")
    def test_analyze_crate_source_crates_io_failure(self, mock_get, mock_analyze_repo, sample_crate):
...
class TestUserBehaviorAnalyzer:
    ...
    def test_fetch_user_behavior_data_github_success(self, mock_get, sample_crate):
        ...
        mock_versions_response.json.return_value = {
            "versions": [{"num": "1.0.0", "downloads": 100, "created_at": "2023-01-01T00:00:00Z"}]
        }
