...
class TestCanonRegistry:
    ...
    def test_register_canon(self):
        ...
        result = registry.register_canon(
            key="test-key", source="test-source", content="test content", authority_level=5
        )
...
class TestIRLEngine:
    ...
    def test_irl_engine_initialization(self):
        ...
        assert engine.canon_version == "2.2.0"
    ...
    def test_get_audit_summary(self):
        ...
        assert summary["canon_version"] == "2.2.3"
