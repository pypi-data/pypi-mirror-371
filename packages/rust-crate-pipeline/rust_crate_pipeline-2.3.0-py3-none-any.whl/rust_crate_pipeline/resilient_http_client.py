    ...
    def request(self, method: str, url: str, **kwargs) -> requests.Response:
        ...
        try:
            ...
            if response.status_code == 429:
                ...
                raise RateLimitError(f"API rate limit hit: {response.text}", retry_after=int(retry_after))
...
if HTTPX_AVAILABLE and httpx is not None:
    ...
    class AsyncResilientHTTPClient:
        ...
        def __init__(
            ...
            self.circuit_breaker = CircuitBreaker(name=base_url or "default", config=cb_config)
            self.retry_config = retry_config or RetryConfig()
