...
class CrawlAIManager:
    ...
    def __init__(
        ...
        if not CRAWL4AI_AVAILABLE:
            raise ConfigurationError("Crawl4AI is not installed. Install with: " "pip install crawl4ai[all]")
    ...
    async def crawl_url(
        ...
        try:
            ...
            crawl_config = CrawlerRunConfig(
                cache_mode=(CacheMode.ENABLED if config.use_cache else CacheMode.BYPASS),
    ...
    async def crawl_multiple_urls(self, urls: List[str], max_concurrent: int = 5) -> List[CrawlResult]:
    ...
    def _process_crawl_result(self, raw_result: Any, url: str) -> CrawlResult:
        ...
        try:
            ...
            if hasattr(raw_result, "extracted_content") and raw_result.extracted_content:
                try:
            ...
            return CrawlResult(
                ...
                markdown=(raw_result.markdown.fit_markdown if hasattr(raw_result, "markdown") else None),
    ...
    def _has_llm_config(self) -> bool:
        ...
        return os.getenv("OPENAI_API_KEY") or os.getenv("ANTHROPIC_API_KEY") or os.getenv("OLLAMA_BASE_URL")
                        ...
                        try:
                            ...
                            if len(path_parts) >= 2:
                                github_path = f"{
                                    path_parts[0]}/{
                                    path_parts[1]}"
                                crate_results["github"] = await crawler.crawl_github_repo(github_path)
                        except Exception as e:
