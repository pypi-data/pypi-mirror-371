...
# Keep this whole module private for the moment.  Think more
...
from degreedays._private import getSafeDictKeys, _Immutable, XmlElement, \
    raiseWrapped
...
class RequestSecurityInfo(_Immutable):
...
class EncodedString(_Immutable):
...
class XmlHttpRequestProcessor(object):
    ...
    _rateLimitCacheMap = {}
    # If making this module public we'd want some way to stop this from being
