...
def run_mpebm(
    ...
    energy_influence:float=0.03,
    use_scaling:bool=False, # whether to use scaling_factor
    ...
    try:
        accepted_orders, log_likelihoods, final_theta_phi, final_stage_post, current_pi = metropolis_hastings(
            ...
            iterations = n_iter, n_shuffle = n_shuffle, prior_n=prior_n, prior_v=prior_v, rng=rng, energy_influence=energy_influence,
    ...
    #         "order_with_highest_ll": {k: int(v) for k, v in zip(biomarker_names, order_with_highest_ll)},
    #         "mean_absolute_error": mae,
    #         # 'mean_absolute_error_sampling': mae,
    #         "final_theta_phi_params": final_theta_phi_dict
    #     }
