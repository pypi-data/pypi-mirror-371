...
class IntrospectTokenResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if iat (nullable) is None
        # and model_fields_set contains the field
        if self.iat is None and "iat" in self.model_fields_set:
            _dict["iat"] = None

        # set to None if nbf (nullable) is None
        # and model_fields_set contains the field
        if self.nbf is None and "nbf" in self.model_fields_set:
            _dict["nbf"] = None
