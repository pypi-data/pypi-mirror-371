...
class PhoneOTPVerificationRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PhoneOTPVerificationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PhoneOTPVerificationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"otp": obj.get("otp")})
        return _obj
