...
class TestApiKeyTokenResponse(unittest.TestCase):
    """ApiKeyTokenResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKeyTokenResponse:
        """Test ApiKeyTokenResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ApiKeyTokenResponse`
        """
        model = ApiKeyTokenResponse()
        if include_optional:
    ...
    def testApiKeyTokenResponse(self):
        """Test ApiKeyTokenResponse"""
