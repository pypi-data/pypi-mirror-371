...
class TestClientConfigResponse(unittest.TestCase):
    """ClientConfigResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientConfigResponse:
        """Test ClientConfigResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClientConfigResponse`
        """
        model = ClientConfigResponse()
        if include_optional:
    ...
    def testClientConfigResponse(self):
        """Test ClientConfigResponse"""
