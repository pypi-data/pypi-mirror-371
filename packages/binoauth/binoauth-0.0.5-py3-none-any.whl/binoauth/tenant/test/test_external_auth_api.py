...
class TestExternalAuthApi(unittest.TestCase):
    """ExternalAuthApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ExternalAuthApi()

    def tearDown(self) -> None:
        pass

    def test_get_active_providers_api_v1_auth_external_active_providers_get(
        self,
    ) -> None:
        """Test case for get_active_providers_api_v1_auth_external_active_providers_get

        Get Active Social Login Providers
        """
        pass

    def test_get_providers_api_v1_auth_external_providers_get(self) -> None:
        """Test case for get_providers_api_v1_auth_external_providers_get

        Get All Available Providers
        """
        pass

    def test_social_callback_api_v1_auth_external_callback_provider_get(self) -> None:
        """Test case for social_callback_api_v1_auth_external_callback_provider_get
