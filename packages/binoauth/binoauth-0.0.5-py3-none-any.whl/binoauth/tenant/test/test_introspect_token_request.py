...
class TestIntrospectTokenRequest(unittest.TestCase):
    """IntrospectTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntrospectTokenRequest:
        """Test IntrospectTokenRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `IntrospectTokenRequest`
        """
        model = IntrospectTokenRequest()
        if include_optional:
    ...
    def testIntrospectTokenRequest(self):
        """Test IntrospectTokenRequest"""
