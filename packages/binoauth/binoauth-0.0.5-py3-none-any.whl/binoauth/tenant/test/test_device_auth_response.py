...
class TestDeviceAuthResponse(unittest.TestCase):
    """DeviceAuthResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceAuthResponse:
        """Test DeviceAuthResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DeviceAuthResponse`
        """
        model = DeviceAuthResponse()
        if include_optional:
    ...
    def testDeviceAuthResponse(self):
        """Test DeviceAuthResponse"""
