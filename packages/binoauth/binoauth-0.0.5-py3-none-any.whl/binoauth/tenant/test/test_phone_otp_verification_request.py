...
class TestPhoneOTPVerificationRequest(unittest.TestCase):
    """PhoneOTPVerificationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhoneOTPVerificationRequest:
        """Test PhoneOTPVerificationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PhoneOTPVerificationRequest`
        """
        model = PhoneOTPVerificationRequest()
        if include_optional:
            return PhoneOTPVerificationRequest(
                otp = ''
            )
        else:
            return PhoneOTPVerificationRequest(
    ...
    def testPhoneOTPVerificationRequest(self):
        """Test PhoneOTPVerificationRequest"""
