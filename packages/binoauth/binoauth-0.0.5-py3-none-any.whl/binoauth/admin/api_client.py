...
from binoauth.admin.configuration import Configuration
from binoauth.admin.api_response import ApiResponse, T as ApiResponseT
import binoauth.admin.models
from binoauth.admin import rest
from binoauth.admin.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(binoauth.admin.models, klass)
