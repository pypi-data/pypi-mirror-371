...
class TestApiKeyTokenRequest(unittest.TestCase):
    """ApiKeyTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKeyTokenRequest:
        """Test ApiKeyTokenRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ApiKeyTokenRequest`
        """
        model = ApiKeyTokenRequest()
        if include_optional:
            return ApiKeyTokenRequest(
                client_id = '',
                scope = '',
                expires_in = 56
            )
    ...
    def testApiKeyTokenRequest(self):
        """Test ApiKeyTokenRequest"""
