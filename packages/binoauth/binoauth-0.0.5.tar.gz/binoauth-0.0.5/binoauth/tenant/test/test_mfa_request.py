...
class TestMFARequest(unittest.TestCase):
    """MFARequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MFARequest:
        """Test MFARequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MFARequest`
        """
        model = MFARequest()
        if include_optional:
            return MFARequest(
