...
class TestDeviceAuthenticationRequest(unittest.TestCase):
    """DeviceAuthenticationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceAuthenticationRequest:
        """Test DeviceAuthenticationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DeviceAuthenticationRequest`
        """
        model = DeviceAuthenticationRequest()
        if include_optional:
    ...
    def testDeviceAuthenticationRequest(self):
        """Test DeviceAuthenticationRequest"""
