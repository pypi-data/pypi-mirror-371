...
class TestVerifyMagicLinkCodeRequest(unittest.TestCase):
    """VerifyMagicLinkCodeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyMagicLinkCodeRequest:
        """Test VerifyMagicLinkCodeRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VerifyMagicLinkCodeRequest`
        """
        model = VerifyMagicLinkCodeRequest()
        if include_optional:
            return VerifyMagicLinkCodeRequest(
                code = ''
            )
        else:
            return VerifyMagicLinkCodeRequest(
    ...
    def testVerifyMagicLinkCodeRequest(self):
        """Test VerifyMagicLinkCodeRequest"""
