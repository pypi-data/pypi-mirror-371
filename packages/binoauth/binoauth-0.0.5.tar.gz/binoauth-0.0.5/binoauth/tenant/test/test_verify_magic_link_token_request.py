...
class TestVerifyMagicLinkTokenRequest(unittest.TestCase):
    """VerifyMagicLinkTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyMagicLinkTokenRequest:
        """Test VerifyMagicLinkTokenRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VerifyMagicLinkTokenRequest`
        """
        model = VerifyMagicLinkTokenRequest()
        if include_optional:
            return VerifyMagicLinkTokenRequest(
                token = ''
            )
        else:
            return VerifyMagicLinkTokenRequest(
    ...
    def testVerifyMagicLinkTokenRequest(self):
        """Test VerifyMagicLinkTokenRequest"""
