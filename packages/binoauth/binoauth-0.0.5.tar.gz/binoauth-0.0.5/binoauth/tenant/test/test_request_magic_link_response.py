...
class TestRequestMagicLinkResponse(unittest.TestCase):
    """RequestMagicLinkResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestMagicLinkResponse:
        """Test RequestMagicLinkResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RequestMagicLinkResponse`
        """
        model = RequestMagicLinkResponse()
        if include_optional:
    ...
    def testRequestMagicLinkResponse(self):
        """Test RequestMagicLinkResponse"""
