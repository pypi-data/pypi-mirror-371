...
class MagicLinkRequest(BaseModel):
    ...
    email: StrictStr
    return_to: StrictStr
    flow_state: Optional[StrictStr] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if flow_state (nullable) is None
        # and model_fields_set contains the field
        if self.flow_state is None and "flow_state" in self.model_fields_set:
            _dict["flow_state"] = None
