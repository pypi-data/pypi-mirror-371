...
class MFARequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "session_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MFARequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MFARequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"code": obj.get("code"), "session_id": obj.get("session_id")}
        )
        return _obj
