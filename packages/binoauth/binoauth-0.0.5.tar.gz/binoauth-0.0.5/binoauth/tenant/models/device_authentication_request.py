...
class DeviceAuthenticationRequest(BaseModel):
    ...
    user_code: StrictStr
    __properties: ClassVar[List[str]] = ["user_code"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceAuthenticationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceAuthenticationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"user_code": obj.get("user_code")})
        return _obj
