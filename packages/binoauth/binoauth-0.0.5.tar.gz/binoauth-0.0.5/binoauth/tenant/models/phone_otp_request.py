...
class PhoneOTPRequest(BaseModel):
    ...
    phone: StrictStr = Field(
        description="International phone number (e.g., +1234567890)"
    )
    allowed_countries: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["phone", "allowed_countries"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PhoneOTPRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if allowed_countries (nullable) is None
        # and model_fields_set contains the field
        if (
            self.allowed_countries is None
            and "allowed_countries" in self.model_fields_set
        ):
            _dict["allowed_countries"] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PhoneOTPRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "phone": obj.get("phone"),
                "allowed_countries": obj.get("allowed_countries"),
            }
        )
        return _obj
