...
from binoauth.tenant.configuration import Configuration
from binoauth.tenant.api_response import ApiResponse, T as ApiResponseT
import binoauth.tenant.models
from binoauth.tenant import rest
from binoauth.tenant.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(binoauth.tenant.models, klass)
