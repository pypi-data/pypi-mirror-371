        ...
        all_stats = pd.Series(
            {
                ...
                # Risk metrics
                "volatility_annual_pct": nav_stats_all["Volatility (%)"],
                "max_drawdown_pct": nav_stats_all["Max Drawdown (%)"],
                # Risk-adjusted returns
                "sharpe_ratio": nav_stats_all["Sharpe Ratio"],
                # Performance metrics
                "hit_ratio_pct": nav_stats_all["Hit Ratio (%)"],
                "max_time_underwater_days": nav_stats_all["Max Tuw"],
                # Distribution metrics
                "skewness": nav_stats_all["Skewness"],
                "kurtosis": nav_stats_all["Kurtosis"],
        ...
        yearly_stats = pd.DataFrame(
            {
                ...
                # Risk metrics
                "volatility_annual_pct": nav_yearly["Volatility (%)"],
                "max_drawdown_pct": nav_yearly["Max Drawdown (%)"],
                # Risk-adjusted returns
                "sharpe_ratio": nav_yearly["Sharpe Ratio"],
                # Performance metrics
                "hit_ratio_pct": nav_yearly["Hit Ratio (%)"],
                "max_time_underwater_days": nav_yearly["Max Tuw"],
                # Distribution metrics
                "skewness": nav_yearly["Skewness"],
                "kurtosis": nav_yearly["Kurtosis"],
                # Portfolio concentration metrics
