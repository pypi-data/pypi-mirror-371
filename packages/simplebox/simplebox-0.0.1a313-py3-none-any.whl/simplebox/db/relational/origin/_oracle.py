...
class OracleOriginDb(OriginDb):
    ...
    def __init__(self, *, host, port, user, passwd, db, creator="cx_Oracle",  min_cached=10, max_cached=50,
                 max_shared=20, max_connections=1000, blocking=True, max_usage=0, set_session=None, **kwargs):
        self.__kwargs = {}
        ...
        self.__kwargs.setdefault("setsession", set_session)
