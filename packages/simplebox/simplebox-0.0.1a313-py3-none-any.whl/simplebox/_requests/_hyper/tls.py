...
Contains the TLS/SSL logic for use in _hyper.
"""
...
def init_context(cert_path=None, cert=None, cert_password=None):
    ...
    parameter to the :class:`HTTPConnection <_hyper.HTTPConnection>` class.
    Provide your own certificate file in case you don’t want to use _hyper’s
