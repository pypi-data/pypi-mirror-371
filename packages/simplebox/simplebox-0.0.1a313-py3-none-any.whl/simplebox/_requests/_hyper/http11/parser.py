# -*- coding: utf-8 -*-
"""
_hyper/http11/parser
~~~~~~~~~~~~~~~~~~~

This module contains _hyper's pure-Python HTTP/1.1 parser. This module defines
...
class Parser(object):
    ...
    def parse_response(self, buffer):
        ...
        :param buffer: A ``memoryview`` object wrapping a buffer containing a
            HTTP response.
        :returns: A :class:`Response <_hyper.http11.parser.Response>` object, or
