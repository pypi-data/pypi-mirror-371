# -*- coding: utf-8 -*-
"""
_hyper/http11/connection
~~~~~~~~~~~~~~~~~~~~~~~

Objects that build _hyper's connection-level HTTP/1.1 abstraction.
"""
import logging
import os
import socket
...
class HTTP11Connection(object):
    ...
    def __init__(self, host, port=None, secure=None, ssl_context=None,
        ...
        #: the standard _hyper parsing interface.
        self.parser = Parser()
    ...
    def close(self):
        ...
        :class:`Response <_hyper.http11.response.Response>` objects will throw
