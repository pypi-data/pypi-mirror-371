# -*- coding: utf-8 -*-
"""
_hyper/http20/window
~~~~~~~~~~~~~~~~~~~

Objects that understand flow control in _hyper.

HTTP/2 implements connection- and stream-level flow control. This flow
control is mandatory. Unfortunately, it's difficult for _hyper to be
...
class FlowControlManager(BaseFlowControlManager):
    """
    ``_hyper``'s default flow control manager.

    This implements _hyper's flow control algorithms. This algorithm attempts to
