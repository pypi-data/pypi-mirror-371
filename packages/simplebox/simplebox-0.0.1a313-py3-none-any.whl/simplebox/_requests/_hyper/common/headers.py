# -*- coding: utf-8 -*-
"""
_hyper/common/headers
~~~~~~~~~~~~~~~~~~~~~

Contains _hyper's structures for storing and working with HTTP headers.
"""
from collections.abc import MutableMapping

from .util import to_bytestring, to_bytestring_tuple
...
class HTTPHeaderMap(MutableMapping):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # This cost is judged acceptable in low-level code like `_hyper`, but
