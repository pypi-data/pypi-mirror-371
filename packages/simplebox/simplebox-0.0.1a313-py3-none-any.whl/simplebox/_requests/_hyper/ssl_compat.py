...
actually use in _hyper (all method signatures are complete, however). May be
...
# Referenced in _hyper/http20/connection.py. These values come
# from the python ssl package, and must be defined in this file
# for _hyper to work in python versions <2.7.9
