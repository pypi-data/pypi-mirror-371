# Making a new release of jupy_sqlite_extension
...
To test on [TestPyPI](https://test.pypi.org/), do the one-time setup first:
...
```bash
pip install -i https://test.pypi.org/simple/ jupy-sqlite-extension
```
