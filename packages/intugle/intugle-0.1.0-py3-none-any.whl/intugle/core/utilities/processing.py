...
def preprocess_profiling_data(profiling_data: pd.DataFrame,
                              sample_limit: int = 5,
    ...
    def __sample_process__(sample_data, limit=5):        
        ...
        if len(sample_data) != 0:
            sample_data = character_length_based_stratified_sampling(samples=sample_data, n_strata=limit, n_samples=int(settings.LLM_SAMPLE_LIMIT))
