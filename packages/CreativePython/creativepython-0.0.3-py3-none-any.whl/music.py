...
from creativepython_setup import find_soundfont  # finds local path for soundfont file
...
# calculate constants for the way we represent pitch bend in our API (-8192 to 8192)
...
_SOUNDFONT_PATH = find_soundfont()    # find soundfont's location

try:
   # load soundfont with slightly reduced decibels for some headroom
   DECIBEL_REDUCTION = -6.0
...
class AudioSample:
   ...
   def getFrameRate(self):
      """
      Returns the sample's defualt recording rate (e.g., 44100.0 Hz).
      """
...
class View:
   ...
   def notate(material):
      ...
      Note: The notation capability is limited to only one Phrase.
      But it allows to enter music as notation and save the Phrase as a MIDI file (among other options).
      """
      # TODO?
      print("View.notate is not implemented yet. Try Write.midi(material, filename) and then open the .mid file in a notation software like MuseScore.")
      ...
      #    print("View.notate: material must be a Score, Part, or Phrase.")
