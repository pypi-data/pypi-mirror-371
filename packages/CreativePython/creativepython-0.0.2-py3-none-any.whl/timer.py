...
class Timer():
   ...
   def __str__(self):
      ...
      return f"Timer: {self.getDelay()} ms, repeat: {self.getRepeat()}"   # string representation of the timer

   def __repr__(self):
      """Return the string representation for repr."""
      return str(self)   # use the string representation for repr
...
class Timer2:
   ...
   def start(self):
      ...
      if not self._running:
         ...
         # _timers.append(self)   # add this timer to the active timers list
