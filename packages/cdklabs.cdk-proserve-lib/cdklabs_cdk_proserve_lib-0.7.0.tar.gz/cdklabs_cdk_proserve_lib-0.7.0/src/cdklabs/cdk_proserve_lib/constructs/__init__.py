...
class OpenSearchProvisionDomain(
    ...
    def __init__(
        ...
        *,
        ...
        :param domain_type: (experimental) Type of the managed Amazon OpenSearch Service domain.
...
class OpenSearchProvisionDomainProps:
    ...
    def domain_type(self) -> builtins.str:
        '''(experimental) Type of the managed Amazon OpenSearch Service domain.

        :stability: experimental
        '''
        result = self._values.get("domain_type")
        assert result is not None, "Required property 'domain_type' is missing"
        return typing.cast(builtins.str, result)
