...
class TableProcessor(BaseProcessor):
    ...
    def _process_xl_tc(cls, xml: str) -> str:
        def process_tc(match):
            ...
            tc_props_str += f'<w:top w:val="none"/>' if border_top == 'none' else ''
            tc_props_str += f'<w:bottom w:val="none"/>' if border_bottom == 'none' else ''
            tc_props_str += f'<w:left w:val="none"/>' if border_left == 'none' else ''
            tc_props_str += f'<w:right w:val="none"/>' if border_right == 'none' else ''
