...
class TIcebergMergeSinkAction(object):
    DATA = 1
    DELETE = 2
    BOTH = 3
...
class TIcebergDeleteSink(object):
    ...
    def __init__(self, partition_key_exprs=None,):
        self.partition_key_exprs = partition_key_exprs
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i27 in range(_size23):
                        _elem28 = Exprs.ttypes.TExpr()
                        _elem28.read(iprot)
                        self.partition_key_exprs.append(_elem28)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.partition_key_exprs is not None:
            oprot.writeFieldBegin('partition_key_exprs', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.partition_key_exprs))
            for iter29 in self.partition_key_exprs:
                iter29.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TKuduTableSink(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i34 in range(_size30):
                        ...
                        self.referenced_columns.append(_elem35)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.referenced_columns is not None:
            ...
            for iter36 in self.referenced_columns:
...
class TJoinBuildSink(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i41 in range(_size37):
                        _elem42 = PlanNodes.ttypes.TEqJoinCondition()
                        _elem42.read(iprot)
                        self.eq_join_conjuncts.append(_elem42)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i47 in range(_size43):
                        _elem48 = PlanNodes.ttypes.TRuntimeFilterDesc()
                        _elem48.read(iprot)
                        self.runtime_filters.append(_elem48)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.eq_join_conjuncts is not None:
            ...
            for iter49 in self.eq_join_conjuncts:
                iter49.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.runtime_filters is not None:
            ...
            for iter50 in self.runtime_filters:
                iter50.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TDataSink(object):
    ...
    def __init__(self, type=None, stream_sink=None, table_sink=None, join_build_sink=None, plan_root_sink=None, label=None, estimated_stats=None, output_exprs=None, resource_profile=None, child_data_sinks=None,):
        self.type = type
        ...
        self.resource_profile = resource_profile
        self.child_data_sinks = child_data_sinks
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i55 in range(_size51):
                        _elem56 = Exprs.ttypes.TExpr()
                        _elem56.read(iprot)
                        self.output_exprs.append(_elem56)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                ...
                if ftype == TType.LIST:
                    self.child_data_sinks = []
                    (_etype60, _size57) = iprot.readListBegin()
                    for _i61 in range(_size57):
                        _elem62 = TDataSink()
                        _elem62.read(iprot)
                        self.child_data_sinks.append(_elem62)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.output_exprs is not None:
            ...
            for iter63 in self.output_exprs:
                iter63.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.resource_profile is not None:
            ...
            self.resource_profile.write(oprot)
            oprot.writeFieldEnd()
        if self.child_data_sinks is not None:
            oprot.writeFieldBegin('child_data_sinks', TType.LIST, 10)
            oprot.writeListBegin(TType.STRUCT, len(self.child_data_sinks))
            for iter64 in self.child_data_sinks:
                iter64.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
TDataSink.thrift_spec = (
    ...
    (10, TType.LIST, 'child_data_sinks', (TType.STRUCT, [TDataSink, None], False), None, ),  # 10
)
