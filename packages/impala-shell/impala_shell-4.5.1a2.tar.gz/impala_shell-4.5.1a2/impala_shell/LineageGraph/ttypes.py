...
class TVertexMetadata(object):
    ...
    def __init__(self, table_name=None, table_type=None, table_create_time=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.table_type = iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.I64:
    ...
    def write(self, oprot):
        ...
        if self.table_type is not None:
            oprot.writeFieldBegin('table_type', TType.STRING, 2)
            oprot.writeString(self.table_type)
            oprot.writeFieldEnd()
        if self.table_create_time is not None:
            oprot.writeFieldBegin('table_create_time', TType.I64, 3)
    ...
    def validate(self):
        ...
        if self.table_type is None:
            raise TProtocolException(message='Required field table_type is unset!')
...
TVertexMetadata.thrift_spec = (
    ...
    (2, TType.STRING, 'table_type', None, None, ),  # 2
    (3, TType.I64, 'table_create_time', None, None, ),  # 3
)
