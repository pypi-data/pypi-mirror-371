...
class TOpenParams(object):
    ...
    def __init__(self, query_id=None, table_name=None, init_string=None, authenticated_user_name=None, row_schema=None, batch_size=None, predicates=None, limit=None, clean_dbcp_ds_cache=None,):
    ...
    def write(self, oprot):
        ...
        if self.clean_dbcp_ds_cache is not None:
            oprot.writeFieldBegin('clean_dbcp_ds_cache', TType.BOOL, 9)
...
TOpenParams.thrift_spec = (
    ...
    (9, TType.BOOL, 'clean_dbcp_ds_cache', None, None, ),  # 9
)
