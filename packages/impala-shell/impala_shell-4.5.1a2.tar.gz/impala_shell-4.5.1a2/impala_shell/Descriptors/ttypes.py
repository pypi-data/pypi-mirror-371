...
class TTableDescriptor(object):
    ...
    def __init__(self, id=None, tableType=None, columnDescriptors=None, numClusteringCols=None, hdfsTable=None, hbaseTable=None, dataSourceTable=None, kuduTable=None, icebergTable=None, systemTable=None, tableName=None, dbName=None,):
        self.id = id
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.systemTable = CatalogObjects.ttypes.TSystemTable()
                    self.systemTable.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.icebergTable is not None:
            ...
            oprot.writeFieldEnd()
        if self.systemTable is not None:
            oprot.writeFieldBegin('systemTable', TType.STRUCT, 12)
            self.systemTable.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
TTableDescriptor.thrift_spec = (
    ...
    (12, TType.STRUCT, 'systemTable', [CatalogObjects.ttypes.TSystemTable, None], None, ),  # 12
)
