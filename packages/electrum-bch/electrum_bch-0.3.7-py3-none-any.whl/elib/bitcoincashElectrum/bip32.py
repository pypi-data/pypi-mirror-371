...
from . import ecc
from .bitcoin import hash_160, hmac_oneshot, rev_hex, int_to_hex, EncodeBase58Check, DecodeBase58Check
...
def _CKD_priv(parent_privkey: bytes, parent_chaincode: bytes,
    ...
    try:
        ...
        raise Exception('Impossible xprv (not within curve order)') from e
...
class InvalidMasterKeyVersionBytes(Exception): pass
