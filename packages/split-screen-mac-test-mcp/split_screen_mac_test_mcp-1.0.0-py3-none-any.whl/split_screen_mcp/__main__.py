...
def left_half() -> TextContent:
    ...
    return ok("left-half: done") if success else fail("left-half: failed")
...
def right_half() -> TextContent:
    ...
    return ok("right-half: done") if success else fail("right-half: failed")
...
def top_half() -> TextContent:
    ...
    return ok("top-half: done") if success else fail("top-half: failed")
...
def bottom_half() -> TextContent:
    ...
    return ok("bottom-half: done") if success else fail("bottom-half: failed")
...
def top_left() -> TextContent:
    ...
    return ok("top-left: done") if success else fail("top-left: failed")
...
def top_right() -> TextContent:
    ...
    return ok("top-right: done") if success else fail("top-right: failed")
...
def bottom_left() -> TextContent:
    ...
    return ok("bottom-left: done") if success else fail("bottom-left: failed")
...
def bottom_right() -> TextContent:
    ...
    return ok("bottom-right: done") if success else fail("bottom-right: failed")
...
def left_third() -> TextContent:
    ...
    return ok("left-third: done") if success else fail("left-third: failed")
...
def middle_third() -> TextContent:
    ...
    return ok("middle-third: done") if success else fail("middle-third: failed")
...
def right_third() -> TextContent:
    ...
    return ok("right-third: done") if success else fail("right-third: failed")
...
def left_two_thirds() -> TextContent:
    ...
    return ok("left-two-thirds: done") if success else fail("left-two-thirds: failed")
...
def right_two_thirds() -> TextContent:
    ...
    return ok("right-two-thirds: done") if success else fail("right-two-thirds: failed")
...
def maximize() -> TextContent:
    ...
    return ok("maximize: done") if success else fail("maximize: failed")
...
def fullscreen() -> TextContent:
    ...
    return ok("fullscreen: done") if success else fail("fullscreen: failed")
...
def minimize() -> TextContent:
    ...
    return ok("minimize: done") if success else fail("minimize: failed")
