...
Try out the examples: [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/HLinde/RedCamel/v0.1.5)
...
![Electron Wiggles](https://codeberg.org/FlashREMI/RedCamel/media/tag/v0.1.5/Electrons.png)
![Ion fragmentation](https://codeberg.org/FlashREMI/RedCamel/media/tag/v0.1.5/Ions.png)
