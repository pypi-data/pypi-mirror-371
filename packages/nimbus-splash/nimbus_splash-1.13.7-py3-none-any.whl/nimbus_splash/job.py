...
def parse_input_contents(input_file: str | pathlib.Path,
    ...
    try:
        ...
        if _palprocs:
            ...
            ut.red_exit('e.g. %pal nprocs 16 end')
    ...
    if n_procs and _palprocs:
        ut.red_exit(
            'Error: Both %PAL and !PAL found in input file'
        )
    ...
    try:
        ...
        ut.cprint(f'Missing max per-core memory in {input_file}', 'red')
        ut.red_exit('e.g. %maxcore 3000')
