...
class AdditionalMetric(BaseModel):
    name: StrictStr = ...
    value: StrictStr = ...
    full_precision_value: float = Field(..., alias="fullPrecisionValue")
    tooltip_text: Optional[StrictStr] = Field(None, alias="tooltipText")
    link: Optional[StrictStr] = None
    __properties = ["name", "value", "fullPrecisionValue", "tooltipText", "link"]
    ...
    def from_dict(cls, obj: dict) -> AdditionalMetric:
        ...
        _obj = AdditionalMetric.construct(**{
            "name": obj.get("name"),
            "value": obj.get("value"),
            "full_precision_value": obj.get("fullPrecisionValue"),
