...
class TunerTrialImpulse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TunerTrialImpulse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TunerTrialImpulse:
        """Create an instance of TunerTrialImpulse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TunerTrialImpulse.construct(**obj)

        _obj = TunerTrialImpulse.construct(**{
