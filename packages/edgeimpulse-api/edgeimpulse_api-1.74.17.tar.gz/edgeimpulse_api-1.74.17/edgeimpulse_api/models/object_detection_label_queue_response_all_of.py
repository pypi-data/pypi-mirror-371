...
class ObjectDetectionLabelQueueResponseAllOf(BaseModel):
    samples: List[ObjectDetectionLabelQueueResponseAllOfSamples] = ...
    ...
    def from_dict(cls, obj: dict) -> ObjectDetectionLabelQueueResponseAllOf:
        ...
        _obj = ObjectDetectionLabelQueueResponseAllOf.construct(**{
            "samples": [ObjectDetectionLabelQueueResponseAllOfSamples.from_dict(_item) for _item in obj.get("samples")] if obj.get("samples") is not None else None
        })
        return _obj
