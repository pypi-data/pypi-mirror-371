...
class ProjectInfoResponseAllOfExperiments(BaseModel):
    type: StrictStr = ...
    title: StrictStr = ...
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectInfoResponseAllOfExperiments:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectInfoResponseAllOfExperiments:
        """Create an instance of ProjectInfoResponseAllOfExperiments from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProjectInfoResponseAllOfExperiments.construct(**obj)

        _obj = ProjectInfoResponseAllOfExperiments.construct(**{
            "type": obj.get("type"),
            "title": obj.get("title"),
            "help": obj.get("help"),
