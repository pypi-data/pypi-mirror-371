...
class StartEnterpriseTrialRequest(BaseModel):
    ...
    __properties = ["email", "name", "organizationName", "expirationDate", "notes", "useCase", "userHasMLModelsInProduction", "companyName", "companySize", "country", "stateOrProvince", "redirectUrlOrigin", "redirectUrlQueryParams"]
