...
class GetSyntheticDataConfigResponseAllOf(BaseModel):
    ...
    __properties = ["recentJobs", "lastUsedTransformationBlockId", "lastUsedParameters"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetSyntheticDataConfigResponseAllOf:
        """Create an instance of GetSyntheticDataConfigResponseAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSyntheticDataConfigResponseAllOf:
        """Create an instance of GetSyntheticDataConfigResponseAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetSyntheticDataConfigResponseAllOf.construct(**obj)

        _obj = GetSyntheticDataConfigResponseAllOf.construct(**{
