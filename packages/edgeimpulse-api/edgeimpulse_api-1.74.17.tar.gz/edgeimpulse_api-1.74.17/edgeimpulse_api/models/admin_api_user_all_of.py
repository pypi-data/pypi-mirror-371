...
class AdminApiUserAllOf(BaseModel):
    ...
    __properties = ["email", "activated", "organizations", "projects", "experiments", "evaluation", "ambassador", "tier", "lastSeen", "suspended", "trials", "dailyMetrics"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdminApiUserAllOf:
    ...
    def from_dict(cls, obj: dict) -> AdminApiUserAllOf:
        ...
        if type(obj) is not dict:
            return AdminApiUserAllOf.construct(**obj)

        _obj = AdminApiUserAllOf.construct(**{
            "email": obj.get("email"),
