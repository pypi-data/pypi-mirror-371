...
class DSPMetadata(BaseModel):
    ...
    __properties = ["created", "generated", "dspConfig", "labels", "featureLabels", "windowCount", "featureCount", "includedSamples", "windowSizeMs", "windowIncreaseMs", "padZeros", "frequency", "outputConfig", "fftUsed", "resamplingAlgorithmVersion", "featureExplorerJobId", "featureExplorerJobFailed", "featureImportanceJobId", "featureImportanceJobFailed"]
    ...
    def from_dict(cls, obj: dict) -> DSPMetadata:
        ...
        if type(obj) is not dict:
            return DSPMetadata.construct(**obj)

        _obj = DSPMetadata.construct(**{
