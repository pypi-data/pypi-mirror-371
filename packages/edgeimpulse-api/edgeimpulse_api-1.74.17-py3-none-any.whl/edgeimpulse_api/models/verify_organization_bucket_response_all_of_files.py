...
class VerifyOrganizationBucketResponseAllOfFiles(BaseModel):
    ...
    size: StrictInt = Field(..., description="The size of the file in bytes.")
    folder_name: StrictStr = Field(..., alias="folderName", description="The name of the folder containing the file.")
