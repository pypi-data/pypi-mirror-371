...
class CreateWhitelabelRequest(BaseModel):
    ...
    __properties = ["name", "domain", "ownerOrganizationId", "identityProviders", "allowPasswordAuth", "deploymentTargets", "documentationUrl", "allowSignup", "allowFreeProjects", "sandboxed", "exposePublicProjects", "learningBlocks", "organizationsLimit"]
