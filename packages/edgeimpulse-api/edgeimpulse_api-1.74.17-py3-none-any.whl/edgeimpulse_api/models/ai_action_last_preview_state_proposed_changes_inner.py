...
class AIActionLastPreviewStateProposedChangesInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AIActionLastPreviewStateProposedChangesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AIActionLastPreviewStateProposedChangesInner:
        """Create an instance of AIActionLastPreviewStateProposedChangesInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AIActionLastPreviewStateProposedChangesInner.construct(**obj)

        _obj = AIActionLastPreviewStateProposedChangesInner.construct(**{
