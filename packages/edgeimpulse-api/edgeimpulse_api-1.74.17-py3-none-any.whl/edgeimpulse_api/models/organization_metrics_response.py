...
class OrganizationMetricsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationMetricsResponse:
        """Create an instance of OrganizationMetricsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationMetricsResponse:
        """Create an instance of OrganizationMetricsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return OrganizationMetricsResponse.construct(**obj)

        _obj = OrganizationMetricsResponse.construct(**{
