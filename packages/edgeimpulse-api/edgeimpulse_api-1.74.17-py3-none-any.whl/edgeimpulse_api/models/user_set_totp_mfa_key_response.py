...
class UserSetTotpMfaKeyResponse(BaseModel):
    ...
    __properties = ["success", "error", "recoveryCodes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserSetTotpMfaKeyResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserSetTotpMfaKeyResponse:
        """Create an instance of UserSetTotpMfaKeyResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UserSetTotpMfaKeyResponse.construct(**obj)

        _obj = UserSetTotpMfaKeyResponse.construct(**{
