...
class SetSampleStructuredLabelsRequest(BaseModel):
    structured_labels: List[StructuredLabel] = Field(..., alias="structuredLabels")
    __properties = ["structuredLabels"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetSampleStructuredLabelsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetSampleStructuredLabelsRequest:
        """Create an instance of SetSampleStructuredLabelsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SetSampleStructuredLabelsRequest.construct(**obj)

        _obj = SetSampleStructuredLabelsRequest.construct(**{
