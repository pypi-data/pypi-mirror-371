...
class GetAllDetailedImpulsesResponse(BaseModel):
    ...
    __properties = ["success", "error", "impulses", "metricKeysByCategory", "extraTableColumns"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAllDetailedImpulsesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAllDetailedImpulsesResponse:
        """Create an instance of GetAllDetailedImpulsesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetAllDetailedImpulsesResponse.construct(**obj)

        _obj = GetAllDetailedImpulsesResponse.construct(**{
