...
class AnomalyModelMetadataResponse(BaseModel):
    ...
    __properties = ["success", "error", "created", "scale", "mean", "clusters", "axes", "defaultMinimumConfidenceRating", "availableModelTypes", "recommendedModelType", "modelValidationMetrics", "hasTrainedModel", "thresholds"]
