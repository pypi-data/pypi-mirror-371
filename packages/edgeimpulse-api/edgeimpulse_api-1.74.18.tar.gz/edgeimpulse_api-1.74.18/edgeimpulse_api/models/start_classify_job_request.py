...
class StartClassifyJobRequest(BaseModel):
    ...
    skip_feature_generation: Optional[StrictBool] = Field(None, alias="skipFeatureGeneration", description="If enabled, skips feature generation altogether. Used e.g. if you update thresholds.")
    __properties = ["modelVariants", "skipFeatureGeneration"]
    ...
    def from_dict(cls, obj: dict) -> StartClassifyJobRequest:
        ...
        _obj = StartClassifyJobRequest.construct(**{
            ...
            "skip_feature_generation": obj.get("skipFeatureGeneration")
        })
        return _obj
