...
class DspRunResponseWithSample(BaseModel):
    ...
    label_at_end_of_window: Optional[StrictStr] = Field(None, alias="labelAtEndOfWindow", description="DEPRECATED. Label at the end of the window (only present for time-series data)")
    label_for_window: Optional[StrictStr] = Field(None, alias="labelForWindow", description="Label for the window. How the label is chosen is dependent on the value of \"labelingMethodMultiLabel\" in the input block.")
    ...
    __properties = ["success", "error", "features", "graphs", "labels", "state_string", "labelAtEndOfWindow", "labelForWindow", "sample", "performance", "canProfilePerformance"]
    ...
    def from_dict(cls, obj: dict) -> DspRunResponseWithSample:
        ...
        _obj = DspRunResponseWithSample.construct(**{
            ...
            "label_for_window": obj.get("labelForWindow"),
