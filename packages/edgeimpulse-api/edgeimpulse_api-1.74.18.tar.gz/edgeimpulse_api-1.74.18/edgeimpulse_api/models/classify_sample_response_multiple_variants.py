...
class ClassifySampleResponseMultipleVariants(BaseModel):
    ...
    __properties = ["success", "error", "results", "sample", "windowSizeMs", "windowIncreaseMs", "alreadyInDatabase"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassifySampleResponseMultipleVariants:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassifySampleResponseMultipleVariants:
        """Create an instance of ClassifySampleResponseMultipleVariants from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ClassifySampleResponseMultipleVariants.construct(**obj)

        _obj = ClassifySampleResponseMultipleVariants.construct(**{
