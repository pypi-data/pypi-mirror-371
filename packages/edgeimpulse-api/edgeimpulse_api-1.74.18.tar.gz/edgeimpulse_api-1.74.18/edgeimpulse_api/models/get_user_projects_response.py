...
class GetUserProjectsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetUserProjectsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetUserProjectsResponse:
        """Create an instance of GetUserProjectsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetUserProjectsResponse.construct(**obj)

        _obj = GetUserProjectsResponse.construct(**{
