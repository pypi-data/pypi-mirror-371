...
class ClassifySampleResponseMultipleVariantsAllOf(BaseModel):
    ...
    __properties = ["results", "sample", "windowSizeMs", "windowIncreaseMs", "alreadyInDatabase"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassifySampleResponseMultipleVariantsAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassifySampleResponseMultipleVariantsAllOf:
        """Create an instance of ClassifySampleResponseMultipleVariantsAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ClassifySampleResponseMultipleVariantsAllOf.construct(**obj)

        _obj = ClassifySampleResponseMultipleVariantsAllOf.construct(**{
            "results": [ClassifySampleResponseVariantResults.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
