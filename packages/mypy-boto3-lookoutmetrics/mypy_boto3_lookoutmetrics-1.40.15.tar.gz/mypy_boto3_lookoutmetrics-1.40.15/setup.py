...
setup(
    ...
    description="Type annotations for boto3 LookoutMetrics 1.40.15 service generated with mypy-boto3-builder 8.11.0",
    classifiers=[
    ...
    keywords="boto3 lookoutmetrics boto3-stubs type-annotations mypy typeshed autocomplete",
