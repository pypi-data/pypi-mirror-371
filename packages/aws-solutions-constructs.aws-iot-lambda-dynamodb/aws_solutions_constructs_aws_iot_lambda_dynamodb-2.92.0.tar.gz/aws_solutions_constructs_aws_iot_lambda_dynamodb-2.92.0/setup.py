    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_iot_lambda_dynamodb._jsii": [
            "aws-iot-lambda-dynamodb@2.92.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_iot_lambda_dynamodb": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-constructs.aws-iot-lambda==2.92.0",
        "aws-solutions-constructs.aws-lambda-dynamodb==2.92.0",
        "aws-solutions-constructs.core==2.92.0",
