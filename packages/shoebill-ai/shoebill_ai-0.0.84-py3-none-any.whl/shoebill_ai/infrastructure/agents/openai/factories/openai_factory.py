...
from ..repositories.openai_generate_repository import OpenAIGenerateRepository
...
class OpenAIFactory(ModelFactory):
    ...
    def __init__(self, api_key: str, temperature: float = 0.7, max_tokens: int = 2000,
                 organization: str = None, system_prompt: str = None,
    ...
    def create_generate_repository(self) -> LlmGenerateRepository:
        ...
        return OpenAIGenerateRepository(**kwargs)
