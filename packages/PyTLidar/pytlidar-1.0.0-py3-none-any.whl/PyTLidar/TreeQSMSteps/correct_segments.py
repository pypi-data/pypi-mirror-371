...
def correct_segments(P,cover,segment,inputs,RemSmall=None,ModBases=None,AddChild=None):
    ...
    Args:
        ...
        RemSmall (boolean, optional): If True, removes small segments, this happens on the second pass. Defaults to None.
        ModBases (boolean, optional): If True, modifies the bases of segments, this happens on the second pass. Defaults to None.
        AddChild (boolean, optional): If True, adds the expanded base to the child segment and removes it from the parent, this happens on the second pass. Defaults to None.
