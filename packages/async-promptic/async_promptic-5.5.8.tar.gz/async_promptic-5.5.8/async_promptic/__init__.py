    ...
    async def ensure_server_running(self, server_config: dict) -> Any:
        ...
        if server_name not in self.running_servers:
            ...
            try:
                ...
                from fastmcp.mcp_config import StdioMCPServer, MCPConfig
                
                # Create StdioMCPServer with the server configuration
                # Only pass the specific env vars configured for this server
                ...
                # Wrap it in an MCPConfig
                mcp_config = MCPConfig(mcpServers={server_name: stdio_server})
                
                # Create client with the MCPConfig
