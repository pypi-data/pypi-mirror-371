...
class QueryFilter(_message.Message):
    __slots__ = ("tenant_id", "project_id", "session_id", "agent_id", "span_id", "types", "statuses", "severities", "tags", "text_query", "time")
    ...
    text_query: str
    time: TimeRange
    def __init__(self, tenant_id: _Optional[str] = ..., project_id: _Optional[str] = ..., session_id: _Optional[str] = ..., agent_id: _Optional[str] = ..., span_id: _Optional[str] = ..., types: _Optional[_Iterable[_Union[_events_pb2.EventType, str]]] = ..., statuses: _Optional[_Iterable[_Union[_events_pb2.EventStatus, str]]] = ..., severities: _Optional[_Iterable[_Union[_events_pb2.Severity, str]]] = ..., tags: _Optional[_Iterable[str]] = ..., text_query: _Optional[str] = ..., time: _Optional[_Union[TimeRange, _Mapping]] = ...) -> None: ...

class QueryRequest(_message.Message):
    __slots__ = ("filter", "page_size", "page_token", "order_by_time")
...
class Capabilities(_message.Message):
    __slots__ = ("worm_retention", "audit_proofs", "distributed_query", "rbac", "sso", "policy_decisions", "data_access_events")
