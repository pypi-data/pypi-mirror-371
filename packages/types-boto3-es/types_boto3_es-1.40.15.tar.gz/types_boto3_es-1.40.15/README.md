<a id="types-boto3-es"></a>

# types-boto3-es

[![PyPI - types-boto3-es](https://img.shields.io/pypi/v/types-boto3-es.svg?color=blue)](https://pypi.org/project/types-boto3-es/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-es.svg?color=blue)](https://pypi.org/project/types-boto3-es/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-es)](https://pypistats.org/packages/types-boto3-es)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 ElasticsearchService 1.40.15](https://pypi.org/project/boto3/)
...
[types-boto3-es docs](https://youtype.github.io/types_boto3_docs/types_boto3_es/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-es](#types-boto3-es)
...
- Install `types-boto3[es]` in your environment:
...
- Install `types-boto3[es]` with services you use in your environment:
...
`types-boto3-es` dependency in production. However, there is an issue in
...
from types_boto3_es import ElasticsearchServiceClient
...
`types_boto3_es.paginator` module contains type annotations for all paginators.
...
`types_boto3_es.literals` module contains literals extracted from shapes that
can be used in user code for type checking.

Full list of `ElasticsearchService` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_es/literals/).
...
`types_boto3_es.type_defs` module contains structures and shapes assembled to
typed dictionaries and unions for additional type checking.

Full list of `ElasticsearchService` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_es/type_defs/).
...
`types-boto3-es` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_es/)
