...
class ClientAPI:
    ...
    def list_timeseries(
        ...
        """
        List available timeseries from the server via /api/timeseries endpoint.
        ...
        Returns:
            pandas.DataFrame or list: Timeseries info.
        """
        url = os.environ['SHAREDDATA_ENDPOINT'] if not endpoint else endpoint
        url += '/api/timeseries'
        params = {'keyword': keyword, 'user': user}
    ...
    def get_timeseries(database, period, source, tag,
                      ...
                      token=None, user=None):
        """
        Fetches timeseries data from a specified API endpoint using efficient binary format.
        ...
        Parameters:
            ...
            columns (list, optional): Filter by specific columns.
            dropna (bool, optional): Whether to drop NaN rows, defaults to True.
            token (str, optional): Authentication token.
            user (str, optional): User identifier.
        
        Returns:
            pandas.DataFrame: The retrieved timeseries data.
        """
        url = os.environ['SHAREDDATA_ENDPOINT'] if not endpoint else endpoint
    ...
    def post_timeseries(database, period, symbol, tag,
                       ...
                       token=None, user=None):
        """
        Post timeseries data to a specified endpoint or create empty timeseries with columns.
        ...
        Parameters:
            ...
            tag (str): The tag identifier, optionally including a subfolder separated by '/'.
            value (pandas.DataFrame, optional): The timeseries data to post.
            columns (pandas.Index or list, optional): Column names for creating empty timeseries.
            endpoint (str, optional): Custom API endpoint URL.
            token (str, optional): Authentication token.
            user (str, optional): User identifier.
    ...
    def create_timeseries(database, period, source,
        ...
        This method creates a new timeseries container similar to calling shdata.timeseries() directly.
        
        Parameters:
            database (str): The database name.
            period (str): The period identifier.
            source (str): The source identifier.
            startdate (pandas.Timestamp or str, optional): Start date for the timeseries.
            columns (list of str, optional): List of column names for the timeseries.
            endpoint (str, optional): Custom API endpoint URL.
            token (str, optional): Authentication token.
            user (str, optional): User identifier.
        
        Returns:
            dict: Response from the server confirming creation.
        """
        url = os.environ['SHAREDDATA_ENDPOINT'] if not endpoint else endpoint
    ...
    @staticmethod
    def head_timeseries(database, period, symbol, tag,
                       endpoint=None, token=None, user=None):
        """
        Get metadata for timeseries data from a specified endpoint.
        ...
        Returns:
            requests.Response: The HEAD response object with headers.
        """
        url = os.environ['SHAREDDATA_ENDPOINT'] if not endpoint else endpoint
    ...
    def write_timeseries(database, period, source, tag,
                        ...
                        endpoint=None, token=None, user=None):
        """
        Trigger a write operation for a specific timeseries tag.
        
        This method calls the underlying timeseries container's write() method to flush
        data to persistent storage for a specific tag.
        ...
        Parameters:
            ...
            source (str): The source identifier.
            tag (str): The tag identifier, optionally including a subfolder separated by '/'.
            startdate (str or pandas.Timestamp, optional): Optional start date for the write operation.
            endpoint (str, optional): Custom API endpoint URL.
            token (str, optional): Authentication token.
            user (str, optional): User identifier.
        
        Returns:
            dict: Response from the server confirming the write operation.
        """
        url = os.environ['SHAREDDATA_ENDPOINT'] if not endpoint else endpoint
    ...
    def write_timeseries_source(database, period, source,
                               ...
                               endpoint=None, token=None, user=None):
        """
        Trigger a write operation for all timeseries in a source container.
