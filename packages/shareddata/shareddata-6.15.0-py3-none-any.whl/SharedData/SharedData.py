...
class SharedData:    
    ...
    def list_timeseries(self, keyword='', user='master'):
        """
        Retrieve and merge data from remote, local sources into a single DataFrame for timeseries data.
        ...
        Returns:
            pandas.DataFrame: A DataFrame containing merged and cleaned metadata from remote and local sources,
            with standardized columns and filled missing values, filtered to only include timeseries containers.
        """
        dfremote = self.list_remote(keyword, user=user)
        dflocal = self.list_local(keyword, user=user)        
    ...
    def list_streams(self, keyword='', user='master'):
        """
        List and summarize streams from the MongoDB database.
        ...
        Returns:
            pd.DataFrame: A DataFrame containing metadata about the streams, including:
        """        
