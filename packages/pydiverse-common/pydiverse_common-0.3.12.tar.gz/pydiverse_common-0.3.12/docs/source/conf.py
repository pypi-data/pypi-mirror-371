...
_mod = importlib.import_module("pydiverse.common")

# -- Project information -----------------------------------------------------
# https://www.sphinx-doc.org/en/master/usage/configuration.html#project-information

project = "pydiverse.common"
copyright = f"{datetime.date.today().year}, QuantCo, Inc"
author = "QuantCo, Inc."

release = importlib.metadata.version("pydiverse.common")
...
html_title = "pydiverse.common"

html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/pydiverse/pydiverse.common/",
            "html": """
    ...
    "source_repository": "https://github.com/pydiverse/pydiverse.common/",
    "source_branch": "main",
...
def linkcode_resolve(domain, info):
    ...
    try:
        ...
        return (
            "https://github.com/pydiverse/pydiverse.common"
            f"/tree/{release}/src/pydiverse/common/{fn}{linespec}"
        )
