...
@mcp.tool()
def get_transcript(folder_id: str, conversation_ids: List[str]) -> Dict[str, Any]:
...
@mcp.tool()
def generate_transcription(conversation_ids: List[str]) -> Dict[str, Any] | list[types.TextContent]:
