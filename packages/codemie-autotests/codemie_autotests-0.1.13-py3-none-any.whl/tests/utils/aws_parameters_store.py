...
class CredentialsUtil:
    ...
    def gitlab_credentials():
        return [
            CredentialValues(key="url", value=os.getenv("GITLAB_URL")),
            CredentialValues(key="name", value="test-token-name"),
            CredentialValues(key="token", value=os.getenv("GITLAB_TOKEN")),
        ]

    @staticmethod
    def github_credentials():
        return [
            CredentialValues(key="url", value=os.getenv("GITHUB_URL")),
            CredentialValues(key="name", value=""),
            CredentialValues(key="token", value=os.getenv("GITHUB_TOKEN")),
        ]
