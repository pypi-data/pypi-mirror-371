...
EN['0035'] ='[SCF INFO]     If train_dat_name data has been updated, make sure to rerun FREQ_BINS_STEP, OPT_BINS_STEP, and WOE_STEP. Please do not update train_dat_name data within dat_update.'
...
EN['1074'] = '[SCF Error 1074] Error occurred while calculating stepwise regression forward operation, currently contains column: %s, attempt to join column: %s'
EN['1075'] = '[SCF Error 1075] Error occurred while calculating stepwise backward operation, currently contains column: %s, trying to remove column: %s'
...
EN['0084'] = '[SCF INFO] Round %d: Modeling ends when the specified round is exceeded. Appropriately raising iter_num may result in a better model '
EN['0085'] = '[SCF INFO] If the specified round is exceeded, modeling ends. Appropriately raising iter_num may result in a better model '
EN['0086'] = 'Round %d: All variables enter the model, modeling ends'
EN['0087'] = 'All variables enter the model, modeling ends'
...
EN['0092'] = 'Round %d: No variables can enter the model, modeling ends'
EN['0093'] = 'No variables can enter the model, modeling ends'
...
EN['0097'] = 'Round %d: under the premise of meeting the conditions set by the user, the index of the model cannot be further improved by adding or deleting variables, the modeling ends'
EN['0098'] = 'On the premise of meeting the conditions set by the user, the index of the model cannot be further improved by adding or deleting variables, end of modeling'
...
EN['0103'] = 'Round %d: Modeling ends when the specified round is reached. Appropriately raising iter_num may result in a better model '
EN['0104'] = 'When the specified round is reached, modeling ends. Appropriately raising iter_num may result in a better model '
EN['0105'] = 'Round %d: All variables enter the model, modeling ends'
EN['0106'] = 'All variables enter the model, modeling ends'
EN['0107'] = 'Round %d complete'
...
EN['0140'] = 'After joining, the model metrics improved, but due to iter_num reaching its limit, it was not added to the model'
...
EN['0154'] = 'Group conflict exists with variable %s'
