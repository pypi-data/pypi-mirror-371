...
from vgrid.utils.io import process_input_data_bin, convert_to_output_format, validate_isea4t_resolution		
from vgrid.utils.constants import STATS_OPTIONS, OUTPUT_FORMATS, STRUCTURED_FORMATS

def isea4t_bin(data, resolution, stats="count", category=None, numeric_field=None, lat_col="lat", lon_col="lon", **kwargs):
	"""
	...
	grid_gdf = isea4t_grid_within_bbox(resolution=resolution, bbox=(minx, miny, maxx, maxy))
