...
OUTPUT_FORMATS = [
    None,
    "geojson_dict", "json_dict", 
    "gpd", "geopandas", "gdf", "geodataframe", 
    "csv",
    "geojson", "json", 
    "shp","shapefile", 
    "gpkg", "geopackage", 
...
DGGAL_TYPES = {
    "gnosis": {"min_res": 0, "max_res": 28, "class_name": "GNOSISGlobalGrid"},
    "isea3h": {"min_res": 0, "max_res": 33, "class_name": "ISEA3H"},
    "isea9r": {"min_res": 0, "max_res": 16, "class_name": "ISEA9R"},
    "ivea3h": {"min_res": 0, "max_res": 33, "class_name": "IVEA3H"},
    "ivea9r": {"min_res": 0, "max_res": 16, "class_name": "IVEA9R"},
    "rtea3h": {"min_res": 0, "max_res": 33, "class_name": "RTEA3H"},
    "rtea9r": {"min_res": 0, "max_res": 16, "class_name": "RTEA9R"},
    "rhealpix": {"min_res": 0, "max_res": 16, "class_name": "rHEALPix"}
}

DGGRID_TYPES = {
   "SUPERFUND": {"min_res": 0, "max_res": 9}, # error when calling dggrid_instance.grid_stats_table
   "PLANETRISK": {"min_res": 0, "max_res": 22},
   "ISEA3H": {"min_res": 0, "max_res": 35}, 
   "ISEA4H": {"min_res": 0, "max_res": 30}, 
   "ISEA4T": {"min_res": 0, "max_res": 29}, 
   "ISEA4D": {"min_res": 0, "max_res": 30},      
   "ISEA43H": {"min_res": 0, "max_res": 35},
   "ISEA7H": {"min_res": 0, "max_res": 21},
   "IGEO7": {"min_res": 0, "max_res": 20}, # error when calling dggrid_instance.grid_stats_table
   "FULLER3H": {"min_res": 0, "max_res": 35},
   "FULLER4H": {"min_res": 0, "max_res": 30},
   "FULLER4T": {"min_res": 0, "max_res": 29},
   "FULLER4D": {"min_res": 0, "max_res": 30},
   "FULLER43H": {"min_res": 0, "max_res": 35},
   "FULLER7H": {"min_res": 0, "max_res": 21}
}
