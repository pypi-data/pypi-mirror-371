...
@shell.define
class Dwi2Mask_Trace(shell.Task["Dwi2Mask_Trace.Outputs"]):
    """
    ...
    **Copyright:** Copyright (c) 2008-2025 the MRtrix3 contributors.
    ...
    max_iters: int | None = shell.arg(
        help="Set the maximum number of iterations for the algorithm (default: 10)",
        argstr="-max_iters",
        default=None,
    )
    ...
    clean_scale: int | None = shell.arg(
        help="the maximum scale used to cut bridges. A certain maximum scale cuts bridges up to a width (in voxels) of 2x the provided scale. Setting this to 0 disables the mask cleaning step. (Default: 2)",
        argstr="-clean_scale",
        default=None,
    )
