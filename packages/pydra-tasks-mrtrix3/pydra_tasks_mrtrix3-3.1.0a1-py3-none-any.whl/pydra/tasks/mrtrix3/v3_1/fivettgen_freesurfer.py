...
@shell.define
class FivettGen_Freesurfer(shell.Task["FivettGen_Freesurfer.Outputs"]):
    """
    ...
    **Copyright:** Copyright (c) 2008-2025 the MRtrix3 contributors.
    ...
    executable = ("5ttgen", "freesurfer")

    in_file: ImageIn = shell.arg(
        position=1,
        argstr="",
        help='The input FreeSurfer parcellation image (any image containing "aseg" in its name)',
    )
    lut: File | None = shell.arg(
        help="Manually provide path to the lookup table on which the input parcellation image is based (e.g. FreeSurferColorLUT.txt)",
        argstr="-lut",
        default=None,
    )
