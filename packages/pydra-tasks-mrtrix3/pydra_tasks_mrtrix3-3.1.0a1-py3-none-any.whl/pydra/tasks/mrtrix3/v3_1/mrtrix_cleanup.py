...
@shell.define(xor=[["info", "quiet", "debug", None], ["test", "failed", None]])
class MrTrix_Cleanup(shell.Task["MrTrix_Cleanup.Outputs"]):
    """
    ...
    **Copyright:** Copyright (c) 2008-2025 the MRtrix3 contributors.
    ...
    executable = "mrtrix_cleanup"

    path: Directory = shell.arg(
        position=1,
        argstr="",
    ...
    test: bool = shell.arg(
        help="Run script in test mode: will list identified files / directories, but not attempt to delete them",
        argstr="-test",
        default=False,
    )

    class Outputs(shell.Outputs):
        failed: File | None = shell.outarg(
            help="Write list of items that the script failed to delete to a text file",
            argstr="-failed",
            default=None,
            path_template="failed.txt",
        )
