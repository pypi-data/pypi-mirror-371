...
@shell.define
class Dwi2Mask_Consensus(shell.Task["Dwi2Mask_Consensus.Outputs"]):
    """
    ...
    **Copyright:** Copyright (c) 2008-2025 the MRtrix3 contributors.
    ...
    threshold: float | None = shell.arg(
        help="The fraction of algorithms that must include a voxel for that voxel to be present in the final mask (default: 0.501)",
        argstr="-threshold",
        default=None,
    )
