...
class DwiNormalise_Manual(shell.Task["DwiNormalise_Manual.Outputs"]):
    """
    ...
    **Copyright:** Copyright (c) 2008-2025 the MRtrix3 contributors.
    ...
    input_dwi: ImageIn = shell.arg(
        position=1,
        argstr="",
        help="The input DWI series",
    )
    input_mask: ImageIn = shell.arg(
        position=2,
        argstr="",
    ...
    intensity: float | None = shell.arg(
        help="Normalise the b=0 signal to a specified value (Default: 1000)",
        argstr="-intensity",
        default=None,
    )
    percentile: float | None = shell.arg(
        help="Define the percentile of the b=0 image intensties within the mask used for normalisation; if this option is not supplied then the median value (50th percentile) will be normalised to the desired intensity value",
        argstr="-percentile",
        default=None,
    )
