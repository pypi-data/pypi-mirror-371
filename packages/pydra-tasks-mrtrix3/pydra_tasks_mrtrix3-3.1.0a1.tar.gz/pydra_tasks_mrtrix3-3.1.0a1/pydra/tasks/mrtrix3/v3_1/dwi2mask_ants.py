...
@shell.define
class Dwi2Mask_Ants(shell.Task["Dwi2Mask_Ants.Outputs"]):
    """
    ...
    **Copyright:** Copyright (c) 2008-2025 the MRtrix3 contributors.
    ...
    template: ImageIn | None = shell.arg(
        help="Provide the template image and corresponding mask for antsBrainExtraction.sh to use; the template image should be T2-weighted.",
        argstr="-template",
        default=None,
    )
