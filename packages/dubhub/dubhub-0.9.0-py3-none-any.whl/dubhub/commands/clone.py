...
class CloneCommand(BaseCommand):
    def add_arguments(self, parser):
        ...
        parser_start.add_argument(
            "--host",
            type=str,
            help="Host URL for the API server (CLI > DUBHUB_HOST > config, defaults to https://app.dubhub.io)",
        )
        parser_start.add_argument(
            "-v", "--verbose",
            action="store_true",
    ...
    def start(self, args, server):
        ...
        try:
            api_host = utils.get_config_value(
                args.host, "DUBHUB_HOST", "host", default="https://app.dubhub.io"
            )
        except ValueError as e:
        ...
        try:
            ...
            if status_response.status_code == 200:
                ...
                if clone_status != "stopped":
                    ...
                    print("Please stop the clone first using 'dubhub clone stop' command.")
                    return
            else:
