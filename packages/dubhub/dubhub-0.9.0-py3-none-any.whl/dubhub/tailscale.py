"""
Tailscale integration module for dubhub CLI.
...
class TailscaleForwarder:
    ...
    def _get_binary_path(self) -> str:
        ...
        if not binary_path.exists():
            raise FileNotFoundError(
                f"Tailscale forwarder binary not found: {binary_path}. "
                f"Expected binary for {system}-{arch}"
            )
    ...
    def _create_clean_binary_symlink(self):
        ...
        temp_dir = tempfile.mkdtemp(prefix="dubhub_")
