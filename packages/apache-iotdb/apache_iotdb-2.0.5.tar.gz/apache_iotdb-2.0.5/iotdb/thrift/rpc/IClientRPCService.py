...
class Iface(object):
    ...
    def executeFastLastDataQueryForOnePrefixPath(self, req):
        """
        Parameters:
         - req
...
class Client(Iface):
    ...
    def executeFastLastDataQueryForOnePrefixPath(self, req):
        ...
        """
        self.send_executeFastLastDataQueryForOnePrefixPath(req)
        return self.recv_executeFastLastDataQueryForOnePrefixPath()

    def send_executeFastLastDataQueryForOnePrefixPath(self, req):
        self._oprot.writeMessageBegin('executeFastLastDataQueryForOnePrefixPath', TMessageType.CALL, self._seqid)
        args = executeFastLastDataQueryForOnePrefixPath_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_executeFastLastDataQueryForOnePrefixPath(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = executeFastLastDataQueryForOnePrefixPath_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "executeFastLastDataQueryForOnePrefixPath failed: unknown result")
...
class Processor(Iface, TProcessor):
    ...
    def process_executeFastLastDataQueryForOnePrefixPath(self, seqid, iprot, oprot):
        args = executeFastLastDataQueryForOnePrefixPath_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = executeFastLastDataQueryForOnePrefixPath_result()
        try:
            result.success = self._handler.executeFastLastDataQueryForOnePrefixPath(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("executeFastLastDataQueryForOnePrefixPath", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class executeFastLastDataQueryForOnePrefixPath_args(object):
    """
    Attributes:
     - req
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.req = TSFastLastDataQueryForOnePrefixPathReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('executeFastLastDataQueryForOnePrefixPath_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(executeFastLastDataQueryForOnePrefixPath_args)
executeFastLastDataQueryForOnePrefixPath_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TSFastLastDataQueryForOnePrefixPathReq, None], None, ),  # 1
)


class executeFastLastDataQueryForOnePrefixPath_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('executeFastLastDataQueryForOnePrefixPath_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(executeFastLastDataQueryForOnePrefixPath_result)
executeFastLastDataQueryForOnePrefixPath_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TSExecuteStatementResp, None], None, ),  # 0
)
...
class deleteStorageGroups_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i677 in range(_size673):
                        _elem678 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.storageGroup.append(_elem678)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.storageGroup is not None:
            ...
            for iter679 in self.storageGroup:
                oprot.writeString(iter679.encode('utf-8') if sys.version_info[0] == 2 else iter679)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
