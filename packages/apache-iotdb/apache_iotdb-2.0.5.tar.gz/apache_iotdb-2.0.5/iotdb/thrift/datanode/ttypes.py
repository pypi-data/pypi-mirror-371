...
class TRegionRouteReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i232 in range(_size228):
                        _key233 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _key233.read(iprot)
                        _val234 = iotdb.thrift.common.ttypes.TRegionReplicaSet()
                        _val234.read(iprot)
                        self.regionRouteMap[_key233] = _val234
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.regionRouteMap is not None:
            ...
            for kiter235, viter236 in self.regionRouteMap.items():
                kiter235.write(oprot)
...
class TUpdateTableReq(object):
    ...
    def __init__(self, type=None, tableInfo=None, oldName=None,):
        self.type = type
    ...
    def write(self, oprot):
        ...
        if self.oldName is not None:
            oprot.writeFieldBegin('oldName', TType.STRING, 3)
...
class TDeleteColumnDataReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i241 in range(_size237):
                        _elem242 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem242.read(iprot)
                        self.regionIdList.append(_elem242)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.regionIdList is not None:
            ...
            for iter243 in self.regionIdList:
                iter243.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.tableName is not None:
...
class TDeleteDataOrDevicesForDropTableReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i248 in range(_size244):
                        _elem249 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem249.read(iprot)
                        self.regionIdList.append(_elem249)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.regionIdList is not None:
            oprot.writeFieldBegin('regionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.regionIdList))
            for iter250 in self.regionIdList:
                iter250.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.tableName is not None:
...
class TTableDeviceDeletionWithPatternAndFilterReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i255 in range(_size251):
                        ...
                        _elem256.read(iprot)
                        self.schemaRegionIdList.append(_elem256)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            ...
            for iter257 in self.schemaRegionIdList:
                iter257.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.tableName is not None:
...
class TLoadCommandReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i269 in range(_size265):
                        _key270 = iotdb.thrift.common.ttypes.TTimePartitionSlot()
                        _key270.read(iprot)
                        _val271 = iprot.readBinary()
                        self.timePartition2ProgressIndex[_key270] = _val271
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.timePartition2ProgressIndex is not None:
            ...
            for kiter272, viter273 in self.timePartition2ProgressIndex.items():
                kiter272.write(oprot)
                oprot.writeBinary(viter273)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TAttributeUpdateReq(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i278 in range(_size274):
                        ...
                        _val280 = TSchemaRegionAttributeInfo()
                        _val280.read(iprot)
                        self.attributeUpdateMap[_key279] = _val280
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributeUpdateMap is not None:
            ...
            for kiter281, viter282 in self.attributeUpdateMap.items():
                oprot.writeI32(kiter281)
                viter282.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TDeviceViewReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i287 in range(_size283):
                        _elem288 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem288.read(iprot)
                        self.regionIds.append(_elem288)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i293 in range(_size289):
                        ...
                        self.prefixPattern.append(_elem294)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.SET:
                    ...
                    (_etype298, _size295) = iprot.readSetBegin()
                    for _i299 in range(_size295):
                        ...
                        self.requiredMeasurements.add(_elem300)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.prefixPattern is not None:
            ...
            for iter302 in self.prefixPattern:
        ...
        if self.requiredMeasurements is not None:
            ...
            for iter303 in self.requiredMeasurements:
...
class TDeviceViewResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i308 in range(_size304):
                        _key309 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val310 = iprot.readByte()
                        self.deviewViewFieldTypeMap[_key309] = _val310
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.deviewViewFieldTypeMap is not None:
            ...
            for kiter311, viter312 in self.deviewViewFieldTypeMap.items():
                oprot.writeString(kiter311.encode('utf-8') if sys.version_info[0] == 2 else kiter311)
                oprot.writeByte(viter312)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TConstructSchemaBlackListReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i317 in range(_size313):
                        _elem318 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem318.read(iprot)
                        self.schemaRegionIdList.append(_elem318)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter319 in self.schemaRegionIdList:
                iter319.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TRollbackSchemaBlackListReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i324 in range(_size320):
                        _elem325 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem325.read(iprot)
                        self.schemaRegionIdList.append(_elem325)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter326 in self.schemaRegionIdList:
                iter326.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TFetchSchemaBlackListReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i331 in range(_size327):
                        _elem332 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem332.read(iprot)
                        self.schemaRegionIdList.append(_elem332)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter333 in self.schemaRegionIdList:
                iter333.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TDeleteDataForDeleteSchemaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i338 in range(_size334):
                        _elem339 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem339.read(iprot)
                        self.dataRegionIdList.append(_elem339)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.dataRegionIdList is not None:
            ...
            for iter340 in self.dataRegionIdList:
                iter340.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TConstructSchemaBlackListWithTemplateReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i358 in range(_size354):
                        ...
                        iprot.readListEnd()
                        self.templateSetInfo[_key359] = _val360
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter367 in self.schemaRegionIdList:
                iter367.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.templateSetInfo is not None:
            ...
            for kiter368, viter369 in self.templateSetInfo.items():
                oprot.writeString(kiter368.encode('utf-8') if sys.version_info[0] == 2 else kiter368)
                oprot.writeListBegin(TType.I32, len(viter369))
...
class TRollbackSchemaBlackListWithTemplateReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i375 in range(_size371):
                        _elem376 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem376.read(iprot)
                        self.schemaRegionIdList.append(_elem376)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i381 in range(_size377):
                        ...
                        iprot.readListEnd()
                        self.templateSetInfo[_key382] = _val383
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter390 in self.schemaRegionIdList:
                iter390.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.templateSetInfo is not None:
            oprot.writeFieldBegin('templateSetInfo', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.templateSetInfo))
            for kiter391, viter392 in self.templateSetInfo.items():
                oprot.writeString(kiter391.encode('utf-8') if sys.version_info[0] == 2 else kiter391)
                oprot.writeListBegin(TType.I32, len(viter392))
...
class TDeactivateTemplateReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i398 in range(_size394):
                        _elem399 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem399.read(iprot)
                        self.schemaRegionIdList.append(_elem399)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i404 in range(_size400):
                        _key405 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val406 = []
                        ...
                        iprot.readListEnd()
                        self.templateSetInfo[_key405] = _val406
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter413 in self.schemaRegionIdList:
                iter413.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.templateSetInfo is not None:
            oprot.writeFieldBegin('templateSetInfo', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.templateSetInfo))
            for kiter414, viter415 in self.templateSetInfo.items():
                oprot.writeString(kiter414.encode('utf-8') if sys.version_info[0] == 2 else kiter414)
                oprot.writeListBegin(TType.I32, len(viter415))
                for iter416 in viter415:
...
class TCountPathsUsingTemplateReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i421 in range(_size417):
                        _elem422 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem422.read(iprot)
                        self.schemaRegionIdList.append(_elem422)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter423 in self.schemaRegionIdList:
                iter423.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TCheckSchemaRegionUsingTemplateReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i428 in range(_size424):
                        _elem429 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem429.read(iprot)
                        self.schemaRegionIdList.append(_elem429)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter430 in self.schemaRegionIdList:
                iter430.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TCheckTimeSeriesExistenceReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i435 in range(_size431):
                        _elem436 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem436.read(iprot)
                        self.schemaRegionIdList.append(_elem436)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter437 in self.schemaRegionIdList:
                iter437.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i442 in range(_size438):
                        ...
                        self.pipeMetas.append(_elem443)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TPushPipeMetaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i449 in range(_size445):
                        _elem450 = TPushPipeMetaRespExceptionMessage()
                        _elem450.read(iprot)
                        self.exceptionMessages.append(_elem450)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.exceptionMessages is not None:
            ...
            for iter451 in self.exceptionMessages:
                iter451.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TPushMultiPipeMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i456 in range(_size452):
                        ...
                        self.pipeMetas.append(_elem457)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i462 in range(_size458):
                        _elem463 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.pipeNamesToDrop.append(_elem463)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.pipeNamesToDrop is not None:
            ...
            for iter465 in self.pipeNamesToDrop:
...
class TPushTopicMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i470 in range(_size466):
                        ...
                        self.topicMetas.append(_elem471)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.topicMetas is not None:
            ...
            for iter472 in self.topicMetas:
...
class TPushMultiTopicMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i477 in range(_size473):
                        ...
                        self.topicMetas.append(_elem478)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i483 in range(_size479):
                        _elem484 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.topicNamesToDrop.append(_elem484)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.topicMetas is not None:
            oprot.writeFieldBegin('topicMetas', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.topicMetas))
            for iter485 in self.topicMetas:
                oprot.writeBinary(iter485)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.topicNamesToDrop is not None:
            ...
            for iter486 in self.topicNamesToDrop:
...
class TPushTopicMetaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i491 in range(_size487):
                        _elem492 = TPushTopicMetaRespExceptionMessage()
                        _elem492.read(iprot)
                        self.exceptionMessages.append(_elem492)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.exceptionMessages is not None:
            oprot.writeFieldBegin('exceptionMessages', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.exceptionMessages))
            for iter493 in self.exceptionMessages:
                iter493.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TPushConsumerGroupMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i498 in range(_size494):
                        ...
                        self.consumerGroupMetas.append(_elem499)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.consumerGroupMetas is not None:
            ...
            for iter500 in self.consumerGroupMetas:
...
class TPushConsumerGroupMetaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i505 in range(_size501):
                        _elem506 = TPushConsumerGroupMetaRespExceptionMessage()
                        _elem506.read(iprot)
                        self.exceptionMessages.append(_elem506)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.exceptionMessages is not None:
            oprot.writeFieldBegin('exceptionMessages', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.exceptionMessages))
            for iter507 in self.exceptionMessages:
                iter507.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TConstructViewSchemaBlackListReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i512 in range(_size508):
                        _elem513 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem513.read(iprot)
                        self.schemaRegionIdList.append(_elem513)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter514 in self.schemaRegionIdList:
                iter514.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TRollbackViewSchemaBlackListReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i519 in range(_size515):
                        _elem520 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem520.read(iprot)
                        self.schemaRegionIdList.append(_elem520)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter521 in self.schemaRegionIdList:
                iter521.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TDeleteViewSchemaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i526 in range(_size522):
                        _elem527 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem527.read(iprot)
                        self.schemaRegionIdList.append(_elem527)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter528 in self.schemaRegionIdList:
                iter528.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TAlterViewReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i533 in range(_size529):
                        _elem534 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem534.read(iprot)
                        self.schemaRegionIdList.append(_elem534)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i539 in range(_size535):
                        _elem540 = iprot.readBinary()
                        self.viewBinaryList.append(_elem540)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter541 in self.schemaRegionIdList:
                iter541.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.viewBinaryList is not None:
            ...
            for iter542 in self.viewBinaryList:
                oprot.writeBinary(iter542)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.isGeneratedByPipe is not None:
            oprot.writeFieldBegin('isGeneratedByPipe', TType.BOOL, 3)
...
class TFetchMoreDataResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i547 in range(_size543):
                        ...
                        self.tsDataset.append(_elem548)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.tsDataset is not None:
            ...
            for iter549 in self.tsDataset:
                oprot.writeBinary(iter549)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TFetchTimeseriesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i554 in range(_size550):
                        ...
                        self.columnNameList.append(_elem555)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i560 in range(_size556):
                        _elem561 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.columnTypeList.append(_elem561)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.MAP:
                    ...
                    for _i566 in range(_size562):
                        _key567 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val568 = iprot.readI32()
                        self.columnNameIndexMap[_key567] = _val568
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i573 in range(_size569):
                        ...
                        self.tsDataset.append(_elem574)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.columnNameList is not None:
            ...
            for iter575 in self.columnNameList:
                oprot.writeString(iter575.encode('utf-8') if sys.version_info[0] == 2 else iter575)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.columnTypeList is not None:
            ...
            for iter576 in self.columnTypeList:
        ...
        if self.columnNameIndexMap is not None:
            ...
            for kiter577, viter578 in self.columnNameIndexMap.items():
        ...
        if self.tsDataset is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.tsDataset))
            for iter579 in self.tsDataset:
                oprot.writeBinary(iter579)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.hasMoreData is not None:
...
class TOperatorStatistics(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i584 in range(_size580):
                        ...
                        self.specifiedInfo[_key585] = _val586
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.specifiedInfo is not None:
            ...
            for kiter587, viter588 in self.specifiedInfo.items():
...
class TFetchFragmentInstanceStatisticsResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i593 in range(_size589):
                        _key594 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val595 = TOperatorStatistics()
                        _val595.read(iprot)
                        self.operatorStatisticsMap[_key594] = _val595
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.operatorStatisticsMap is not None:
            ...
            for kiter596, viter597 in self.operatorStatisticsMap.items():
                oprot.writeString(kiter596.encode('utf-8') if sys.version_info[0] == 2 else kiter596)
                viter597.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
TUpdateTableReq.thrift_spec = (
    ...
    (3, TType.STRING, 'oldName', 'UTF8', None, ),  # 3
)
