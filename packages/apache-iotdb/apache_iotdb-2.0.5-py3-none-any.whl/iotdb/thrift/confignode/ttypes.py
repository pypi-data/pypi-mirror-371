...
class TDataNodeInfo4InformationSchema(object):
    """
    Attributes:
     - dataNodeId
     - dataRegionNum
    ...
    def __init__(self, dataNodeId=None, dataRegionNum=None, schemaRegionNum=None, rpcAddress=None, rpcPort=None, mppPort=None, dataConsensusPort=None, schemaConsensusPort=None,):
        self.dataNodeId = dataNodeId
        self.dataRegionNum = dataRegionNum
        self.schemaRegionNum = schemaRegionNum
        self.rpcAddress = rpcAddress
        self.rpcPort = rpcPort
        self.mppPort = mppPort
        self.dataConsensusPort = dataConsensusPort
        self.schemaConsensusPort = schemaConsensusPort
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.rpcAddress = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.I32:
                ...
                if ftype == TType.I32:
                    self.mppPort = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.I32:
                    self.dataConsensusPort = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.I32:
                    self.schemaConsensusPort = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TDataNodeInfo4InformationSchema')
        if self.dataNodeId is not None:
            oprot.writeFieldBegin('dataNodeId', TType.I32, 1)
            oprot.writeI32(self.dataNodeId)
            oprot.writeFieldEnd()
        if self.dataRegionNum is not None:
            oprot.writeFieldBegin('dataRegionNum', TType.I32, 2)
            oprot.writeI32(self.dataRegionNum)
            oprot.writeFieldEnd()
        if self.schemaRegionNum is not None:
            oprot.writeFieldBegin('schemaRegionNum', TType.I32, 3)
            oprot.writeI32(self.schemaRegionNum)
            oprot.writeFieldEnd()
        if self.rpcAddress is not None:
            oprot.writeFieldBegin('rpcAddress', TType.STRING, 4)
            oprot.writeString(self.rpcAddress.encode('utf-8') if sys.version_info[0] == 2 else self.rpcAddress)
            oprot.writeFieldEnd()
        if self.rpcPort is not None:
            oprot.writeFieldBegin('rpcPort', TType.I32, 5)
            oprot.writeI32(self.rpcPort)
            oprot.writeFieldEnd()
        if self.mppPort is not None:
            oprot.writeFieldBegin('mppPort', TType.I32, 6)
            oprot.writeI32(self.mppPort)
            oprot.writeFieldEnd()
        if self.dataConsensusPort is not None:
            oprot.writeFieldBegin('dataConsensusPort', TType.I32, 7)
            oprot.writeI32(self.dataConsensusPort)
            oprot.writeFieldEnd()
        if self.schemaConsensusPort is not None:
            oprot.writeFieldBegin('schemaConsensusPort', TType.I32, 8)
            oprot.writeI32(self.schemaConsensusPort)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.rpcAddress is None:
            raise TProtocolException(message='Required field rpcAddress is unset!')
        if self.rpcPort is None:
            raise TProtocolException(message='Required field rpcPort is unset!')
        if self.mppPort is None:
            raise TProtocolException(message='Required field mppPort is unset!')
        if self.dataConsensusPort is None:
            raise TProtocolException(message='Required field dataConsensusPort is unset!')
        if self.schemaConsensusPort is None:
            raise TProtocolException(message='Required field schemaConsensusPort is unset!')
        return
...
class TShowDataNodes4InformationSchemaResp(object):
    """
    Attributes:
     - status
     - dataNodesInfoList
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i455 in range(_size451):
                        _elem456 = TDataNodeInfo4InformationSchema()
                        _elem456.read(iprot)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TShowDataNodes4InformationSchemaResp')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRUCT, 1)
            self.status.write(oprot)
            oprot.writeFieldEnd()
...
class TShowDataNodesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i462 in range(_size458):
                        _elem463 = TDataNodeInfo()
                        _elem463.read(iprot)
                        self.dataNodesInfoList.append(_elem463)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataNodesInfoList is not None:
            oprot.writeFieldBegin('dataNodesInfoList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.dataNodesInfoList))
            for iter464 in self.dataNodesInfoList:
                iter464.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowAINodesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i469 in range(_size465):
                        _elem470 = TAINodeInfo()
                        _elem470.read(iprot)
                        self.aiNodesInfoList.append(_elem470)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.aiNodesInfoList is not None:
            ...
            for iter471 in self.aiNodesInfoList:
                iter471.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowConfigNodesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i476 in range(_size472):
                        _elem477 = TConfigNodeInfo()
                        _elem477.read(iprot)
                        self.configNodesInfoList.append(_elem477)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodesInfoList is not None:
            ...
            for iter478 in self.configNodesInfoList:
                iter478.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TConfigNodeInfo4InformationSchema(object):
    """
    Attributes:
     - configNodeId
     - consensusPort
    ...
    def __init__(self, configNodeId=None, consensusPort=None, roleType=None,):
        self.configNodeId = configNodeId
        self.consensusPort = consensusPort
        self.roleType = roleType
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.consensusPort = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TConfigNodeInfo4InformationSchema')
        if self.configNodeId is not None:
            oprot.writeFieldBegin('configNodeId', TType.I32, 1)
            oprot.writeI32(self.configNodeId)
            oprot.writeFieldEnd()
        if self.consensusPort is not None:
            oprot.writeFieldBegin('consensusPort', TType.I32, 2)
            oprot.writeI32(self.consensusPort)
            oprot.writeFieldEnd()
        if self.roleType is not None:
            oprot.writeFieldBegin('roleType', TType.STRING, 5)
            oprot.writeString(self.roleType.encode('utf-8') if sys.version_info[0] == 2 else self.roleType)
    ...
    def validate(self):
        if self.configNodeId is None:
            raise TProtocolException(message='Required field configNodeId is unset!')
        if self.consensusPort is None:
            raise TProtocolException(message='Required field consensusPort is unset!')
        if self.roleType is None:
            raise TProtocolException(message='Required field roleType is unset!')
        return
...
class TShowConfigNodes4InformationSchemaResp(object):
    """
    Attributes:
     - status
     - configNodesInfoList
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i483 in range(_size479):
                        _elem484 = TConfigNodeInfo4InformationSchema()
                        _elem484.read(iprot)
                        self.configNodesInfoList.append(_elem484)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TShowConfigNodes4InformationSchemaResp')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRUCT, 1)
            self.status.write(oprot)
            oprot.writeFieldEnd()
        if self.configNodesInfoList is not None:
            oprot.writeFieldBegin('configNodesInfoList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodesInfoList))
            for iter485 in self.configNodesInfoList:
                iter485.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetDatabaseReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i490 in range(_size486):
                        ...
                        self.databasePathPattern.append(_elem491)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.databasePathPattern is not None:
            ...
            for iter492 in self.databasePathPattern:
                oprot.writeString(iter492.encode('utf-8') if sys.version_info[0] == 2 else iter492)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.scopePatternTree is not None:
...
class TShowDatabaseResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i497 in range(_size493):
                        ...
                        _val499 = TDatabaseInfo()
                        _val499.read(iprot)
                        self.databaseInfoMap[_key498] = _val499
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databaseInfoMap is not None:
            ...
            for kiter500, viter501 in self.databaseInfoMap.items():
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i506 in range(_size502):
                        ...
                        self.databases.append(_elem507)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
...
class TShowRegionResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i513 in range(_size509):
                        _elem514 = TRegionInfo()
                        _elem514.read(iprot)
                        self.regionInfoList.append(_elem514)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.regionInfoList is not None:
            ...
            for iter515 in self.regionInfoList:
                iter515.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TRegionRouteMapResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i520 in range(_size516):
                        _key521 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _key521.read(iprot)
                        _val522 = iotdb.thrift.common.ttypes.TRegionReplicaSet()
                        _val522.read(iprot)
                        self.regionRouteMap[_key521] = _val522
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.regionRouteMap is not None:
            ...
            for kiter523, viter524 in self.regionRouteMap.items():
                kiter523.write(oprot)
...
class TGetAllTemplatesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i529 in range(_size525):
                        ...
                        self.templateList.append(_elem530)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.templateList is not None:
            ...
            for iter531 in self.templateList:
...
class TGetPipePluginTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i543 in range(_size539):
                        _elem544 = iprot.readBinary()
                        self.allPipePluginMeta.append(_elem544)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allPipePluginMeta is not None:
            ...
            for iter545 in self.allPipePluginMeta:
...
class TGetAllPipeInfoResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i550 in range(_size546):
                        ...
                        self.allPipeInfo.append(_elem551)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allPipeInfo is not None:
            ...
            for iter552 in self.allPipeInfo:
                oprot.writeBinary(iter552)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TCreatePipeReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i557 in range(_size553):
                        ...
                        self.extractorAttributes[_key558] = _val559
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i564 in range(_size560):
                        _key565 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val566 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.processorAttributes[_key565] = _val566
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.MAP:
                    ...
                    for _i571 in range(_size567):
                        ...
                        self.connectorAttributes[_key572] = _val573
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.extractorAttributes is not None:
            ...
            for kiter574, viter575 in self.extractorAttributes.items():
        ...
        if self.processorAttributes is not None:
            ...
            for kiter576, viter577 in self.processorAttributes.items():
                oprot.writeString(kiter576.encode('utf-8') if sys.version_info[0] == 2 else kiter576)
                oprot.writeString(viter577.encode('utf-8') if sys.version_info[0] == 2 else viter577)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.connectorAttributes is not None:
            ...
            for kiter578, viter579 in self.connectorAttributes.items():
                oprot.writeString(kiter578.encode('utf-8') if sys.version_info[0] == 2 else kiter578)
                oprot.writeString(viter579.encode('utf-8') if sys.version_info[0] == 2 else viter579)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.ifNotExistsCondition is not None:
...
class TAlterPipeReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i584 in range(_size580):
                        ...
                        self.processorAttributes[_key585] = _val586
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i591 in range(_size587):
                        _key592 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val593 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.connectorAttributes[_key592] = _val593
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i598 in range(_size594):
                        _key599 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val600 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.extractorAttributes[_key599] = _val600
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.processorAttributes is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.processorAttributes))
            for kiter601, viter602 in self.processorAttributes.items():
        ...
        if self.connectorAttributes is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.connectorAttributes))
            for kiter603, viter604 in self.connectorAttributes.items():
                oprot.writeString(kiter603.encode('utf-8') if sys.version_info[0] == 2 else kiter603)
                oprot.writeString(viter604.encode('utf-8') if sys.version_info[0] == 2 else viter604)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        ...
        if self.extractorAttributes is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.extractorAttributes))
            for kiter605, viter606 in self.extractorAttributes.items():
...
class TPipeSinkInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i611 in range(_size607):
                        ...
                        self.attributes[_key612] = _val613
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.attributes))
            for kiter614, viter615 in self.attributes.items():
...
class TShowPipeResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i620 in range(_size616):
                        _elem621 = TShowPipeInfo()
                        _elem621.read(iprot)
                        self.pipeInfoList.append(_elem621)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.pipeInfoList is not None:
            ...
            for iter622 in self.pipeInfoList:
                iter622.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TCreateTopicReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i627 in range(_size623):
                        ...
                        self.topicAttributes[_key628] = _val629
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.topicAttributes is not None:
            ...
            for kiter630, viter631 in self.topicAttributes.items():
                oprot.writeString(kiter630.encode('utf-8') if sys.version_info[0] == 2 else kiter630)
                oprot.writeString(viter631.encode('utf-8') if sys.version_info[0] == 2 else viter631)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.ifNotExistsCondition is not None:
...
class TDropTopicReq(object):
    ...
    def __init__(self, topicName=None, ifExistsCondition=None, isTableModel=None,):
        self.topicName = topicName
        self.ifExistsCondition = ifExistsCondition
        self.isTableModel = isTableModel
...
class TShowTopicReq(object):
    ...
    def __init__(self, topicName=None, isTableModel=None,):
        self.topicName = topicName
        self.isTableModel = isTableModel
...
class TShowTopicResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i636 in range(_size632):
                        _elem637 = TShowTopicInfo()
                        _elem637.read(iprot)
                        self.topicInfoList.append(_elem637)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.topicInfoList is not None:
            ...
            for iter638 in self.topicInfoList:
                iter638.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TAlterTopicReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i643 in range(_size639):
                        _key644 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val645 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.topicAttributes[_key644] = _val645
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.SET:
                    ...
                    (_etype649, _size646) = iprot.readSetBegin()
                    for _i650 in range(_size646):
                        ...
                        self.subscribedConsumerGroupIds.add(_elem651)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.topicAttributes is not None:
            oprot.writeFieldBegin('topicAttributes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.topicAttributes))
            for kiter652, viter653 in self.topicAttributes.items():
                oprot.writeString(kiter652.encode('utf-8') if sys.version_info[0] == 2 else kiter652)
                oprot.writeString(viter653.encode('utf-8') if sys.version_info[0] == 2 else viter653)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.subscribedConsumerGroupIds is not None:
            ...
            for iter654 in self.subscribedConsumerGroupIds:
...
class TGetAllTopicInfoResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i659 in range(_size655):
                        _elem660 = iprot.readBinary()
                        self.allTopicInfo.append(_elem660)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allTopicInfo is not None:
            ...
            for iter661 in self.allTopicInfo:
                oprot.writeBinary(iter661)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TCreateConsumerReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i666 in range(_size662):
                        _key667 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val668 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.consumerAttributes[_key667] = _val668
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.consumerAttributes is not None:
            ...
            for kiter669, viter670 in self.consumerAttributes.items():
                oprot.writeString(kiter669.encode('utf-8') if sys.version_info[0] == 2 else kiter669)
                oprot.writeString(viter670.encode('utf-8') if sys.version_info[0] == 2 else viter670)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TSubscribeReq(object):
    ...
    def __init__(self, consumerId=None, consumerGroupId=None, topicNames=None, isTableModel=None,):
        self.consumerId = consumerId
        self.consumerGroupId = consumerGroupId
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i675 in range(_size671):
                        _elem676 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.topicNames.add(_elem676)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.topicNames is not None:
            ...
            for iter677 in self.topicNames:
                oprot.writeString(iter677.encode('utf-8') if sys.version_info[0] == 2 else iter677)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        if self.isTableModel is not None:
            oprot.writeFieldBegin('isTableModel', TType.BOOL, 4)
            oprot.writeBool(self.isTableModel)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TUnsubscribeReq(object):
    ...
    def write(self, oprot):
        ...
        if self.topicNames is not None:
            oprot.writeFieldBegin('topicNames', TType.SET, 3)
            oprot.writeSetBegin(TType.STRING, len(self.topicNames))
            for iter684 in self.topicNames:
...
class TShowSubscriptionResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i689 in range(_size685):
                        _elem690 = TShowSubscriptionInfo()
                        _elem690.read(iprot)
                        self.subscriptionInfoList.append(_elem690)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.subscriptionInfoList is not None:
            ...
            for iter691 in self.subscriptionInfoList:
                iter691.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowSubscriptionInfo(object):
    ...
    def __init__(self, topicName=None, consumerGroupId=None, consumerIds=None, creationTime=None,):
        self.topicName = topicName
        self.consumerGroupId = consumerGroupId
    ...
    def write(self, oprot):
        ...
        if self.consumerIds is not None:
            ...
            for iter698 in self.consumerIds:
...
class TDropSubscriptionReq(object):
    """
    Attributes:
     - subsciptionId
     - ifExistsCondition
    ...
    def __init__(self, subsciptionId=None, ifExistsCondition=None, isTableModel=None,):
        self.subsciptionId = subsciptionId
        self.ifExistsCondition = ifExistsCondition
        self.isTableModel = isTableModel
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.subsciptionId = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.BOOL:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TDropSubscriptionReq')
        if self.subsciptionId is not None:
            oprot.writeFieldBegin('subsciptionId', TType.STRING, 1)
            oprot.writeString(self.subsciptionId.encode('utf-8') if sys.version_info[0] == 2 else self.subsciptionId)
            oprot.writeFieldEnd()
        if self.ifExistsCondition is not None:
            oprot.writeFieldBegin('ifExistsCondition', TType.BOOL, 2)
            oprot.writeBool(self.ifExistsCondition)
    ...
    def validate(self):
        if self.subsciptionId is None:
            raise TProtocolException(message='Required field subsciptionId is unset!')
        return
...
class TGetAllSubscriptionInfoResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i703 in range(_size699):
                        ...
                        self.allSubscriptionInfo.append(_elem704)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allSubscriptionInfo is not None:
            ...
            for iter705 in self.allSubscriptionInfo:
...
class TShowModelResp(object):
    ...
    def __init__(self, status=None, modelIdList=None, modelTypeMap=None, categoryMap=None, stateMap=None,):
        self.status = status
        self.modelIdList = modelIdList
        self.modelTypeMap = modelTypeMap
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i717 in range(_size713):
                        ...
                        self.modelIdList.append(_elem718)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i723 in range(_size719):
                        _key724 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val725 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.modelTypeMap[_key724] = _val725
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.MAP:
                    self.categoryMap = {}
                    (_ktype727, _vtype728, _size726) = iprot.readMapBegin()
                    for _i730 in range(_size726):
                        _key731 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val732 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.categoryMap[_key731] = _val732
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.MAP:
                    ...
                    for _i737 in range(_size733):
                        _key738 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val739 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.stateMap[_key738] = _val739
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.status is not None:
            ...
            self.status.write(oprot)
            oprot.writeFieldEnd()
        if self.modelIdList is not None:
            oprot.writeFieldBegin('modelIdList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.modelIdList))
            for iter740 in self.modelIdList:
                oprot.writeString(iter740.encode('utf-8') if sys.version_info[0] == 2 else iter740)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.modelTypeMap is not None:
            oprot.writeFieldBegin('modelTypeMap', TType.MAP, 3)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.modelTypeMap))
            for kiter741, viter742 in self.modelTypeMap.items():
                oprot.writeString(kiter741.encode('utf-8') if sys.version_info[0] == 2 else kiter741)
                oprot.writeString(viter742.encode('utf-8') if sys.version_info[0] == 2 else viter742)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.categoryMap is not None:
            oprot.writeFieldBegin('categoryMap', TType.MAP, 4)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.categoryMap))
            for kiter743, viter744 in self.categoryMap.items():
                oprot.writeString(kiter743.encode('utf-8') if sys.version_info[0] == 2 else kiter743)
                oprot.writeString(viter744.encode('utf-8') if sys.version_info[0] == 2 else viter744)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.stateMap is not None:
            oprot.writeFieldBegin('stateMap', TType.MAP, 5)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.stateMap))
            for kiter745, viter746 in self.stateMap.items():
                oprot.writeString(kiter745.encode('utf-8') if sys.version_info[0] == 2 else kiter745)
                oprot.writeString(viter746.encode('utf-8') if sys.version_info[0] == 2 else viter746)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i751 in range(_size747):
                        ...
                        self.aiNodeIds.append(_elem752)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
...
class TDataSchemaForTable(object):
    ...
    def __init__(self, targetSql=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.targetSql = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.targetSql is not None:
            oprot.writeFieldBegin('targetSql', TType.STRING, 1)
            oprot.writeString(self.targetSql.encode('utf-8') if sys.version_info[0] == 2 else self.targetSql)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()

    def validate(self):
        if self.targetSql is None:
            raise TProtocolException(message='Required field targetSql is unset!')
        return
...
class TCreateTrainingReq(object):
    ...
    def __init__(self, modelId=None, isTableModel=None, existingModelId=None, dataSchemaForTable=None, dataSchemaForTree=None, parameters=None, timeRanges=None,):
        self.modelId = modelId
        self.isTableModel = isTableModel
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i765 in range(_size761):
                        ...
                        self.parameters[_key766] = _val767
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i772 in range(_size768):
                        ...
                        for _i778 in range(_size774):
                            ...
                            _elem773.append(_elem779)
                        iprot.readListEnd()
                        self.timeRanges.append(_elem773)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.existingModelId is not None:
            oprot.writeFieldBegin('existingModelId', TType.STRING, 3)
        ...
        if self.parameters is not None:
            ...
            for kiter780, viter781 in self.parameters.items():
                oprot.writeString(kiter780.encode('utf-8') if sys.version_info[0] == 2 else kiter780)
                oprot.writeString(viter781.encode('utf-8') if sys.version_info[0] == 2 else viter781)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.timeRanges is not None:
            oprot.writeFieldBegin('timeRanges', TType.LIST, 7)
            oprot.writeListBegin(TType.LIST, len(self.timeRanges))
            for iter782 in self.timeRanges:
                oprot.writeListBegin(TType.I64, len(iter782))
                for iter783 in iter782:
    ...
    def validate(self):
        ...
        if self.existingModelId is None:
            raise TProtocolException(message='Required field existingModelId is unset!')
        return
...
class TSpaceQuotaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i788 in range(_size784):
                        _key789 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val790 = iotdb.thrift.common.ttypes.TSpaceQuota()
                        _val790.read(iprot)
                        self.spaceQuota[_key789] = _val790
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i795 in range(_size791):
                        ...
                        _val797 = iotdb.thrift.common.ttypes.TSpaceQuota()
                        _val797.read(iprot)
                        self.spaceQuotaUsage[_key796] = _val797
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.spaceQuota is not None:
            ...
            for kiter798, viter799 in self.spaceQuota.items():
...
class TThrottleQuotaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i806 in range(_size802):
                        _key807 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val808 = iotdb.thrift.common.ttypes.TThrottleQuota()
                        _val808.read(iprot)
                        self.throttleQuota[_key807] = _val808
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.throttleQuota is not None:
            ...
            for kiter809, viter810 in self.throttleQuota.items():
                oprot.writeString(kiter809.encode('utf-8') if sys.version_info[0] == 2 else kiter809)
...
class TAINodeConfigurationResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i815 in range(_size811):
                        _key816 = iprot.readI32()
                        _val817 = iotdb.thrift.common.ttypes.TAINodeConfiguration()
                        _val817.read(iprot)
                        self.aiNodeConfigurationMap[_key816] = _val817
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.aiNodeConfigurationMap is not None:
            ...
            for kiter818, viter819 in self.aiNodeConfigurationMap.items():
                oprot.writeI32(kiter818)
                viter819.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TAINodeRegisterResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i824 in range(_size820):
                        _elem825 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem825.read(iprot)
                        self.configNodeList.append(_elem825)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter826 in self.configNodeList:
                iter826.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.aiNodeId is not None:
...
class TAINodeRestartResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i831 in range(_size827):
                        _elem832 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem832.read(iprot)
                        self.configNodeList.append(_elem832)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter833 in self.configNodeList:
                iter833.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TAlterOrDropTableReq(object):
    ...
    def __init__(self, database=None, tableName=None, queryId=None, operationType=None, updateInfo=None, isView=None,):
        self.database = database
        self.tableName = tableName
        self.queryId = queryId
    ...
    def write(self, oprot):
        ...
        if self.updateInfo is not None:
            ...
            oprot.writeFieldEnd()
        if self.isView is not None:
            oprot.writeFieldBegin('isView', TType.BOOL, 6)
            oprot.writeBool(self.isView)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TShowTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i838 in range(_size834):
                        _elem839 = TTableInfo()
                        _elem839.read(iprot)
                        self.tableInfoList.append(_elem839)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.tableInfoList is not None:
            ...
            for iter840 in self.tableInfoList:
                iter840.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowTable4InformationSchemaResp(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    (_ktype842, _vtype843, _size841) = iprot.readMapBegin()
                    for _i845 in range(_size841):
                        _key846 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val847 = []
                        (_etype851, _size848) = iprot.readListBegin()
                        for _i852 in range(_size848):
                            _elem853 = TTableInfo()
                            _elem853.read(iprot)
                            _val847.append(_elem853)
                        iprot.readListEnd()
                        self.databaseTableInfoMap[_key846] = _val847
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databaseTableInfoMap is not None:
            ...
            for kiter854, viter855 in self.databaseTableInfoMap.items():
                oprot.writeString(kiter854.encode('utf-8') if sys.version_info[0] == 2 else kiter854)
                oprot.writeListBegin(TType.STRUCT, len(viter855))
                for iter856 in viter855:
                    iter856.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class TDescTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i861 in range(_size857):
                        _elem862 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.preDeletedColumns.add(_elem862)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.preDeletedColumns is not None:
            ...
            for iter863 in self.preDeletedColumns:
...
class TDescTable4InformationSchemaResp(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    (_ktype865, _vtype866, _size864) = iprot.readMapBegin()
                    for _i868 in range(_size864):
                        _key869 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val870 = {}
                        ...
                        for _i875 in range(_size871):
                            ...
                            _val877 = TTableColumnInfo()
                            _val877.read(iprot)
                            _val870[_key876] = _val877
                        iprot.readMapEnd()
                        self.tableColumnInfoMap[_key869] = _val870
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.tableColumnInfoMap is not None:
            ...
            for kiter878, viter879 in self.tableColumnInfoMap.items():
                oprot.writeString(kiter878.encode('utf-8') if sys.version_info[0] == 2 else kiter878)
                oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(viter879))
                for kiter880, viter881 in viter879.items():
                    oprot.writeString(kiter880.encode('utf-8') if sys.version_info[0] == 2 else kiter880)
                    viter881.write(oprot)
                oprot.writeMapEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TTableColumnInfo(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    self.preDeletedColumns = set()
                    (_etype885, _size882) = iprot.readSetBegin()
                    for _i886 in range(_size882):
                        _elem887 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.preDeletedColumns.add(_elem887)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.preDeletedColumns is not None:
            ...
            oprot.writeSetBegin(TType.STRING, len(self.preDeletedColumns))
            for iter888 in self.preDeletedColumns:
                oprot.writeString(iter888.encode('utf-8') if sys.version_info[0] == 2 else iter888)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TTableInfo(object):
    ...
    def __init__(self, tableName=None, TTL=None, state=None, comment=None, type=None,):
        self.tableName = tableName
        self.TTL = TTL
        self.state = state
...
class TCreateTableViewReq(object):
    """
    Attributes:
     - tableInfo
     - replace
    ...
    def __init__(self, tableInfo=None, replace=None,):
        self.tableInfo = tableInfo
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TCreateTableViewReq')
        if self.tableInfo is not None:
            oprot.writeFieldBegin('tableInfo', TType.STRING, 1)
            oprot.writeBinary(self.tableInfo)
            oprot.writeFieldEnd()
    ...
    def validate(self):
        ...
        if self.replace is None:
            raise TProtocolException(message='Required field replace is unset!')
        return
...
all_structs.append(TDataNodeInfo4InformationSchema)
TDataNodeInfo4InformationSchema.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'dataNodeId', None, None, ),  # 1
    (2, TType.I32, 'dataRegionNum', None, None, ),  # 2
    (3, TType.I32, 'schemaRegionNum', None, None, ),  # 3
    (4, TType.STRING, 'rpcAddress', 'UTF8', None, ),  # 4
    (5, TType.I32, 'rpcPort', None, None, ),  # 5
    (6, TType.I32, 'mppPort', None, None, ),  # 6
    (7, TType.I32, 'dataConsensusPort', None, None, ),  # 7
    (8, TType.I32, 'schemaConsensusPort', None, None, ),  # 8
)
...
all_structs.append(TShowDataNodes4InformationSchemaResp)
TShowDataNodes4InformationSchemaResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [iotdb.thrift.common.ttypes.TSStatus, None], None, ),  # 1
    (2, TType.LIST, 'dataNodesInfoList', (TType.STRUCT, [TDataNodeInfo4InformationSchema, None], False), None, ),  # 2
)
...
all_structs.append(TConfigNodeInfo4InformationSchema)
TConfigNodeInfo4InformationSchema.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'configNodeId', None, None, ),  # 1
    (2, TType.I32, 'consensusPort', None, None, ),  # 2
    None,  # 3
    None,  # 4
    (5, TType.STRING, 'roleType', 'UTF8', None, ),  # 5
)
all_structs.append(TShowConfigNodes4InformationSchemaResp)
TShowConfigNodes4InformationSchemaResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [iotdb.thrift.common.ttypes.TSStatus, None], None, ),  # 1
    (2, TType.LIST, 'configNodesInfoList', (TType.STRUCT, [TConfigNodeInfo4InformationSchema, None], False), None, ),  # 2
)
...
TSubscribeReq.thrift_spec = (
    ...
    (4, TType.BOOL, 'isTableModel', None, None, ),  # 4
)
...
all_structs.append(TDropSubscriptionReq)
TDropSubscriptionReq.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'subsciptionId', 'UTF8', None, ),  # 1
    (2, TType.BOOL, 'ifExistsCondition', None, None, ),  # 2
    (3, TType.BOOL, 'isTableModel', None, None, ),  # 3
)
...
TShowModelResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [iotdb.thrift.common.ttypes.TSStatus, None], None, ),  # 1
    (2, TType.LIST, 'modelIdList', (TType.STRING, 'UTF8', False), None, ),  # 2
    (3, TType.MAP, 'modelTypeMap', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 3
    (4, TType.MAP, 'categoryMap', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 4
    (5, TType.MAP, 'stateMap', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 5
)
...
TDataSchemaForTable.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'targetSql', 'UTF8', None, ),  # 1
)
...
TCreateTrainingReq.thrift_spec = (
    ...
    (1, TType.STRING, 'modelId', 'UTF8', None, ),  # 1
    (2, TType.BOOL, 'isTableModel', None, None, ),  # 2
    (3, TType.STRING, 'existingModelId', 'UTF8', None, ),  # 3
    ...
    (6, TType.MAP, 'parameters', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 6
    (7, TType.LIST, 'timeRanges', (TType.LIST, (TType.I64, None, False), False), None, ),  # 7
)
...
TAlterOrDropTableReq.thrift_spec = (
    ...
    (6, TType.BOOL, 'isView', None, None, ),  # 6
)
...
all_structs.append(TCreateTableViewReq)
TCreateTableViewReq.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'tableInfo', 'BINARY', None, ),  # 1
