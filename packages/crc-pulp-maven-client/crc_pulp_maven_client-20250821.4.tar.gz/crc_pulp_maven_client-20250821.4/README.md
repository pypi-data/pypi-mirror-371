...
import crc-pulp_maven-client
from crc-pulp_maven-client.rest import ApiException
...
configuration = crc-pulp_maven-client.Configuration(
...
with crc-pulp_maven-client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = crc-pulp_maven-client.ApiMavenApi(api_client)
