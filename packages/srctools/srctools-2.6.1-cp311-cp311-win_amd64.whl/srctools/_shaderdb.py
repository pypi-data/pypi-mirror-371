...
def _shader_db(var_type: type[VarType], DB: dict[str, VarType]) -> None:
    ...
    DB['emissiontexture'] = TEXTURE
    DB['emissiontexture2'] = TEXTURE
    DB['emissiontexture3'] = TEXTURE
    DB['emissiontexture4'] = TEXTURE
    ...
    DB['mraotexture'] = TEXTURE
    DB['mraotexture2'] = TEXTURE
    DB['mraotexture3'] = TEXTURE
    DB['mraotexture4'] = TEXTURE
    DB['noise'] = TEXTURE
    DB['noisemap'] = TEXTURE
    DB['noisetexture'] = TEXTURE
    DB['normalmap'] = TEXTURE
    DB['normalmap2'] = TEXTURE
    DB['normalmap3'] = TEXTURE
    DB['normalmap4'] = TEXTURE
    DB['normaltexture'] = TEXTURE
    DB['offsetmap'] = TEXTURE
    DB['opacitytexture'] = TEXTURE
    DB['originaltexture'] = TEXTURE
    DB['overlaytexture'] = TEXTURE
    DB['paintenvmap'] = TEXTURE
    DB['paintsplatbubble'] = TEXTURE
    DB['paintsplatbubblelayout'] = TEXTURE
    ...
    DB['wfxbumpmap'] = TEXTURE
    DB['wfxdiffuse'] = TEXTURE
    DB['wfxrma'] = TEXTURE
    DB['ytexture'] = TEXTURE
    ...
    DB['bumpframe'] = INT
    DB['bumpframe2'] = INT
    DB['checkercolor1'] = INT
    DB['checkercolor2'] = INT
    DB['clearalpha'] = INT
    DB['cleardepth'] = INT
    DB['combine_mode'] = INT
    ...
    DB['dudvframe'] = INT
    DB['effect'] = INT
    DB['emissionframe'] = INT
    DB['emissionframe2'] = INT
    ...
    DB['flags'] = INT
    DB['flags2'] = INT
    DB['flags_defined'] = INT
    DB['flags_defined2'] = INT
    DB['flowmapframe'] = INT
    DB['frame'] = INT
    DB['frame2'] = INT
    DB['frame3'] = INT
    ...
    DB['c2_y'] = FLOAT
    DB['c2_z'] = FLOAT
    DB['blendsharpness'] = FLOAT
    DB['bumpmapdetailamount'] = FLOAT
    DB['c3_w'] = FLOAT
    DB['c3_x'] = FLOAT
    DB['c3_y'] = FLOAT
    DB['c3_z'] = FLOAT
    ...
    DB['parallaxcenter'] = FLOAT
    DB['parallaxdepth'] = FLOAT
    DB['parallaxscale'] = FLOAT
    ...
    DB['refracteffectscale'] = FLOAT
    DB['refractscale'] = FLOAT
    ...
    DB['texturepreview_hidealpha'] = FLOAT
    DB['texturepreview_scalex'] = FLOAT
    DB['texturepreview_scaley'] = FLOAT
    DB['tiling'] = FLOAT
    DB['time'] = FLOAT
    DB['time_scale'] = FLOAT
    ...
    DB['glow'] = BOOL
    DB['gradientmodulation'] = BOOL
    DB['hsv_blend'] = BOOL
    DB['ignorevertexcolors'] = BOOL
    DB['interior'] = BOOL
    DB['intro'] = BOOL
    DB['inversedepthblend'] = BOOL
    DB['layereddamageblend'] = BOOL
    ...
    DB['emissionscale'] = COLOR
    DB['emissionscale2'] = COLOR
    ...
    DB['glintu'] = VEC4
    DB['glintv'] = VEC4
    DB['gradientcolorstop0'] = VEC4
    DB['gradientcolorstop1'] = VEC4
    DB['gradientcolorstop2'] = VEC4
