...
the file.
"""
from typing import IO, TYPE_CHECKING, Any, Final, Generic, NamedTuple, Optional, Union, cast
from typing_extensions import Literal, TypeAlias, TypeVar, deprecated, overload
from collections.abc import (
    Callable, Iterable, Iterator, KeysView, Mapping, MutableMapping, Sequence, ValuesView,
)
...
def _make_iter(val_type: ValueType, typ: type[ValueT]) -> Callable[['Attribute[ValueT]'], Iterator[ValueT]]:
    ...
    iterator.__doc__ = f'Iterate over the attribute, treating it as an array of {val_type.name.lower()} values.'
...
class Attribute(_ValProps, Generic[ValueT]):
    ...
    if TYPE_CHECKING:
        def iter_int(self) -> Iterator[builtins.int]:
            ...
            ...
        def iter_float(self) -> Iterator[builtins.float]:
        ...
        def iter_bool(self) -> Iterator[builtins.bool]:
            """Iterate over the attribute, treating it as an array of boolean values."""
            ...
        ...
        def iter_bytes(self) -> Iterator[bytes]:
            """Iterate over the attribute, treating it as an array of bytes values."""
            ...
        ...
        def iter_compound(self) -> Iterator['Element']:
            """Iterate over the attribute, treating it as an array of child Elements."""
            ...
