...
from opentelemetry.exporter.otlp.proto.grpc.trace_exporter import OTLPSpanExporter as BaseOTLPSpanExporter

from ...constants import MULTIPLAYER_OTEL_DEFAULT_TRACES_EXPORTER_GRPC_URL
