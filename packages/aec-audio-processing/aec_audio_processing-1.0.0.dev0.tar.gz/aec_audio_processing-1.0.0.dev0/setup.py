...
setup(
    ...
    version='1.0.0',
    description='VideoSDK WebRTC Audio Processing Module',
    long_description=long_description,
    long_description_content_type='text/markdown',
    author='Deep Bhupatkar',
    author_email='deep@videosdk.live',
    url='https://github.com/videosdk-live/aec-audio-processing',
    ...
    package_data={
        'aec_audio_processing': ['*.py', '*.cpp', '*.h', '*.i']
    }
)