...
class ProcessManager:
    ...
    def probe_processes(self) -> ProbeResponse:
        apm = observability.get_apm_provider()
        apm_info = APMInfo(active=apm.active(),
                           ready=bool(apm.get_trace_id()),
                           provider=apm.__class__.__name__)
    ...
    def _get_process_info(self, id: int | None, name: str) -> ProbeResponse:
        connections: list[ProcessSocketConnection] = []
