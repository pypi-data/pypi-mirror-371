...
from ..api import Env, OdooVersion, OdooVersionRange
from ..api_converter import EnumKey, OdooConfigConverter, OnlyCli, SimpleKey
...
class ConfigConverterDatabase(OdooConfigConverter):
    ...
    _pg_path: Any = OnlyCli("--pg_path", info="specify the pg executable path")
