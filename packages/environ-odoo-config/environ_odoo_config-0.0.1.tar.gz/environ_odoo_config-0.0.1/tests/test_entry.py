...
class TestOdooConfig(unittest.TestCase):
    ...
    def test_env_to_no_section(self):
        ...
        unknown_section = entry.env_to_section(OdooConfigConverter, {})
        # self.assertFalse(unknown_section)
    ...
    def test_env_to_section(self):
        ...
        result_section = entry.env_to_section(ConfigConverterDatabase, extra_env)
    ...
    def test_empty_env(self):
        result_section = entry.env_to_section(ConfigConverterDatabase)
