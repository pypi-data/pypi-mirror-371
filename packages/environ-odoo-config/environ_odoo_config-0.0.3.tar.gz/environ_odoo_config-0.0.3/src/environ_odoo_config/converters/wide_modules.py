...
from ..api import Env
from ..api_converter import NOT_INI_CONFIG, OdooConfigConverter, RepeatableKey, SimpleCSVKey

EP_GROUP_NAME = "environ_odoo_config.server_wide_module"


def _auto_load_entry_point() -> Dict[set, Callable[[Env], bool]]:
    result: Dict[set, Callable[[Env], bool]] = {}
