...
from ..api import OdooVersion, OdooVersionRange, odoo_log_levels
from ..api_converter import NOT_INI_CONFIG, OdooConfigConverter, RepeatableKey, SimpleKey


class ConfigConverterLogging(OdooConfigConverter):
    """
    ...
    log_request: bool = SimpleKey(
        "LOG_REQUEST",
        cli="--log-request",
        odoo_version=OdooVersionRange(vmax=OdooVersion.V15),
