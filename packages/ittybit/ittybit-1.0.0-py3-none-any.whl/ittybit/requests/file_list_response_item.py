...
from ..types.file_list_response_item_kind import FileListResponseItemKind
from ..types.file_list_response_item_object import FileListResponseItemObject
from ..types.file_list_response_item_status import FileListResponseItemStatus


class FileListResponseItemParams(typing_extensions.TypedDict):
    id: str
    media_id: str
