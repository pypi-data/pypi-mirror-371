...
from ..types.files_get_response_kind import FilesGetResponseKind
from ..types.files_get_response_object import FilesGetResponseObject
from ..types.files_get_response_status import FilesGetResponseStatus


class FilesGetResponseParams(typing_extensions.TypedDict):
    id: str
    media_id: str
    object: FilesGetResponseObject
    kind: FilesGetResponseKind
    type: str
