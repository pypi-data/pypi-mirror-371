...
from ..types.files_create_response_kind import FilesCreateResponseKind
from ..types.files_create_response_object import FilesCreateResponseObject
from ..types.files_create_response_status import FilesCreateResponseStatus


class FilesCreateResponseParams(typing_extensions.TypedDict):
    id: str
    media_id: str
    object: FilesCreateResponseObject
    kind: FilesCreateResponseKind
    type: str
    ...
    created: dt.datetime
    updated: dt.datetime
    status: FilesCreateResponseStatus
