...
from ..types.files_update_response_kind import FilesUpdateResponseKind
from ..types.files_update_response_object import FilesUpdateResponseObject
from ..types.files_update_response_status import FilesUpdateResponseStatus


class FilesUpdateResponseParams(typing_extensions.TypedDict):
    id: str
    media_id: str
    object: FilesUpdateResponseObject
    kind: FilesUpdateResponseKind
    type: str
    ...
    created: dt.datetime
    updated: dt.datetime
    status: FilesUpdateResponseStatus
