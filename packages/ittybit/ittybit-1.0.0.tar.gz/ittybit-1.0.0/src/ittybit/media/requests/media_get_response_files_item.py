...
from ..types.media_get_response_files_item_kind import MediaGetResponseFilesItemKind
from ..types.media_get_response_files_item_object import MediaGetResponseFilesItemObject
from ..types.media_get_response_files_item_orientation import MediaGetResponseFilesItemOrientation
from ..types.media_get_response_files_item_status import MediaGetResponseFilesItemStatus


class MediaGetResponseFilesItemParams(typing_extensions.TypedDict):
    id: str
    object: MediaGetResponseFilesItemObject
    kind: MediaGetResponseFilesItemKind
    type: str
    ...
    orientation: typing_extensions.NotRequired[MediaGetResponseFilesItemOrientation]
    ...
    created: dt.datetime
    updated: dt.datetime
    status: MediaGetResponseFilesItemStatus
