...
class Agent:
    ...
    def chat(self, session_id: str, user_input: str, system_addendum: Optional[str] = None) -> str:
        ...
        for _ in range(self.max_turns):
            ...
            # Synthesize system prompt for this call without overshadowing the base template
