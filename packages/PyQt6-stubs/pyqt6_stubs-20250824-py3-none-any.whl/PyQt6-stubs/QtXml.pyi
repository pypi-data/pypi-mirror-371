...
class QDomImplementation(PyQt6.sip.simplewrapper):
    ...
    def createDocument(
        self, nsURI: str | None, qName: str | None, doctype: QDomDocumentType
    ) -> QDomDocument: ...
    def createDocumentType(
        self, qName: str | None, publicId: str | None, systemId: str | None
    ) -> QDomDocumentType: ...
...
class QDomNode(PyQt6.sip.simplewrapper):
    ...
    def nextSiblingElement(
        self, taName: str | None = ..., namespaceURI: str | None = ...
    ) -> QDomElement: ...
    def previousSiblingElement(
        self, tagName: str | None = ..., namespaceURI: str | None = ...
    ) -> QDomElement: ...
    ...
    def isSupported(
        self, feature: str | None, version: str | None
    ) -> bool: ...
...
class QDomDocument(QDomNode):
    ...
    def setContent(
        self,
        reader: QtCore.QXmlStreamReader | None,
    ...
    def setContent(
        self,
        data: QtCore.QByteArray | bytes | bytearray | memoryview | str | None,
        options: QDomDocument.ParseOption = ...,
    ) -> tuple[bool, str, int, int]: ...
    @typing.overload
    def setContent(
        self,
        text: QtCore.QByteArray | bytes | bytearray | memoryview,
        namespaceProcessing: bool,
    ) -> tuple[bool, str | None, int | None, int | None]: ...
    @typing.overload
    def setContent(
        self, text: str | None, namespaceProcessing: bool
    ) -> tuple[bool, str | None, int | None, int | None]: ...
    @typing.overload
    def setContent(
        self, dev: QtCore.QIODevice | None, namespaceProcessing: bool
    ) -> tuple[bool, str | None, int | None, int | None]: ...
    @typing.overload
    def setContent(
        self, reader: QtCore.QXmlStreamReader | None, namespaceProcessing: bool
    ) -> tuple[bool, str | None, int | None, int | None]: ...
    def nodeType(self) -> QDomNode.NodeType: ...
    ...
    def elementsByTagNameNS(
        self, nsURI: str | None, localName: str | None
    ) -> QDomNodeList: ...
    def createAttributeNS(
        self, nsURI: str | None, qName: str | None
    ) -> QDomAttr: ...
    def createElementNS(
        self, nsURI: str | None, qName: str | None
    ) -> QDomElement: ...
    ...
    def createProcessingInstruction(
        self, target: str | None, data: str | None
...
class QDomCharacterData(QDomNode):
    ...
    def length(self) -> int: ...
    def replaceData(
        self, offset: int, count: int, arg: str | None
    ) -> None: ...
...
class QDomElement(QDomNode):
    ...
    @typing.overload
    def setAttributeNS(
        self, nsURI: str | None, qName: str | None, value: str | None
    ) -> None: ...
    @typing.overload
    def setAttributeNS(
        self, nsURI: str | None, qName: str | None, value: float
    ) -> None: ...
    @typing.overload
    def setAttributeNS(
        self, nsURI: str | None, qName: str | None, value: int
    ) -> None: ...
    def attributeNS(
        self,
        nsURI: str | None,
