...
class QSensor(QtCore.QObject):
    ...
    def setIdentifier(
        self, identifier: QtCore.QByteArray | bytes | bytearray | memoryview
    ) -> None: ...
...
class QAmbientLightReading(QSensorReading):
    ...
    def setLightLevel(
        self, lightLevel: QAmbientLightReading.LightLevel
    ) -> None: ...
...
class QTapReading(QSensorReading):
    ...
    def setTapDirection(
        self, tapDirection: QTapReading.TapDirection
    ) -> None: ...
...
class QTapSensor(QSensor):
    ...
    def setReturnDoubleTapEvents(
        self, returnDoubleTapEvents: bool
    ) -> None: ...
