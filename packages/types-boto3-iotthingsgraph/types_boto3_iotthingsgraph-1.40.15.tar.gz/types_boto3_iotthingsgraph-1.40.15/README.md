<a id="types-boto3-iotthingsgraph"></a>

# types-boto3-iotthingsgraph

[![PyPI - types-boto3-iotthingsgraph](https://img.shields.io/pypi/v/types-boto3-iotthingsgraph.svg?color=blue)](https://pypi.org/project/types-boto3-iotthingsgraph/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-iotthingsgraph.svg?color=blue)](https://pypi.org/project/types-boto3-iotthingsgraph/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-iotthingsgraph)](https://pypistats.org/packages/types-boto3-iotthingsgraph)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 IoTThingsGraph 1.40.15](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-iotthingsgraph docs](https://youtype.github.io/types_boto3_docs/types_boto3_iotthingsgraph/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-iotthingsgraph](#types-boto3-iotthingsgraph)
...
- Install `types-boto3[iotthingsgraph]` in your environment:
...
- Install `types-boto3[iotthingsgraph]` with services you use in your
  environment:
...
`types-boto3-iotthingsgraph` dependency in production. However, there is an
...
from types_boto3_iotthingsgraph import IoTThingsGraphClient
...
`types_boto3_iotthingsgraph.paginator` module contains type annotations for all
paginators.
...
`types_boto3_iotthingsgraph.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `IoTThingsGraph` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_iotthingsgraph/literals/).
...
`types_boto3_iotthingsgraph.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `IoTThingsGraph` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_iotthingsgraph/type_defs/).
...
`types-boto3-iotthingsgraph` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_iotthingsgraph/)
