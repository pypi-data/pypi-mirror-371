...
class CommandDeserializer
  ...
  def read_command
    ...
    payload = Array.new(number_of_elements_in_payload)
    for i in 0..number_of_elements_in_payload - 1
      payload[i] = read_object(@buffer[@position])
    end
    Command.new(runtime, command_type, payload)
  end
  ...
  def read_string
    ...
    p = @position
    @position += size
    TypeDeserializer.deserialize_string(string_encoding_mode, @buffer[p...p + size])
  end
  ...
  def read_int
    ...
    p = @position
    @position += size
    TypeDeserializer.deserialize_int(@buffer[p...p + size])
  end
  ...
  def read_float
    ...
    p = @position
    @position += size
    TypeDeserializer.deserialize_float(@buffer[p...p + size])
  end
  ...
  def read_longlong
    ...
    p = @position
    @position += size
    TypeDeserializer.deserialize_longlong(@buffer[p...p + size])
  end
  ...
  def read_double
    ...
    p = @position
    @position += size
    TypeDeserializer.deserialize_double(@buffer[p...p + size])
  end
  ...
  def read_ullong
    ...
    p = @position
    @position += size
    TypeDeserializer.deserialize_ullong(@buffer[p...p + size])
  end
  ...
  def read_uint
    ...
    p = @position
    @position += size
    TypeDeserializer.deserialize_uint(@buffer[p...p + size])
  end
