...
setup(
  name = 'invoicing-pdf-08-22-2025',         #* Your package will have this name
  ...
  author = 'Harsh Mishrikotkar',                   # Your name
  author_email = 'HarshMishrikotkar@example.com',  # Your email
  url = 'https://github.com/Harsh-Mishrikotkar/Python-Project',              # Homepage of your library (e.g. github or your website)
