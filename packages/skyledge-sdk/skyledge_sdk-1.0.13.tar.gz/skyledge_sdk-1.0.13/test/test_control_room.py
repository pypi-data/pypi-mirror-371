...
class TestControlRoom(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ControlRoom:
        """Test ControlRoom
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlRoom`
        """
        model = ControlRoom()
        if include_optional:
            return ControlRoom(
