...
class TestPushChannel(unittest.TestCase):
    """PushChannel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PushChannel:
        """Test PushChannel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PushChannel`
        """
        model = PushChannel()
        if include_optional:
            return PushChannel(
