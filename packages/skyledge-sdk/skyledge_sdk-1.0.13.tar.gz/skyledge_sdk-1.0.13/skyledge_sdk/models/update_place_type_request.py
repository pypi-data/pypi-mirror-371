...
class UpdatePlaceTypeRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "icon"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdatePlaceTypeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdatePlaceTypeRequest from a dict"""
        if obj is None:
            return None
