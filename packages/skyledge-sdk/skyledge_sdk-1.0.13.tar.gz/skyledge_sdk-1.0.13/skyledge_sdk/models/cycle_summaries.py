...
class CycleSummaries(BaseModel):
    """
    CycleSummaries
    """ # noqa: E501
    total_count: Optional[StrictInt] = Field(default=None, alias="totalCount")
    results: Optional[List[CycleSummaryResponse]] = None
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["totalCount", "results", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CycleSummaries from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CycleSummaries from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [CycleSummaryResponse.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "_links": dict(
