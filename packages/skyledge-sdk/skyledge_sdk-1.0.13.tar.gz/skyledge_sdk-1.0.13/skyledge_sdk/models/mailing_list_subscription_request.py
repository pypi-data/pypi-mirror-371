...
class MailingListSubscriptionRequest(BaseModel):
    """
    MailingListSubscriptionRequest
    """ # noqa: E501
    list_name: StrictStr = Field(alias="listName")
    __properties: ClassVar[List[str]] = ["listName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MailingListSubscriptionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MailingListSubscriptionRequest from a dict"""
        if obj is None:
            return None
