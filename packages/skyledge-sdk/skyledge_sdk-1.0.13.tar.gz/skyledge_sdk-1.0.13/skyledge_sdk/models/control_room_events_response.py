...
class ControlRoomEventsResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ControlRoomEventsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ControlRoomEventsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "events": [ControlRoomEventResponse.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
            "_links": dict(
