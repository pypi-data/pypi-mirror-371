...
class CycleTypeMetricsDto(BaseModel):
    """
    CycleTypeMetricsDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "icon", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CycleTypeMetricsDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CycleTypeMetricsDto from a dict"""
        if obj is None:
            return None
