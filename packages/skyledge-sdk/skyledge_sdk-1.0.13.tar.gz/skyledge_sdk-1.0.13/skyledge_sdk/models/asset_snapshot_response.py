...
class AssetSnapshotResponse(BaseModel):
    ...
    """ # noqa: E501
    location: Optional[LocationHistory] = None
    metrics: Optional[Dict[str, MetricHistory]] = None
    __properties: ClassVar[List[str]] = ["location", "metrics"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetSnapshotResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetSnapshotResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "location": LocationHistory.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "metrics": dict(
                (_k, MetricHistory.from_dict(_v))
