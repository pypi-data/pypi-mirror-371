...
class PlaceTypeRequest(BaseModel):
    """
    PlaceTypeRequest
    """ # noqa: E501
    ...
    icon: StrictStr
    __properties: ClassVar[List[str]] = ["identifier", "name", "description", "controlRooms", "icon"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceTypeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceTypeRequest from a dict"""
        if obj is None:
            return None
