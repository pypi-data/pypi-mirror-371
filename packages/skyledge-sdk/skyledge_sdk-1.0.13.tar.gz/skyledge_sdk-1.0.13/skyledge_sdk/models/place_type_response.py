...
class PlaceTypeResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "createdAt", "ownerId", "identifier", "icon"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceTypeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceTypeResponse from a dict"""
        if obj is None:
            return None
