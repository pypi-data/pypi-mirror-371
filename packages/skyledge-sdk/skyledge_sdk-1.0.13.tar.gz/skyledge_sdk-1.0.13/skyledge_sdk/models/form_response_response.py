...
class FormResponseResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "formId", "formIdentifier", "createdAt", "version", "response"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FormResponseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FormResponseResponse from a dict"""
        if obj is None:
            return None
