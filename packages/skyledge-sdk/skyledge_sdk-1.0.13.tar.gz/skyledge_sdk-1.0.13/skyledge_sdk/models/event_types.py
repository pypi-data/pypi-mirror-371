...
class EventTypes(BaseModel):
    ...
    EventTypes
    """ # noqa: E501
    event_types: Optional[List[EventTypeResponse]] = Field(default=None, alias="eventTypes")
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["eventTypes", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eventTypes": [EventTypeResponse.from_dict(_item) for _item in obj["eventTypes"]] if obj.get("eventTypes") is not None else None,
            "_links": dict(
