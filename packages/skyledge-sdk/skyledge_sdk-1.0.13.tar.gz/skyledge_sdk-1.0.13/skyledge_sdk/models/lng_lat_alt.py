...
class LngLatAlt(BaseModel):
    ...
    additional_elements: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, alias="additionalElements")
    __properties: ClassVar[List[str]] = ["longitude", "latitude", "altitude", "additionalElements"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "additionalElements": obj.get("additionalElements")
        })
        return _obj
