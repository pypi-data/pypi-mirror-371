...
from skyledge_sdk.configuration import Configuration
from skyledge_sdk.api_response import ApiResponse, T as ApiResponseT
import skyledge_sdk.models
from skyledge_sdk import rest
from skyledge_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(skyledge_sdk.models, klass)
