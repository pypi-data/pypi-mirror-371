...
class InstalledAppsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["apps", "totalCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstalledAppsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstalledAppsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "apps": [InstalledAppResponse.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None,
