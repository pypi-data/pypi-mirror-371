...
class FormsResponse(BaseModel):
    ...
    forms: Optional[FormsResponseForms] = None
    __properties: ClassVar[List[str]] = ["totalCount", "forms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "forms": FormsResponseForms.from_dict(obj["forms"]) if obj.get("forms") is not None else None
        })
        return _obj
