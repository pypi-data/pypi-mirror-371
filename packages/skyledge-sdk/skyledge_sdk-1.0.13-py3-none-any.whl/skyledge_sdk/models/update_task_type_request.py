...
class UpdateTaskTypeRequest(BaseModel):
    ...
    custom_filters: Optional[List[Any]] = Field(default=None, alias="customFilters")
    quick_filters: Optional[List[QuickFilter]] = Field(default=None, alias="quickFilters")
    __properties: ClassVar[List[str]] = ["name", "title", "description", "attributes", "properties", "actions", "icon", "customFilters", "quickFilters"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateTaskTypeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateTaskTypeRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "icon": obj.get("icon"),
            "customFilters": obj.get("customFilters"),
