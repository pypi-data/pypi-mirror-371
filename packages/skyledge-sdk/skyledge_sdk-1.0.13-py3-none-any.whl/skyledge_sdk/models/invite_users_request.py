...
class InviteUsersRequest(BaseModel):
    ...
    InviteUsersRequest
    """ # noqa: E501
    users: Annotated[List[InviteUserRequest], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [InviteUserRequest.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
