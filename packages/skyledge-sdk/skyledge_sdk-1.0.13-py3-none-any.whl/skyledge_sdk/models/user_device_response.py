...
class UserDeviceResponse(BaseModel):
    ...
    last_active_at: StrictStr = Field(alias="lastActiveAt")
    created_at: StrictStr = Field(alias="createdAt")
    __properties: ClassVar[List[str]] = ["deviceId", "userId", "platform", "brand", "appVersion", "pushToken", "lastActiveAt", "createdAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserDeviceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserDeviceResponse from a dict"""
        if obj is None:
            return None
