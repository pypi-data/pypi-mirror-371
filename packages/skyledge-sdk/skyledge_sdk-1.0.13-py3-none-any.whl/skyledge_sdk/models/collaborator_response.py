...
class CollaboratorResponse(BaseModel):
    ...
    pending: StrictBool
    __properties: ClassVar[List[str]] = ["name", "role", "userId", "pending"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollaboratorResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollaboratorResponse from a dict"""
        if obj is None:
            return None
