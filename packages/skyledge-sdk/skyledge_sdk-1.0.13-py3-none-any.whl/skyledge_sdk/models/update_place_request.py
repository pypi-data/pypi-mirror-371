...
class UpdatePlaceRequest(BaseModel):
    ...
    location: Polygon
    __properties: ClassVar[List[str]] = ["name", "description", "location"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdatePlaceRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdatePlaceRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "location": Polygon.from_dict(obj["location"]) if obj.get("location") is not None else None
        })
        return _obj
