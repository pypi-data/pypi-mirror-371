...
class CollaboratorsResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollaboratorsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollaboratorsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "collaborators": [CollaboratorResponse.from_dict(_item) for _item in obj["collaborators"]] if obj.get("collaborators") is not None else None
        })
        return _obj
