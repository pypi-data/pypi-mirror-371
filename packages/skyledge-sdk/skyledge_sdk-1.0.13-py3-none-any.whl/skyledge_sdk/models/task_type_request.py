...
class TaskTypeRequest(BaseModel):
    ...
    custom_filters: List[Any] = Field(alias="customFilters")
    quick_filters: Optional[List[QuickFilter]] = Field(default=None, alias="quickFilters")
    __properties: ClassVar[List[str]] = ["identifier", "name", "title", "attributes", "properties", "actions", "description", "icon", "customFilters", "quickFilters"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaskTypeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaskTypeRequest from a dict"""
        if obj is None:
            return None
