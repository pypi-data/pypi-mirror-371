...
class AssetLocationResponse(BaseModel):
    ...
    """ # noqa: E501
    times: List[StrictStr]
    locations: List[Dict[str, Any]]
    total_count: StrictInt = Field(alias="totalCount")
    __properties: ClassVar[List[str]] = ["times", "locations", "totalCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetLocationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetLocationResponse from a dict"""
        if obj is None:
            return None
