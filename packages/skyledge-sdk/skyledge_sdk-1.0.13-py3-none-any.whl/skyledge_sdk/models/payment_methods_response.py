...
class PaymentMethodsResponse(BaseModel):
    ...
    """ # noqa: E501
    payment_methods: Optional[List[PaymentMethodResponse]] = Field(default=None, alias="paymentMethods")
    __properties: ClassVar[List[str]] = ["paymentMethods"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "paymentMethods": [PaymentMethodResponse.from_dict(_item) for _item in obj["paymentMethods"]] if obj.get("paymentMethods") is not None else None
        })
        return _obj
