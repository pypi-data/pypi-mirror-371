...
class NotificationActionConfig(BaseModel):
    ...
    """ # noqa: E501
    channels: Optional[List[NotificationActionConfigChannelsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NotificationActionConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NotificationActionConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "channels": [NotificationActionConfigChannelsInner.from_dict(_item) for _item in obj["channels"]] if obj.get("channels") is not None else None
        })
        return _obj
