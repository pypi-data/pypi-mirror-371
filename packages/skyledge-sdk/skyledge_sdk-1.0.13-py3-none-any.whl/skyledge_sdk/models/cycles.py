...
class Cycles(BaseModel):
    ...
    cycles: Optional[List[CycleResponse]] = None
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["totalCount", "cycles", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Cycles from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in cycles (list)
        _items = []
        if self.cycles:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Cycles from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "cycles": [CycleResponse.from_dict(_item) for _item in obj["cycles"]] if obj.get("cycles") is not None else None,
            "_links": dict(
