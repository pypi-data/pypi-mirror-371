...
class SecretSingletonServicer(SecretBaseServicer):
    ...
    async def _Write(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.secrets.Secret('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.Write()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
    ...
    async def _Read(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.secrets.Secret('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.Read()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
    ...
    async def _Delete(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.secrets.Secret('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.Delete()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
...
class SecretServicer(SecretBaseServicer):
    ...
    async def _Write(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.cloud.v1alpha1.secrets.Secret('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.Write()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _Read(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.cloud.v1alpha1.secrets.Secret('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.Read()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _Delete(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.cloud.v1alpha1.secrets.Secret('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.Delete()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
...
class SecretServicerNodeAdaptor(Secret.singleton.Servicer):
    ...
    async def Write(
        ...
        try:
            ...
            return rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteResponse.FromString(result.response)
    ...
    async def Read(
        ...
        try:
            ...
            return rbt.cloud.v1alpha1.secrets.secrets_pb2.ReadResponse.FromString(result.response)
    ...
    async def Delete(
        ...
        try:
            ...
            assert result.HasField('response')
            return rbt.cloud.v1alpha1.secrets.secrets_pb2.DeleteResponse.FromString(result.response)
