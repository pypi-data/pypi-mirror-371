...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-elasticbeanstalk)](https://pypistats.org/packages/mypy-boto3-elasticbeanstalk)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 ElasticBeanstalk 1.40.15](https://pypi.org/project/boto3/) compatible
...
`mypy-boto3-elasticbeanstalk` dependency in production. However, there is an
