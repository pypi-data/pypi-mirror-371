...
class FacetBucket(BaseModel):
    ...
    def expression(self) -> str:
        """Return the expression for the facet bucket."""
...
class FacetBuckets(BaseModel):
    ...
    @property
    def expression(self) -> str:
        """Return the expression for the facet buckets."""
        return self.model_dump(by_alias=True)
...
class FacetDefinition(BaseModel):
    ...
    @property
    def expression(self) -> str:
        """Return the expression for the facet definition."""
        return self.model_dump(by_alias=True)
...
class Facet(SearchCollector):
    ...
    def numeric(
        ...
        *,
        ...
        self.facet(
            type="number", path=path, name=name, boundaries=boundaries, default=default
        )
        return self
    ...
    def date(
        ...
        *,
        ...
        self.facet(
            type="date", path=path, name=name, boundaries=boundaries, default=default
        )
        return self

    def string(
        self, path: str, *, num_buckets: int = 10, name: str | None = None
    ) -> Self:
