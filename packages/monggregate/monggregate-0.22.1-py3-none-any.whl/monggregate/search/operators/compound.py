...
class Compound(SearchOperator):
    ...
    def expression(self) -> Expression:
        ...
        return self.express({"compound": clauses})
    ...
    def autocomplete(
        ...
        **kwargs: Any,
        ...
        _autocomplete = Autocomplete(
            query=query, path=path, token_order=token_order, fuzzy=fuzzy, score=score
        )
    ...
    def equals(
        ...
        **kwargs: Any,
        ...
        _equals = Equals(path=path, value=value, score=score)
    ...
    def range(
        ...
        **kwargs: Any,
        ...
        _range = Range(path=path, gt=gt, gte=gte, lt=lt, lte=lte, score=score)
