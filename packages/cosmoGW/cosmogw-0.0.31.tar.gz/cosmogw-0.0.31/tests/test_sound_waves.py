...
class TestUnits(unittest.TestCase):
    ...
    def test_GWs_sound_waves(self):
        ...
        # read test data
        with open(
            COSMOGW_HOME + 'tests/GWs_sound_waves/Oms_sws1.pkl', 'rb'
        ) as f:
    ...
    def test_read_Omega_higgsless(self):
        ...
        with open(
            COSMOGW_HOME + 'tests/GWs_sound_waves/OmGWtilde_HL.pkl', 'rb'
        ) as f:
    ...
    def test_compute_read_K0s(self):
        ...
        with open(
            COSMOGW_HOME + 'tests/GWs_sound_waves/K0_Esp_HL.pkl', 'rb'
        ) as f:
    ...
    def test_tdurs_Esp(self):
        ...
        with open(
            COSMOGW_HOME + 'tests/GWs_sound_waves/tdur_eddy_HL.pkl', 'rb'
        ) as f:
    ...
    def test_K2ints_flat(self):
        ...
        with open(
            COSMOGW_HOME + 'tests/GWs_sound_waves/K2ints_flat_HL.pkl', 'rb'
        ) as f:
    ...
    def test_K2ints_exp(self):
        ...
        with open(
            COSMOGW_HOME + 'tests/GWs_sound_waves/K2ints_exp_HL.pkl', 'rb'
        ) as f:
    ...
    def test_prefs_sw_HL(self):
        ...
        with open(
            COSMOGW_HOME + 'tests/GWs_sound_waves/prefs_HL.pkl', 'rb'
        ) as f:
    ...
    def test_shapes_sw_HL(self):
        ...
        with open(
            COSMOGW_HOME + 'tests/GWs_sound_waves/shapes_sw_HL.pkl', 'rb'
        ) as f:
    ...
    def test_shapes2_sw_HL(self):
        ...
        with open(
            COSMOGW_HOME + 'tests/GWs_sound_waves/shapes2_sw_HL.pkl', 'rb'
        ) as f:
    ...
    def test_shapes3_sw_HL(self):
        ...
        with open(
            COSMOGW_HOME + 'tests/GWs_sound_waves/shapes3_sw_HL.pkl', 'rb'
        ) as f:
    ...
    def test_shell_thickness_HL(self):
        ...
        with open(
            COSMOGW_HOME + 'tests/GWs_sound_waves/shell_thickness_HL.pkl', 'rb'
        ) as f:
