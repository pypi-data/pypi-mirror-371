...
This module provides Numba-optimized wavelet variance analysis for estimating 
...
class WaveletVarianceEstimatorNumba(BaseEstimator):
    """
    Numba-optimized Wavelet Variance Analysis estimator.
    ...
    def __init__(self, wavelet: str = 'db4', scales: Optional[List[int]] = None, 
        ...
        print("Numba Wavelet Variance: Using JIT-compiled optimization")
    ...
    def estimate(self, data: np.ndarray) -> Dict[str, Any]:
        ...
        y = np.array(variance_logs, dtype=np.float64)
