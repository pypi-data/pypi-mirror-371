...
class RSEstimatorJAX(BaseEstimator):
    ...
    @staticmethod
    def _calculate_rs_batch(data: jnp.ndarray, window_sizes: jnp.ndarray, 
    ...
    def plot_scaling(self, save_path: str = None, show: bool = True) -> None:
        ...
        # Plot data points
        ax.scatter(self.results['log_sizes'], self.results['log_rs'], 
