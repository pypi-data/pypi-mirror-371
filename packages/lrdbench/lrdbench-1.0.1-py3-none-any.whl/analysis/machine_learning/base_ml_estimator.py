...
class BaseMLEstimator(ABC):
    ...
    def __init__(self, **kwargs):
        ...
        **kwargs : dict
        ...
        self.feature_extraction_method = kwargs.get('feature_extraction_method', 'statistical')
    ...
    def _extract_statistical_features(self, data: np.ndarray) -> np.ndarray:
        ...
        for series in data:
            ...
            # Variance features
            var_ratio = np.var(series[::2]) / np.var(series[1::2]) if len(series) > 2 else 1.0
            ...
            feature_vector = [
                ...
                var_ratio, entropy, hurst_approx
            ]
    ...
    def _extract_spectral_features(self, data: np.ndarray) -> np.ndarray:
        ...
        for series in data:
            ...
            feature_vector = [
                spectral_slope, spectral_entropy, dominant_freq,
    ...
    def _extract_wavelet_features(self, data: np.ndarray) -> np.ndarray:
        ...
        try:
            ...
            raise ImportError("PyWavelets is required for wavelet features. Install with: pip install PyWavelets")
    ...
    def _calculate_confidence_interval(self, estimate: float, confidence: float = 0.95) -> Tuple[float, float]:
        """
    ...
    def load_model(self, filepath: str) -> None:
        ...
        if previous_feature_method is not None and loaded_feature_method != previous_feature_method:
            print(
        ...
        self.feature_extraction_method = self.parameters.get('feature_extraction_method', self.feature_extraction_method)
    ...
    def get_default_model_filename(self) -> str:
        ...
        try:
            signature_payload = {
                ...
                'model_params': self.model_params if isinstance(self.model_params, dict) else str(self.model_params),
            }
    ...
    def get_model_path(self, model_dir: str = "saved_models", filename: Optional[str] = None) -> str:
