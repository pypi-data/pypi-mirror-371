...
class MultifractalWaveletLeadersEstimator(BaseEstimator):
    ...
    def _compute_structure_functions(self, data: np.ndarray, q: float, scale: int) -> float:
        """
    ...
    def estimate(self, data: np.ndarray) -> Dict[str, Any]:
        ...
        for q in q_values:
            ...
            try:
                # Linear regression
                slope, intercept, r_value, p_value, std_err = stats.linregress(log_j, log_sq)
        ...
        self.results = {
            ...
            'q_values': q_values,
            'structure_functions': {q: sq.tolist() if hasattr(sq, 'tolist') else list(sq) 
