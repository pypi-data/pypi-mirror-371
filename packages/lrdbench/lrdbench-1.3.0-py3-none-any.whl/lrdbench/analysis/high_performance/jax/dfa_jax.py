...
class DFAEstimatorJAX(BaseEstimator):
    ...
    def __init__(self, min_box_size: int = 4, max_box_size: int = None,
                 box_sizes: List[int] = None, polynomial_order: int = 1,
                 use_gpu: bool = True):
        """
    ...
    @staticmethod
    def _calculate_fluctuation_jax(segment: jnp.ndarray, polynomial_order: int) -> jnp.ndarray:
        """
    ...
    @staticmethod
    def _calculate_fluctuations_batch(data: jnp.ndarray, box_sizes: jnp.ndarray, 
                                    polynomial_order: int) -> jnp.ndarray:
        """
        ...
        for box_size in box_sizes:
            ...
            for i in range(n_boxes):
                ...
                f = DFAEstimatorJAX._calculate_fluctuation_jax(segment, polynomial_order)
    ...
    def estimate(self, data: np.ndarray) -> Dict[str, Any]:
        ...
        if self.parameters['box_sizes'] is not None:
            ...
            box_sizes = jnp.unique(jnp.logspace(
                jnp.log10(min_size), jnp.log10(max_size), 
    ...
    def plot_scaling(self, save_path: str = None, show: bool = True) -> None:
        ...
        # Plot data points
        ax.scatter(self.results['log_sizes'], self.results['log_fluctuations'], 
