...
# from ut_eviq.rst.utils import Evex as RstEvex
from ut_eviq.xls.utils import Evex as XlsEvex
...
class TaskIn:
    ...
    @staticmethod
    def evupadm(kwargs: TyDic) -> tuple[TnAoD, TyDoAoD]:
        """
        ...
        _tup_adm: tuple[TnAoD, TyDoAoD] = Evup.sh_aod_evup_adm(
                ...
                Evex.read_wb_exp_to_df(kwargs),
                kwargs)
        return _tup_adm

    @staticmethod
    def evupdel(kwargs: TyDic) -> tuple[TnAoD, TyDoAoD]:
        """
    ...
    @staticmethod
    def evupreg(
           kwargs: TyDic) -> tuple[TnAoD, TyDoAoD, TnAoD, TyDoAoD]:
        """
    ...
    @staticmethod
    def evdomap(kwargs: TyDic) -> TyAoD:
        """
