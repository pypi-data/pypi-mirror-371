...
class TaskIoc:
    ...
    def evupadm(cls, kwargs: TyDic) -> None:
        ...
        """
        TaskOut.evupadm(TaskIn.evupadm(kwargs), kwargs)
    ...
    def evupdel(cls, kwargs: TyDic) -> None:
        ...
        """
        TaskOut.evupdel(TaskIn.evupdel(kwargs), kwargs)
    ...
    def evupreg(cls, kwargs: TyDic) -> None:
        ...
        if _sw_single_wb:
            ...
            TaskOut.evupreg_reg_wb(TaskIn.evupreg(kwargs), kwargs)
        else:
            # write separate workbooks for admin and delete worksheets
            TaskOut.evupreg_adm_del_wb(TaskIn.evupreg(kwargs), kwargs)
    ...
    def evdomap(cls, kwargs: TyDic) -> None:
        ...
        """
        TaskOut.evdomap(TaskIn.evdomap(kwargs), kwargs)
