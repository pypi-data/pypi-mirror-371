...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-simspaceweaver)](https://pypistats.org/packages/mypy-boto3-simspaceweaver)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 SimSpaceWeaver 1.40.16](https://pypi.org/project/boto3/) compatible with
...
`mypy-boto3-simspaceweaver` dependency in production. However, there is an
