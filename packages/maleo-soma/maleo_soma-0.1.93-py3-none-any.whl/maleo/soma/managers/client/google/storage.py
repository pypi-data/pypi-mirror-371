...
from maleo.soma.schemas.authentication import Authentication, MandatoryAuthentication
...
class GoogleCloudStorage(GoogleClientManager):
    def __init__(
        ...
        completed_at = datetime.now(tz=timezone.utc)
        SuccessfulSystemOperationSchema[None](
            service_context=self._service_context,
            id=operation_id,
    ...
    async def upload(
        ...
        authentication: Optional[Union[Authentication, MandatoryAuthentication]] = None,
        ...
        try:
            ...
            CreateSingleResourceOperationSchema[StorageDataSchema, None](
                service_context=self._service_context,
                id=operation_id,
                context=self._operation_context,
                timestamp=OperationTimestamp(
    ...
    async def generate_signed_url(
        ...
        if search_in_redis:
            ...
            if url is not None:
                ...
                ReadSingleResourceOperationSchema[StorageDataSchema, None](
                    service_context=self._service_context,
                    id=operation_id,
