...
def face_split(self, face: bmesh.types.BMFace, vert_a: bmesh.types.BMVert, vert_b: bmesh.types.BMVert, coords: typing.Any = (), use_exist: bool = True, example: bmesh.types.BMEdge = None) -> typing.Any:
...
def vert_separate(self, vert: bmesh.types.BMVert, edges: bmesh.types.BMEdge) -> typing.Any:
