...
active_sequence_strip: bpy.types.Strip = ...

sequences: typing.Sequence[bpy.types.Strip] = ...

selected_sequences: typing.Sequence[bpy.types.Strip] = ...

selected_editable_sequences: typing.Sequence[bpy.types.Strip] = ...
