...
class DurusAIClient:
    ...
    def _make_request(self, method: str, endpoint: str, **kwargs) -> httpx.Response:
        ...
        # Для auth эндпоинтов не добавляем /cli префикс
...
class SyncDurusAIClient:
    ...
    def get_user_info(self) -> Dict[str, Any]:
        return self._run_async(self.client.get_user_info())
    
    def query(self, prompt: str, **kwargs) -> Dict[str, Any]:
        return self._run_async(self.client.query(prompt, **kwargs))
    ...
    def get_history(self, page: int = 1, per_page: int = 20) -> Dict[str, Any]:
        return self._run_async(self.client.get_history(page, per_page))
