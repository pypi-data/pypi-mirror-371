...
class InteractiveMode:
    ...
    def show_welcome(self):
        ...
        self.console.print(Panel.fit(
            "🤖 [bold blue]Добро пожаловать в DurusAI Interactive Mode![/bold blue]\n\n"
            f"📋 Текущая модель: [cyan]{self.current_model}[/cyan]\n"
            f"🔧 API: [dim]{self.config.get_api_endpoint()}[/dim]\n\n"
            "[yellow]Команды:[/yellow]\n"
            "• [green]/help[/green] - показать справку\n"
            "• [green]/model <name>[/green] - сменить модель\n"
            "• [green]/clear[/green] - очистить историю\n"
            "• [green]/quit[/green] или [green]Ctrl+D[/green] - выйти\n\n"
            "[dim]Просто начните печатать ваш вопрос...[/dim]",
    ...
    def handle_query(self, query: str):
        ...
        try:
            ...
            # Рендерим Markdown если возможно
            try:
