...
class InteractiveMode:
    ...
    def print_ai_response(self, content: str):
        """Простой вывод AI ответа как обычный текст (Claude CLI style)"""
        # Выводим как обычный текст для полного скроллинга и копирования
        print(content)
...
Создай проект прямо в текущей директории пользователя."""
                ...
                # Показываем AI ответ как простой текст
...
Верни ТОЛЬКО улучшенный код в формате ```python"""
                ...
                if file_path:
                    ...
                    if file_result.get("success"):
                        ...
                        if any(word in query.lower() for word in ['анализируй', 'analyze', 'что делает', 'объясни']):
                            ...
                            # Выводим анализ как простой текст
    ...
    def handle_query(self, query: str):
        ...
        try:
            ...
            # Выводим ответ как простой текст (Claude CLI style)  
            self.print_ai_response(response)
