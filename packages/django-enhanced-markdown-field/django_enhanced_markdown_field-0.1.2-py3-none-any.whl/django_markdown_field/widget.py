...
class MarkdownFormWidget(AdminTextareaWidget):
    def render(self, name, value, attrs={}, renderer=None):
        ...
        # get template object
        template = get_template("django_markdown_field.html")
    ...
    class Media:
        js = [
            ESM("admin/js/django_markdown_field/django-markdown-field.js"),
        ]
