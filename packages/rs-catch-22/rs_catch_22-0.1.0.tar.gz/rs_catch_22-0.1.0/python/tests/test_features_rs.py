...
def load_benchmark_datasets():
    ...
    benchmark_datasets = {}
    inputs_folder_path = 'python/tests/validation/inputs/*'
        ...
        if os.path.exists(file_path):
            with open(file_path, 'r') as file:
                ...
                try:
                    ...
                    # Check for both scalar and 0-dimensional arrays
                    if np.isscalar(ts_data) or ts_data.ndim == 0:
...
def load_expected_outputs():
    ...
    expected_outputs = {}
    outputs_folder_path = 'python/tests/validation/expected_outputs/*'
...
def compute_new_features():
    """Computes new feature outputs on same benchmarking dataset using Rust implementation and
    ...
    for dset in datasets:
        ...
        test_data = benchmark_datasets[dset].tolist()  # Convert numpy array to list for Rust
        
        # Use the Rust implementation
        res = rs_catch_22.py_catch22_all(test_data, catch24=True, normalize=True)
...
# Add this at the end of test_features_rs.py
