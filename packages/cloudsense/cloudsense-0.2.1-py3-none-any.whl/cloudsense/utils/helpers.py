...
def categorize_ebs_usage_improved(usage_type: str) -> str:
    ...
    elif 'gp3' in clean_type and ('VolumeUsage' in clean_type or 'IOPS' in clean_type or 'Throughput' in clean_type):
        return 'EBS gp3 Storage'
    elif 'VolumeUsage.gp3' in clean_type:
        return 'EBS gp3 Storage'
    elif 'IOPS.gp3' in clean_type:
        return 'EBS gp3 Storage'
    elif 'Throughput.gp3' in clean_type:
        return 'EBS gp3 Storage'
