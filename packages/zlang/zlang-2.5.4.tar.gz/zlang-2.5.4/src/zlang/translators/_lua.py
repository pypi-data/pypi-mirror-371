...
class T(Template):
    ...
    def _if_else(s):                                                                return f"if {s.wt(s.n[1])} then{s.body(s.wt(s.n[2]))}\n{" "*(s.indent-4)}else{s.body(s.wt(s.n[3]))}\nend"
    def _if_elif(s):                                                                return f"if {s.wt(s.n[1])} then{s.body(s.wt(s.n[2]))}{s.body(list((" "*(s.indent-4))+f"elseif {s.wt(cond)} then{s.body(s.wt(prog))}" for cond, prog in s.n[3]))}\nend"
    def _if_elif_else(s):                                                           return f"if {s.wt(s.n[1])} then{s.body(s.wt(s.n[2]))}{s.body(list((" "*(s.indent-4))+f"elseif {s.wt(cond)} then{s.body(s.wt(prog))}" for cond, prog in s.n[3]))}\n{" "*(s.indent-4)}else{s.body(s.wt(s.n[4]))}\nend"
