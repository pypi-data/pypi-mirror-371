...
STATS = ['n_tips',
         ...
         'brlen_sum_4-chain_perc1', 'brlen_sum_4-chain_perc5', 'brlen_sum_4-chain_perc10', 'brlen_sum_4-chain_perc25',
         #
         ...
         #
         'time_diff_in_2_real_mean', 'time_diff_in_3L_real_mean', 'time_diff_in_I_real_mean',
