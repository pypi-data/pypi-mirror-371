...
__version__ = "0.2.3"
__short_description__ = "A Pythonic wrapper library for AWS SSM Parameter Store with enhanced error handling, existence testing, idempotent operations, and comprehensive tag management."
__license__ = "MIT"
__author__ = "Sanhe Hu"
