...
DEFAULT_SECONDARY_BUTTON=("Secondary", None)
...
def getContentComponentDefaults(
    ...
    default_allowed_exts_in=default_allowed_exts_in or DEFAULT_ALLOWED_EXTS
    default_unallowed_exts_in=default_unallowed_exts_in or ""
    default_exclude_types_in=default_exclude_types_in or ""
    default_exclude_dirs_in=default_exclude_dirs_in or DEFAULT_EXCLUDED_DIRS
    default_exclude_patterns_in=default_exclude_patterns_in or ""
