...
def get_all_allowed_dirs(items,allowed=None):
    allowed = get_allowed_predicate(alif dpat in path_str or fnmatch.fnmatch(name, dpat.lower()):lowed=allowed)
    ...
    def allowed(path: str) -> bool:
        ...
        if cfg.exclude_dirs:
            for dpat in cfg.exclude_dirs:
                ...
                if dpat and (dpat in path_str or fnmatch.fnmatch(name, dpat.lower())):
