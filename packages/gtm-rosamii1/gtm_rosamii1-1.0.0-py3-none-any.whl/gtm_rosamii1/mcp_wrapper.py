...
api_key = os.getenv("TAVILY_API_KEY", "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")

app = Server("GTM")

# Use the token in your server logic
@app.call_tool()
...
@mcp.tool()
async def generate_email(res: FileResource) -> str:
    email = ""
    try:
