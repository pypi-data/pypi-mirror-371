...
from vschart.constants import LineStyle, MarkerPosition, MarkerShape, Color, Size
...
class SeriesBase(Base):
    ...
    def add_trend_line(self,
        ...
        fibonacci_line_color: str = Color.YELLOW,
        fibonacci_line_width: int = 1,
        fibonacci_line_style: int = LineStyle.DASHED
        ) -> 'TrendLine':
        ...
        options = {
            ...
            'showFibonacci': show_fibonacci,
            'fibonacciLineColor': fibonacci_line_color,
            'fibonacciLineWidth': fibonacci_line_width,
            'fibonacciLineStyle': fibonacci_line_style,
        }
