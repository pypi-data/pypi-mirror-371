...
def test_tooltip(candlestick_series: CandlestickSeries, volume_series,
    ...
    tooltip1 = candlestick_series.add_tooltip(title = "haha")
    ...
    # Test 9: Add tooltip to volume series with custom options
    logging.info("\n9. Adding tooltip to volume series with custom options")
    tooltip2 = volume_series.add_tooltip(
        title = "Volume",
        background_color =  "rgba(0, 100, 255, 0.8)",
        text_color = "white",
        font_size = 13
    )
    pause_for_next("Hover over the volume series to see the tooltip...", interactive_mode)
    
    # Test 10: Remove tooltip from candlestick series
    logging.info("\n10. Removing tooltip from candlestick series")
    ...
    # Test 11: Change volume tooltip Y position
    logging.info("\n11. Changing volume tooltip Y position.")
    ...
    # Test 12: Remove tooltip from volume series
    logging.info("\n12. Removing tooltip from volume series")
