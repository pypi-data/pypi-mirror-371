...
from equia.models import (
    ...
    SlePointFixedPressureCalculationInput, SlePointCalculationResult
)
...
async def test_call_slepoint():
    ...
    input: SlePointFixedPressureCalculationInput = client.get_sle_point_fixed_pressure_input()
    input.pressure = 20
    input.components = [
    ...
    result: Union[SlePointCalculationResult, ProblemDetails] = await client.call_sle_point_fixed_pressure_async(input)
