...
T = TypeVar("T", bound="FluidDeleteResult")


@attr.s(auto_attribs=True)
class FluidDeleteResult:
    """Holds result for deleting a fluid.
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Dump `FluidDeleteResult` instance to a dict."""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        """Load `FluidDeleteResult` instance from a dict."""
        d = src_dict.copy()
