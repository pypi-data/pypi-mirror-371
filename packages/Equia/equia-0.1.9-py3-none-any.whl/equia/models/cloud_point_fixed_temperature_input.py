...
T = TypeVar("T", bound="CloudPointFixedTemperatureCalculationInput")


@attr.s(auto_attribs=True)
class CloudPointFixedTemperatureCalculationInput:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Dump `CloudPointFixedTemperatureCalculationInput` instance to a dict."""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        """Load `CloudPointFixedTemperatureCalculationInput` instance from a dict."""
        d = src_dict.copy()
    ...
    @classmethod
    def from_input_object(cls: Type[T], input_object: "CloudPointFixedTemperatureCalculationInput") -> T:
        """Load `CloudPointFixedTemperatureCalculationInput` instance from a similar instance, such as `FlashFixedTemperaturePressureCalculationInput`.
        This is useful for copying data from one instance to another.
        
        Parameters
        ----------
        input_object : Union[EosPropertiesTPnCalculationInput, FlashFixedTemperaturePressureCalculationInput, CloudPointFixedTemperatureCalculationInput]
