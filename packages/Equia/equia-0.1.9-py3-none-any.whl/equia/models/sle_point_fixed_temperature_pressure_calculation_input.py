...
T = TypeVar("T", bound="SlePointFixedTemperaturePressureCalculationInput")


@attr.s(auto_attribs=True)
class SlePointFixedTemperaturePressureCalculationInput:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Dump `SlePointFixedTemperaturePressureCalculationInput` instance to a dict."""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        """Load `SlePointFixedTemperaturePressureCalculationInput` instance from a dict."""
        d = src_dict.copy()
