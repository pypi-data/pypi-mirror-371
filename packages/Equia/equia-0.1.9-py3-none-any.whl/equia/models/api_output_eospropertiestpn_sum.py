...
T = TypeVar("T", bound="ApiOutputEosPropertiesTPnResultSum")


@attr.s(auto_attribs=True)
class ApiOutputEosPropertiesTPnResultSum:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Dump `ApiOutputEosPropertiesTPnResultResidual` instance to a dict."""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        """Load `ApiOutputEosPropertiesTPnResultResidual` instance from a dict."""
        d = src_dict.copy()
