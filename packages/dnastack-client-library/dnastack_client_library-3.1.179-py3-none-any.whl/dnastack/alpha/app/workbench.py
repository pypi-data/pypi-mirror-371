...
class Workbench:
	...
	def get_workflow_descriptor(self, workflow_id: str, workflow_version_id: str) -> WorkflowDescriptor:
		return self._get_workflow_client().get_json_schema(workflow_id, workflow_version_id)
