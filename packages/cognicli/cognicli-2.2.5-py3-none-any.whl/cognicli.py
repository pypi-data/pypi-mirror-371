...
class CogniCLI:
    ...
    def show_logo(self):
        ...
        version_text = Text("v2.2.5 - Premium Edition", style="dim")
...
Examples:
  ...
  cognicli --ollama pull llama2:q4_K_M     # Pull specific quantization
    ...
    parser.add_argument('--version', action='version', version='CogniCLI v2.2.5 - Premium Edition')
    ...
    welcome_content = f"""
[bold {COGNICLI_ACCENT}]Welcome to CogniCLI v2.2.5 Premium![/bold {COGNICLI_ACCENT}] 🚀
