...
class TestStreamingHilbertIndexGenerator:
    ...
    def test_integrated_mapping(self):
        ...
        assert stats['total_values_processed'] == 1024  # Padded to fit dimensions
    ...
    def test_edge_cases(self):
        ...
        # Empty image
        empty_result = generator.generate_optimized_indices(np.array([]).reshape(0, 0), 100)
...
class TestConfigurationIntegration:
    ...
    def test_streaming_configuration(self):
        ...
        config = QuantizationConfig(
            use_streaming_indices=True,
            streaming_max_levels=8,
            streaming_memory_efficient=True
        )
    ...
    def test_traditional_configuration(self):
        ...
        config = QuantizationConfig(use_streaming_indices=False)
...
class TestPerformanceComparison:
    ...
    def test_method_comparison(self):
        ...
        trad_config = QuantizationConfig(use_streaming_indices=False)
        trad_generator = HierarchicalIndexGeneratorImpl(trad_config)
        
        # Streaming generator
        stream_config = QuantizationConfig(use_streaming_indices=True)
