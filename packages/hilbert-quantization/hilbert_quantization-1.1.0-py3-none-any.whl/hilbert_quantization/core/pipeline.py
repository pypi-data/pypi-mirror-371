...
# from .optimized_index_generator import OptimizedIndexGenerator  # Not implemented yet
...
class QuantizationPipeline:
    ...
    def __init__(self,
                 ...
                 use_optimized_indexing: bool = True):
        """
        ...
        Args:
            ...
            use_optimized_indexing: Whether to use generator-based optimization
        """
        ...
        if use_optimized_indexing and index_generator is None:
        ...
        self.use_optimized_indexing = use_optimized_indexing
    ...
    def quantize_model(self,
        ...
        try:
            ...
            # Use integrated mapping approach if optimized index generator is available
            if (self.use_optimized_indexing and 
