...
class ClientResolver:
    ...
    def __init__(self, client: httpx.Client | None = None):
        self.client = client or httpx.Client(
            headers={
                "User-Agent": "resolvematrix/0.1.0",
    ...
    def get_client_versions(self, base_url: str) -> bool:
        """
    ...
    def get_well_known(self, server_name: str, msc4299: bool = False) -> typing.Any:
        """
        ...
        return limited_read(response, 50 * 1024 if msc4299 else self.RESPONSE_SIZE_LIMIT, self.RESPONSE_CHUNK_SIZE)
    ...
    def resolve(self, server_name: str, extra_validation: bool = True, unstable_follow_redirects: bool = False) -> str:
        ...
        try:
            ...
            well_known = self.get_well_known(hostname, unstable_follow_redirects)
