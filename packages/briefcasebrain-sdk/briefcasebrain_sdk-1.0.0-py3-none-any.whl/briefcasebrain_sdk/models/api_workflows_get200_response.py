...
class ApiWorkflowsGet200Response(BaseModel):
    """
    ApiWorkflowsGet200Response
    """ # noqa: E501
    workflows: Optional[List[Workflow]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["workflows", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiWorkflowsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiWorkflowsGet200Response from a dict"""
        if obj is None:
            return None
