...
CosmosDbAuthStrategy = Literal['ConnectionString', 'DefaultCredential']
...
class CosmosDBUtils:
    ...
    def create_collection(self, partition_key_path: str) -> ContainerProxy:
        ...
        return self.get_database().create_container_if_not_exists(
    ...
    def get_single_item(self, item_id: str, partition_key: Any | None = None) -> Dict[str, Any]:
        ...
        return container_proxy.read_item(item=item_id, partition_key=partition_key)
    ...
    def create_item(self, item: dict) -> Dict[str, Any]:
    ...
    def upsert_item(self, item: dict) -> Dict[str, Any]:
    ...
    def delete_item(self, item: dict[str, Any] | str, partition_key: Any) -> Dict[str, Any]:
    ...
    def query_container(
        ...
        """
        container_proxy = self.get_collection()
        return container_proxy.query_items(
            query,
