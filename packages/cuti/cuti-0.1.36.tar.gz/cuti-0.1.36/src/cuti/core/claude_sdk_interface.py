    ...
    def _verify_installation(self):
        ...
        try:
            ...
            if result.returncode != 0:
                raise RuntimeError(
                    "Claude Code CLI not available. Please install: npm install -g @anthropic-ai/claude-code@latest"
                )
        except FileNotFoundError:
            raise RuntimeError(
                "Claude Code CLI not found. Please install: npm install -g @anthropic-ai/claude-code@latest"
            )
