...
from sentinel2_geodes.utils import load_config, setup_package_logging
...
def cli(ctx, verbose, config):
    """Sentinel-2 GEODES Processor - Download and process satellite imagery."""
    # Setup logging
...
def info():
    ...
    from sentinel2_geodes import __version__
    from sentinel2_geodes.processing.band_math import BandMath

    click.echo(f"Sentinel-2 GEODES Processor v{__version__}")
    click.echo("\nSupported bands:")
