...
from sentinel2_geodes.cli import cli
...
class TestCLI:
    ...
    def test_cli_help(self, runner):
        ...
        assert 'Sentinel-2 GEODES Processor' in result.output
    ...
    @patch('sentinel2_geodes.cli.Sentinel2Processor')
    ...
    def test_search_command_missing_dates(self, runner, tmp_path):
        ...
        with patch('sentinel2_geodes.cli.Sentinel2Processor'):
            result = runner.invoke(cli, [
                'search',
                str(geojson_path),
                str(tmp_path)
