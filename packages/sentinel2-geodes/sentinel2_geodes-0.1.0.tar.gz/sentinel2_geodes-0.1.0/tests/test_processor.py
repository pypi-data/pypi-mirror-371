...
class TestSentinel2Processor:
    ...
    @patch('sentinel2_geodes.core.processor.Sentinel2Processor.search')
    ...
    @patch('sentinel2_geodes.core.processor.Sentinel2Processor.search')
    @patch('sentinel2_geodes.core.processor.Sentinel2Processor.download')
    @patch('sentinel2_geodes.core.processor.Sentinel2Processor.crop')
...
class TestProcessorConfig:
    ...
    def test_with_config(self, tmp_path):
        ...
        from sentinel2_geodes.utils.config import Config, DefaultsConfig
