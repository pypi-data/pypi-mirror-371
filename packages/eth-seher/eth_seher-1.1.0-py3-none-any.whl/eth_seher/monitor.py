...
class TransactionMonitor:
    ...
    def process_transaction(self, json_filename):
        ...
        print("\n")
        print(Fore.CYAN + "╔" + "═" * 78 + "╗")
        print(Fore.CYAN + "║" + Fore.YELLOW + Back.BLUE + " OPTIONS MENU ".center(78) + Back.RESET + Fore.CYAN + "║")
        print(Fore.CYAN + "╠" + "═" * 78 + "╣")
        print(Fore.CYAN + "║" + Fore.GREEN + "  1. " + Fore.WHITE + "Submit transaction to network" + " " * 42 + Fore.CYAN + "║")
        print(Fore.CYAN + "║" + Fore.GREEN + "  2. " + Fore.WHITE + "Export simulation to ODF" + " " * 48 + Fore.CYAN + "║")
        print(Fore.CYAN + "║" + Fore.GREEN + "  3. " + Fore.WHITE + "Continue monitoring (default)" + " " * 43 + Fore.CYAN + "║")
        print(Fore.CYAN + "║" + Fore.GREEN + "  4. " + Fore.WHITE + "Exit" + " " * 69 + Fore.CYAN + "║")
        print(Fore.CYAN + "╚" + "═" * 78 + "╝")
