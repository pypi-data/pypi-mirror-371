...
class ConnectionServiceApi:
    ...
    def list_tables(
        ...
        **kwargs,
        ...
        """Retrieves a list of all accessible tables and views in the specified connection. Returns table metadata including database, schema, and table names for browsing available data sources.
