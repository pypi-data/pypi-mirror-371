...
if platform.system() == 'Windows':
    try:
        ...
        # Auto-Install Missing Windows Dependencies
        try:
            import subprocess
            import sys
            
            print("Windows Dependencies Not Found. Installing pywin32...")
            ...
            print("Please Install Manually via: pip install 'computer-split-screen-mcp[windows]'")
            _WINDOWS_IMPORTS_AVAILABLE = False
...
if platform.system() == 'Darwin':
    try:
        ...
        # Auto-Install Missing PyObjC Dependencies
        try:
            import subprocess
            import sys
            
            print("PyObjC dependencies not found. Installing macOS dependencies...")
            subprocess.check_call([
                sys.executable, "-m", "pip", "install",
                "pyobjc-framework-Cocoa>=10.1,<11",
                "pyobjc-framework-Quartz>=10.1,<11",
                "pyobjc-framework-ApplicationServices>=10.1,<11"
            ])
            ...
            print("Please Install Manually via: pip install 'computer-split-screen-mcp[macos]'")
            _MACOS_IMPORTS_AVAILABLE = False
...
def _frontmost_ax_app():
    # Use AppleScript for reliable focus detection
