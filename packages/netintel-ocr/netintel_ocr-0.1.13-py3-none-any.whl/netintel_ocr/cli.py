...
def cli():
    parser = argparse.ArgumentParser(
        description="NetIntel-OCR v0.1.13: Convert PDF pages to images and transcribe them to Markdown using local ollama models. "
                    "Supports automatic network diagram detection to Mermaid.js conversion. "
                    "NEW: Use --init to create Docker/Kubernetes deployments for any scale (personal to enterprise).",
