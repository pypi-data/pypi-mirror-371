...
def cli():
    parser = argparse.ArgumentParser(
        prog='netintel-ocr',
        description=f"NetIntel-OCR v{__version__}: Convert PDF pages to images and transcribe them to Markdown using local ollama models. "
                    "Supports automatic network diagram detection to Mermaid.js conversion. "
                    "NEW v0.1.14: High-performance deduplication with C++ core for 50-100x speedup.",
