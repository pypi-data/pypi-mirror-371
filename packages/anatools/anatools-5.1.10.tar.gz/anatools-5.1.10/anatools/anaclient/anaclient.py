...
class client:
    ...
    from .workspaces    import set_workspace, get_workspaces, create_workspace, edit_workspace, delete_workspace, mount_workspaces
    ...
    from .annotations   import get_annotations, get_annotation_formats, get_annotation_maps, create_annotation, download_annotation, delete_annotation , get_annotation_maps, create_annotation_map, edit_annotation_map, delete_annotation_map, download_annotation_map
    ...
    from .editor        import create_remote_development, delete_remote_development, list_remote_development, stop_remote_development, start_remote_development, prepare_ssh_remote_development, remove_ssh_remote_development, invite_remote_development, get_ssh_keys, register_ssh_key, deregister_ssh_key, get_editors, create_editor, delete_editor, invite_editor, start_editor, stop_editor
