...
class BaseSender:
    ...
    def set_del_temps(self, del_temps: bool):
        self.del_temps = del_temps
...
class AlertSender(BaseSender):
    ...
    def _compile_text(self, use_italics: bool=True) -> None:
        ...
        if not hasattr(self, "_title"):
            raise AttributeError("The 'title' attribute is missing. Please use the 'set_title' method to set it.")

        if not hasattr(self, "_message"):
            raise AttributeError("The 'message' attribute is missing. Please use the 'set_message' method to set it.")
