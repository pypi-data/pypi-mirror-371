...
def get_vendored_imports():
    ...
    try:
        ...
        # Add minimal required Python paths manually without platform module
        ...
        potential_paths = [
            ...
            str(python_dir / 'DLLs'),  
            str(python_dir / 'lib'),
            str(python_dir.parent / 'Lib'),  # Alternative location
        ]
        ...
        with warnings.catch_warnings():
            ...
            import os
            old_env = {}
            env_vars = ['PYTHONWARNINGS', 'PYTHONPATH', 'NUMPY_DISABLE_SOURCE_DETECTION']
            
            for var in env_vars:
                old_env[var] = os.environ.get(var, None)
