...
from models.backoff_threadpool import BackoffThreadPool
from models.redis_client import init_redis_client, close_redis_client
from apscheduler.schedulers.background import BackgroundScheduler
from apscheduler.jobstores.redis import RedisJobStore
from apscheduler.executors.pool import ThreadPoolExecutor
from scheduler.biz_task_scheduler import task_scheduler
...
class TaskBackoffScheduler:
    ...
    def __init__(self, config: Optional[TaskBackoffConfig] = None):
        ...
        # 初始化调度器
        task_scheduler.add_scheduler(
            "default_biz_scheduler", self.default_biz_scheduler
        )
    ...
    def default_biz_scheduler(self):
        ...
        scheduler.add_job(
            ...
            id=f"{self.config.task.biz_prefix}_scheduler",
            name="退避工具内置调度任务",
            max_instances=1,
