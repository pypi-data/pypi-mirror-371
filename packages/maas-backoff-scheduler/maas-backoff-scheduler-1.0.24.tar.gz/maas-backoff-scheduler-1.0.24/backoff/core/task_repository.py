...
from backoff.models.repository.storage_adapter import StorageAdapterFactory
...
class TaskRepository:
    ...
    def get_pending_taskIds(self, batch_size: int, service_instance_id: str = "") -> List[str]:
        """
        获取待处理任务
        ...
        try:
            ...
            if service_instance_id:
                ...
                for task_id in task_ids:
                    ...
                    if task and task.service_instance_id == service_instance_id:
