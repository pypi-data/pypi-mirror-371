...
from backoff.common.task_entity import BackoffType, ExecutorType
...
class TaskConfig:
    ...
    task_exec_timeout: int = 300  # 任务超时时间(秒)
    ...
    def from_dict(cls, config_dict: dict):
        return cls(
            ...
            task_exec_timeout=config_dict.get('task_exec_timeout', 300),
...
class ThreadPoolConfig:
    """线程池配置"""
    concurrency: int = 10
    executor_type: str = ExecutorType.THREAD.value  # thread、process
    
    @classmethod
    def from_dict(cls, config_dict: dict):
        return cls(
            concurrency=config_dict.get('concurrency'),
            executor_type=config_dict.get('executor_type', ExecutorType.THREAD.value)
        )
...
class TaskBackoffConfig:
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> "TaskBackoffConfig":
        ...
        threadpool_config = ThreadPoolConfig.from_dict(config_dict.get("threadpool", {}))
