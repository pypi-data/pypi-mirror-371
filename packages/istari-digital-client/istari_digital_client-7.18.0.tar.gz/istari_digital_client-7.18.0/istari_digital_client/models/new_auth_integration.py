...
class NewAuthIntegration(BaseModel):
    ...
    app_integration_id: StrictStr
    auth_type: FunctionAuthType
    revision: FileRevision
    __properties: ClassVar[List[str]] = ["auth_integration_type", "app_integration_id", "auth_type", "revision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "app_integration_id": obj.get("app_integration_id"),
