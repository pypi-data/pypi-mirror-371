...
THEMES = {
    ...
    'enchanted': {
        'name': 'enchanted',
        'colors': {
            'primary': '#FF006E',      # Enchantment pink
            'secondary': '#FB5607',    # Phoenix orange
            'accent': '#FFBE0B',       # Fairy gold
            'neutral': '#8338EC',      # Mystic purple
            'error': '#E01E37',        # Ruby red
            'warning': '#FF9500',      # Sunset orange
            'success': '#95D600',      # Spring green
            'info': '#3A86FF',         # Sky blue
            'emphasis': '#FF4CC4',     # Bright enchantment
            'subtle': '#FFE5F1',       # Soft pink mist
            'distinct': '#C77DFF',     # Lavender magic
            'aether': '#FF10F0',       # Pure magic pink
            'artifact': '#FFD700',     # Treasure gold
            'sylvan': '#7CB518',       # Enchanted forest
            'danger': '#DC2F02',       # Dragon fire
        },
        'generate_variants': True,
    },
