...
impl TryFrom<Buffer> for TimeDomainArray<i16> {
    ...
    fn try_from(value: Buffer) -> Result<Self, Self::Error> {
        match value.cache_buffer {
            nds_cache_rs::buffer::Buffer::Int16(t) => Ok(TimeDomainArray::<i16>::from(t).set_from_buffer_fields(value.fields)),
            _ => {
...
impl TryFrom<Buffer> for TimeDomainArray<i32> {
    ...
    fn try_from(value: Buffer) -> Result<Self, Self::Error> {
        match value.cache_buffer {
            nds_cache_rs::buffer::Buffer::Int32(t) => Ok(TimeDomainArray::<i32>::from(t).set_from_buffer_fields(value.fields)),
            _ => {
...
impl TryFrom<Buffer> for TimeDomainArray<i64> {
    ...
    fn try_from(value: Buffer) -> Result<Self, Self::Error> {
        match value.cache_buffer {
            nds_cache_rs::buffer::Buffer::Int64(t) => Ok(TimeDomainArray::<i64>::from(t).set_from_buffer_fields(value.fields)),
            _ => {
...
impl TryFrom<Buffer> for TimeDomainArray<f32> {
    ...
    fn try_from(value: Buffer) -> Result<Self, Self::Error> {
        match value.cache_buffer {
            nds_cache_rs::buffer::Buffer::Float32(t) => Ok(TimeDomainArray::<f32>::from(t).set_from_buffer_fields(value.fields)),
            t => {
...
impl TryFrom<Buffer> for TimeDomainArray<f64> {
    ...
    fn try_from(value: Buffer) -> Result<Self, Self::Error> {
        match value.cache_buffer {
            nds_cache_rs::buffer::Buffer::Float64(t) => Ok(TimeDomainArray::<f64>::from(t).set_from_buffer_fields(value.fields)),
            nds_cache_rs::buffer::Buffer::Float32(t) => Ok(
...
impl TryFrom<Buffer> for TimeDomainArray<c64> {
    ...
    fn try_from(value: Buffer) -> Result<Self, Self::Error> {
        match value.cache_buffer {
            nds_cache_rs::buffer::Buffer::Complex32(t) => Ok(TimeDomainArray::<c64>::from(t).set_from_buffer_fields(value.fields)),
            _ => {
...
impl TryFrom<Buffer> for TimeDomainArray<u32> {
    ...
    fn try_from(value: Buffer) -> Result<Self, Self::Error> {
        match value.cache_buffer {
            nds_cache_rs::buffer::Buffer::UInt32(t) => Ok(TimeDomainArray::<u32>::from(t).set_from_buffer_fields(value.fields)),
            _ => {
