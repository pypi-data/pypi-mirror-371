...
class AnalysisResult:
    ...
    """
    class Coherence(AnalysisResult):
        __match_args__ = (
            "channel_a",
            "channel_b",
            "value",
        ...
        @property
        def value(self) -> FreqDomainArray: ...
        def __new__(
            cls, channel_a: Channel, channel_b: Channel, value: FreqDomainArray
        ) -> AnalysisResult.Coherence: ...

    class TransferFunction(AnalysisResult):
        __match_args__ = (
            "channel_a",
            "channel_b",
            "value",
        ...
        def __new__(
            cls, channel_a: Channel, channel_b: Channel, value: FreqDomainArray
        ) -> AnalysisResult.TransferFunction: ...

    class ASD(AnalysisResult):
        __match_args__ = (
            "channel",
            "value",
        )
        ...
        def value(self) -> FreqDomainArray: ...
        def __new__(
            cls, channel: Channel, value: FreqDomainArray
        ) -> AnalysisResult.ASD: ...

    class TimeHistoryReal(AnalysisResult):
        __match_args__ = (
            "channel",
            "value",
        )
        ...
        def channel(self) -> Channel: ...
        @property
        def value(self) -> TimeDomainArray: ...
        def __new__(
            cls, channel: Channel, value: TimeDomainArray
        ) -> AnalysisResult.TimeHistoryReal: ...

    class TimeHistoryComplex(AnalysisResult):
        __match_args__ = (
            "channel",
            "value",
        )
        ...
        def __new__(
            cls, channel: Channel, value: TimeDomainArray
        ) -> AnalysisResult.TimeHistoryComplex: ...
    ...
    class Custom(AnalysisResult):
        ...
        def __new__(
            cls,
            channels: typing.Sequence[Channel],
            pipeline_name: builtins.str,
            value: typing.Any,
        ) -> AnalysisResult.Custom: ...
...
class FreqDomainArray:
    ...
    def clone_metadata(self, new_data: typing.Any) -> FreqDomainArray:
        r"""
...
class ResponseToUser:
    ...
    class NewResult(ResponseToUser):
        __match_args__ = ("_0",)
        @property
        def _0(self) -> AnalysisResult: ...
        def __new__(cls, _0: AnalysisResult) -> ResponseToUser.NewResult: ...
        def __len__(self) -> builtins.int: ...
        def __getitem__(self, key: builtins.int) -> typing.Any: ...
    ...
    class ScopeViewResult(ResponseToUser):
        ...
        def __new__(
            cls, id: builtins.int, result: AnalysisResult
...
class TimeDomainArray:
    ...
    def end_gps_pip(self) -> PipInstant:
        ...
        """
    def index_to_gps_pip(self, index: builtins.int) -> PipInstant: ...
