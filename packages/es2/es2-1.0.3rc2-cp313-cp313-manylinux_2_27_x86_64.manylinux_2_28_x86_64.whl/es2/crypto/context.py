...
class Context:
    ...
    dim : int
        The dimension of the context, which should be a power of 2 (e.g., 16, 32, 64, ..., 4096).
    mode : str, optional
        The evaluation mode for the context. Defaults to "rhombus". Options are "none" or "rhombus".
    ...
    def __init__(self, preset: str, dim: int, eval_mode: Optional[str] = None):
        ...
        self._context = evi.make_context(
    ...
    def eval_mode(self) -> str:
        ...
        Returns:
            str: The evaluation mode, either NONE, MS, RHOMBUS, or RMS.
        """
