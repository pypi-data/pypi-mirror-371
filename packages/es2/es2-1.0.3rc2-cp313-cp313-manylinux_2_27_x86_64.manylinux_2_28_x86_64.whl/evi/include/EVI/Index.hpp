 ...
 * Example usage:
 * @code
 *   auto context = evi::makeContext(preset, DeviceType::GPU, 4096, EvalMode::RHOMBUS);
...
class IndexAdapter : public IndexImpl {
    using EvalImpl = std::conditional_t<!(CHECK_RHOMBUS(M)), std::shared_ptr<IndexBase<D, T, M>>,
