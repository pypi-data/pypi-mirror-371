...
protected:
    ...
    SearchResult DO_RHOMBUS_IP(const Index &db, const Query query, ComputeBuffer buffer);

    SearchResult DO_SHARED_A_IP(const Index &db, const Query query, ComputeBuffer buffer);

    SearchResult DO_RHOMBUS_SHARED_A_IP(const Index &db, const Query query, ComputeBuffer buffer);
