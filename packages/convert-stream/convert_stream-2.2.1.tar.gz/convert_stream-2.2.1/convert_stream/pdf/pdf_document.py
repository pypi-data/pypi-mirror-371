...
class ABCDocument(ABC):
    ...
    @abstractmethod
    def add_page(self, page: ModulePagePdf):
        pass

    @abstractmethod
    def add_pages(self, pages: list[ModulePagePdf]):
        pass
...
class ImplementDocumentFitz(ABCDocument):
    ...
    def add_page(self, page: fitz.Page):
        # Assume que page.mod_page é fitz.Page
        self.mod_doc_pdf.insert_pdf(page, from_page=page.number, to_page=page.number)

    def add_pages(self, pages: list[fitz.Page]):
        for page in pages:
            self.add_page(page)
...
class ImplementDocumentPyPdf(ABCDocument):
    ...
    def add_page(self, page: PageObject):
        self.mod_doc_pdf.add_page(page)

    def add_pages(self, pages: list[PageObject]):
        for page in pages:
            self.add_page(page)
