...
class TestBatchAnalyzeIps400ResponseError(unittest.TestCase):
    """BatchAnalyzeIps400ResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchAnalyzeIps400ResponseError:
        """Test BatchAnalyzeIps400ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchAnalyzeIps400ResponseError`
        """
        model = BatchAnalyzeIps400ResponseError()
        if include_optional:
            return BatchAnalyzeIps400ResponseError(
    ...
    def testBatchAnalyzeIps400ResponseError(self):
        """Test BatchAnalyzeIps400ResponseError"""
