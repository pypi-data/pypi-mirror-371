...
```bash
# 1. 저장소 포크
git clone https://github.com/your-username/rfs-framework.git
...
- **🐛 Issues**: [GitHub Issues](https://github.com/rfs-framework/issues)
- **📖 Docs**: [Documentation Site](https://docs.rfs-framework.dev)
...
[![GitHub stars](https://img.shields.io/github/stars/rfs-framework/rfs-v4.svg?style=social&label=Star)](https://github.com/rfs-framework/rfs-v4)
[![GitHub forks](https://img.shields.io/github/forks/rfs-framework/rfs-v4.svg?style=social&label=Fork)](https://github.com/rfs-framework/rfs-v4/fork)
[![Follow on Twitter](https://img.shields.io/twitter/follow/rfs_framework.svg?style=social)](https://twitter.com/rfs_framework)