...
def _to_jsonable(o: Any) -> Any:
    ...
    structures. Datetimes are formatted in ISO with Z suffix.
    """
...
class JsonStore:
    ...
    def data(self) -> Store:
        ...
        This property ensures that data is only loaded from disk when needed,
    ...
    def reload(self):
        ...
        This method clears all caches and reloads the data from disk,
