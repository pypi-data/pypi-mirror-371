<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 155 40">
  <!-- Detailed hound logo -->
  <g transform="translate(5, 37) scale(0.01, -0.01)" fill="#5B6FED">
  ...
  <g font-family="'Inter', system-ui, -apple-system, sans-serif" font-weight="600">
    <text x="42" y="26" font-size="18" fill="#1F2937">Chunk</text><text x="98" y="26" font-size="18" fill="#5B6FED">Hound</text>
  </g>
</svg>
