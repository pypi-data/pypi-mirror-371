<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 155 40">
  <!-- Detailed hound logo duplicate (thicker) -->
  <g transform="translate(-0.25, 37.25) scale(0.0105, -0.0105)" fill="#5B6FED">
  ...
  <!-- Detailed hound logo original -->
  <g transform="translate(0, 37) scale(0.01, -0.01)" fill="#5B6FED">
    <path d="M1755 3604 c-84 -16 -209 -77 -287 -139 -127 -100 -200 -212 -404
    -615 l-129 -254 0 -101 c0 -92 3 -105 33 -170 l33 -71 -41 -89 c-57 -125 -198
    -358 -341 -563 -135 -194 -147 -225 -106 -266 34 -34 95 -36 124 -4 22 25 126
    182 265 403 49 77 121 203 160 280 39 77 71 141 73 142 1 2 53 -20 116 -48
  ...
  <g font-family="'Inter', system-ui, -apple-system, sans-serif" font-weight="600">
    <text x="34" y="26" font-size="18" fill="#1F2937">Chunk</text><text x="89" y="26" font-size="18" fill="#5B6FED">Hound</text>
  </g>
</svg>
