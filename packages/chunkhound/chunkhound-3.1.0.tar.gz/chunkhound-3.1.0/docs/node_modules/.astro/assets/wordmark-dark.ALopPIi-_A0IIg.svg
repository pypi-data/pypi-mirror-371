<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 155 40">
  <!-- Detailed hound logo -->
  <g transform="translate(5, 37) scale(0.01, -0.01)" fill="#7C8FFF">
  ...
  <g font-family="'Inter', system-ui, -apple-system, sans-serif" font-weight="600">
    <text x="42" y="26" font-size="18" fill="#FAFAFA">Chunk</text><text x="98" y="26" font-size="18" fill="#7C8FFF">Hound</text>
  </g>
</svg>
