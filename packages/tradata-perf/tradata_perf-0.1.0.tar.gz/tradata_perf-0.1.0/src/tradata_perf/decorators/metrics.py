...
async def _collect_function_metrics(
    ...
    try:
        ...
        logger.error(f"Failed to collect function metrics: {e}")
...
async def _track_call_metric(
    ...
    try:
        ...
        logger.error(f"Failed to track call metric: {e}")
...
async def _track_duration_metric(
    ...
    try:
        ...
        logger.error(f"Failed to track duration metric: {e}")
...
async def _collect_business_metric(
    ...
    try:
        ...
        logger.error(f"Failed to collect business metric: {e}")
...
async def _increment_performance_counter(
    ...
    try:
        ...
        logger.error(f"Failed to increment performance counter: {e}")
