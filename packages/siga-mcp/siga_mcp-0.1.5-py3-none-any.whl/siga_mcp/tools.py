...
from siga_mcp.constants import MCP_TRANSPORT, TYPE_TO_NUMBER
...
async def buscar_pendencias_lancamentos_atendimentos(
    *,
    ...
    if matricula == "CURRENT_USER":
        ...
        matricula = buscar_matricula_por_ad(ad)
...
async def buscar_todas_os_usuario(
    *,
    matricula: str | Sequence[str] | Literal["CURRENT_USER"] | None = None,
...
async def listar_atendimentos_avulsos(
    *,
    matricula: int | Literal["CURRENT_USER"] = "CURRENT_USER",
    data_inicio: str,
    data_fim: str,
) -> str:
    ...
    **Em caso de erro:**
    ...
    Args:
        matricula (int | Literal["CURRENT_USER"], optional): Matrícula do usuário/analista cujos atendimentos
