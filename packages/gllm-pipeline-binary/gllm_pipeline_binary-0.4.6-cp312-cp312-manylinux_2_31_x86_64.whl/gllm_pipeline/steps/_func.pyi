...
def step(component: Component, input_state_map: dict[str, str], output_state: str | list[str] | None = None, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, emittable: bool = True, name: str | None = None) -> ComponentStep:
    ...
    This will cause the step to execute the Retriever component with the following behavior:
    1. It will pass the `input_query` from the pipeline state to the `query` argument of the Retriever.
    2. It will pass the `top_k` from the runtime configuration to the `top_k` argument of the Retriever.
    3. It will pass the `custom_emitter` to the `event_emitter` argument of the Retriever without modification.
    ...
    Args:
        ...
        fixed_args (dict[str, Any] | None, optional): Fixed arguments to be passed to the component. Defaults to None,
            in which case an empty dictionary is used.
    ...
    '''
def log(message: str, is_template: bool = True, emit_kwargs: dict[str, Any] | None = None, name: str | None = None) -> LogStep:
    ...
    '''
def if_else(condition: ConditionType | Callable[[dict[str, Any]], bool], if_branch: BasePipelineStep | list[BasePipelineStep], else_branch: BasePipelineStep | list[BasePipelineStep], input_state_map: dict[str, str] | None = None, output_state: str | None = None, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> ConditionalStep:
    ...
    ```
    This will cause the step to execute the PositiveComponent if the `input` in the pipeline state is greater than the
    ...
    '''
def switch(condition: ConditionType, branches: dict[str, BasePipelineStep | list[BasePipelineStep]], input_state_map: dict[str, str] | None = None, output_state: str | None = None, default: BasePipelineStep | list[BasePipelineStep] | None = None, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> ConditionalStep:
    ...
    ```
    This will cause the step to execute the SearchComponent if the first part of the `query` in the pipeline state is
    ...
    Returns:
        ConditionalStep: An instance of ConditionalStep configured with the provided parameters.
    '''
def transform(operation: Callable[[dict[str, Any]], Any], input_states: list[str], output_state: str | list[str], runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> StateOperatorStep:
    ...
    ```
    This will cause the step to execute the `sort` operation on the `chunk` in the pipeline state. The result will be
    stored in the pipeline state under the key `output`. The behavior is controlled by the runtime configuration key
    `reverse`.

    Args:
        operation (Callable[[dict[str, Any]], Any]): The operation to execute on the input data.
        input_states (list[str]): List of input state keys required by the operation.
    ...
    '''
def bundle(input_states: list[str], output_state: str | list[str], name: str | None = None) -> StateOperatorStep:
    ...
    Args:
        input_states (list[str]): List of input state keys to be bundled.
    ...
    '''
def guard(condition: ConditionType | Callable[[dict[str, Any]], bool], success_branch: BasePipelineStep | list[BasePipelineStep], failure_branch: BasePipelineStep | list[BasePipelineStep] | None = None, input_state_map: dict[str, str] | None = None, output_state: str | None = None, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> GuardStep:
    ...
    '''
def terminate(name: str | None = None) -> TerminatorStep:
...
def no_op(name: str | None = None) -> NoOpStep:
    ...
    '''
def toggle(condition: ConditionType | Callable[[dict[str, Any]], bool] | str, if_branch: BasePipelineStep | list[BasePipelineStep], input_state_map: dict[str, str] | None = None, output_state: str | None = None, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> ConditionalStep:
    ...
    ```
    This will execute the FeatureComponent only if the value at the key `feature_enabled` in the pipeline state
    (or `enable_feature` in the runtime config) evaluates to True. Otherwise, it will do nothing.
    ...
    Returns:
        ConditionalStep: An instance of ConditionalStep configured with the provided parameters.
    '''
def subgraph(subgraph: Pipeline, input_state_map: dict[str, str] | None = None, output_state_map: dict[str, str] | None = None, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> SubgraphStep:
    ...
    '''
def parallel(branches: list[BasePipelineStep | list[BasePipelineStep]], input_states: list[str] | None = None, squash: bool = True, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> ParallelStep:
    ...
    Important note about input_states:
    1. If input_states is provided, only the keys listed will be passed to the branches
    2. If input_states is None (default), all state keys will be passed to the branches
    3. Each branch is responsible for its own state management once execution begins
    4. For sequential branches (lists of steps), later steps in the branch can still
      access outputs from earlier steps in the same branch

    Args:
        branches (list[BasePipelineStep | list[BasePipelineStep]]):
            List of branches to execute in parallel. Each branch can be a single step
            or a list of steps to execute sequentially.
    ...
    '''
def map_reduce(input_state_map: dict[str, str], output_state: str, map_func: Component | Callable[[dict[str, Any]], Any], reduce_func: Callable[[list[Any]], Any] = ..., runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> MapReduceStep:
    ...
    - A `Component` instance, which will be executed with proper async handling.
    ...
    Usage Examples:
    Example 1: Processing a list of items with an async map function.
    ```python
    ...
    Args:
        input_state_map (dict[str, str]): Mapping of function arguments to pipeline state keys.
