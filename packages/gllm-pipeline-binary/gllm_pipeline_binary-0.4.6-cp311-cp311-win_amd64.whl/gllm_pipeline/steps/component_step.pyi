...
class ComponentStep(BasePipelineStep, HasInputsMixin):
    ...
    def __init__(self, name: str, component: Component, input_state_map: dict[str, str], output_state: str | list[str] | None = None, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None) -> None:
