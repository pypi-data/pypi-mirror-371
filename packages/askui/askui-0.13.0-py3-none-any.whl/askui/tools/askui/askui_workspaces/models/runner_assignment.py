...
class RunnerAssignment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ids", "host", "tags"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RunnerAssignment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RunnerAssignment from a dict"""
        if obj is None:
            return None
