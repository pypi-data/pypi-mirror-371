...
from maleo.soma.schemas.authentication import MandatoryAuthentication
...
class MedicalRoleClientService(MaleoClientService):
    ...
    async def read(
        ...
        *,
        ...
        authentication: MandatoryAuthentication,
            ...
            if result_str is not None:
                ...
                if isinstance(
                    ...
                    ReadMultipleResourceOperationSchema[
                        ...
                        authentication=authentication.to_authentication(),
                    ...
                    ReadSingleResourceOperationSchema[MedicalRoleDataSchema, None](
                        service_context=self._service_context,
                        id=operation_id,
                        context=operation_context,
                        timestamp=OperationTimestamp(
