...
class HistoryClient:
    ...
    def get(
        ...
        *,
    ...
    ) -> models.ResponseEnvelopeHistoricalPnl_:
        """
        Get Pnl History
        ...
        Examples:
        ```py
        client.developer.wallet.pnl.history.get(
            addresses=[
                {
        ...
        _json = to_encodable(
            ...
            dump_with=params._SerializerPayloadHistoricalPnlByWallet,
        )
        return self._base_client.request(
            ...
            json=_json,
            cast_to=models.ResponseEnvelopeHistoricalPnl_,
...
class AsyncHistoryClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.wallet.pnl.history.get(
            addresses=[
                {
                    "address": "125Z6k4ZAxsgdG7JxrKZpwbcS1rxqpAeqM9GSCKd66Wp",
                    "chain": "solana",
