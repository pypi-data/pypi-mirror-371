...
class Erc721TokensClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.AlliumPageTerc721Token_:
        """
        Get Erc721 Tokens

        GET /api/v1/developer/{chain}/raw/erc721-tokens
        ...
        Examples:
        ```py
        client.developer.raw.erc721_tokens.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        ...
        return self._base_client.request(
            method="GET",
            path=f"/api/v1/developer/{chain}/raw/erc721-tokens",
            auth_names=["APIKeyBearer", "APIKeyBearer", "FirebaseAuthBearer"],
            query_params=_query,
            cast_to=models.AlliumPageTerc721Token_,
    ...
    def get(
        ...
        *,
        ...
        GET /api/v1/developer/{chain}/raw/erc721-tokens/{address}
        ...
        Examples:
        ```py
        client.developer.raw.erc721_tokens.get(address="string", chain="abstract")
        ```
        """
        return self._base_client.request(
            method="GET",
            path=f"/api/v1/developer/{chain}/raw/erc721-tokens/{address}",
            auth_names=["APIKeyBearer", "APIKeyBearer", "FirebaseAuthBearer"],
            cast_to=models.Terc721Token,
            request_options=request_options or default_request_options(),
        )


class AsyncErc721TokensClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.raw.erc721_tokens.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(address, type_utils.NotGiven):
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.raw.erc721_tokens.get(address="string", chain="abstract")
        ```
        """
        return await self._base_client.request(
            method="GET",
