...
class Erc20TokensClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.AlliumPageTerc20Token_:
        """
        Get Erc20 Tokens

        GET /api/v1/developer/{chain}/raw/erc20-tokens
        ...
        Examples:
        ```py
        client.developer.raw.erc20_tokens.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        ...
        return self._base_client.request(
            method="GET",
            path=f"/api/v1/developer/{chain}/raw/erc20-tokens",
            auth_names=["APIKeyBearer", "APIKeyBearer", "FirebaseAuthBearer"],
            query_params=_query,
            cast_to=models.AlliumPageTerc20Token_,
    ...
    def get(
        ...
        *,
        ...
        GET /api/v1/developer/{chain}/raw/erc20-tokens/{address}
        ...
        Examples:
        ```py
        client.developer.raw.erc20_tokens.get(address="string", chain="abstract")
        ```
        """
        return self._base_client.request(
            method="GET",
            path=f"/api/v1/developer/{chain}/raw/erc20-tokens/{address}",
            auth_names=["APIKeyBearer", "APIKeyBearer", "FirebaseAuthBearer"],
            cast_to=models.Terc20Token,
            request_options=request_options or default_request_options(),
        )


class AsyncErc20TokensClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.raw.erc20_tokens.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(address, type_utils.NotGiven):
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.raw.erc20_tokens.get(address="string", chain="abstract")
        ```
        """
        return await self._base_client.request(
            method="GET",
