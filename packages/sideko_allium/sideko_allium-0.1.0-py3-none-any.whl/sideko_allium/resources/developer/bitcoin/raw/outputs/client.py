...
class OutputsClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.AlliumPageTOutput_:
        """
        Get Outputs

        GET /api/v1/developer/bitcoin/raw/outputs
        ...
        Examples:
        ```py
        client.developer.bitcoin.raw.outputs.list()
        ```
        """
        _query: QueryParams = {}
        ...
        return self._base_client.request(
            method="GET",
            path="/api/v1/developer/bitcoin/raw/outputs",
            auth_names=["APIKeyBearer", "APIKeyBearer", "FirebaseAuthBearer"],
            query_params=_query,
            cast_to=models.AlliumPageTOutput_,
...
class AsyncOutputsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.bitcoin.raw.outputs.list()
        ```
        """
        _query: QueryParams = {}
        if not isinstance(block_number, type_utils.NotGiven):
