...
class OutputsClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.AlliumPageTMempoolOutput_:
        """
        Get Mempool Outputs

        GET /api/v1/developer/bitcoin/mempool/outputs
        ...
        Examples:
        ```py
        client.developer.bitcoin.mempool.outputs.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        encode_query_param(
        ...
        return self._base_client.request(
            method="GET",
            path="/api/v1/developer/bitcoin/mempool/outputs",
            auth_names=["APIKeyBearer", "APIKeyBearer", "FirebaseAuthBearer"],
            query_params=_query,
            cast_to=models.AlliumPageTMempoolOutput_,
...
class AsyncOutputsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.bitcoin.mempool.outputs.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        encode_query_param(
