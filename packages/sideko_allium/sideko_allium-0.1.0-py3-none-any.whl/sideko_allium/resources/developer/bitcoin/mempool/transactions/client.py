...
class TransactionsClient:
    ...
    def list(
        ...
        *,
        ...
        fetched_at_gte: typing.Union[
            typing.Optional[str], type_utils.NotGiven
        ] = type_utils.NOT_GIVEN,
        fetched_at_lte: typing.Union[
            typing.Optional[str], type_utils.NotGiven
        ] = type_utils.NOT_GIVEN,
        page: typing.Union[
    ...
    ) -> models.AlliumPageTMempoolTransaction_:
        """
        Get Mempool Transactions

        GET /api/v1/developer/bitcoin/mempool/transactions

        Args:
            fetched_at_gte: typing.Optional[str]
            fetched_at_lte: typing.Optional[str]
            page: Page number
            size: Page size
        ...
        Examples:
        ```py
        client.developer.bitcoin.mempool.transactions.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        encode_query_param(
        ...
        if not isinstance(fetched_at_gte, type_utils.NotGiven):
            encode_query_param(
                _query,
                "fetched_at_gte",
                to_encodable(item=fetched_at_gte, dump_with=typing.Optional[str]),
                style="form",
                explode=True,
            )
        if not isinstance(fetched_at_lte, type_utils.NotGiven):
            encode_query_param(
                _query,
                "fetched_at_lte",
                to_encodable(item=fetched_at_lte, dump_with=typing.Optional[str]),
                style="form",
                explode=True,
            )
        ...
        return self._base_client.request(
            method="GET",
            path="/api/v1/developer/bitcoin/mempool/transactions",
            auth_names=["APIKeyBearer", "APIKeyBearer", "FirebaseAuthBearer"],
            query_params=_query,
            cast_to=models.AlliumPageTMempoolTransaction_,
...
class AsyncTransactionsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.bitcoin.mempool.transactions.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        encode_query_param(
