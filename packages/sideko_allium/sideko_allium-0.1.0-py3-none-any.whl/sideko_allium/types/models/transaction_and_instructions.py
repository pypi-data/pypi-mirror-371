...
class TransactionAndInstructions(pydantic.BaseModel):
    """
    ...
    inner_instructions: typing.List[InnerInstruction] = pydantic.Field(
        alias="inner_instructions",
    )
    ...
    mint_to_decimals: TransactionAndInstructionsMintToDecimals = pydantic.Field(
    ...
    sol_amounts: TransactionAndInstructionsSolAmounts = pydantic.Field(
        alias="sol_amounts",
    )
    success: bool = pydantic.Field(
        alias="success",
    )
    token_accounts: TransactionAndInstructionsTokenAccounts = pydantic.Field(
