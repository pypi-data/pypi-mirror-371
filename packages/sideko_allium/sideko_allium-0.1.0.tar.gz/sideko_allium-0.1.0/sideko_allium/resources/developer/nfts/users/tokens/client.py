...
class TokensClient:
    ...
    def list(
        ...
        *,
        ...
        GET /api/v1/developer/nfts/users/{chain}/{address}/tokens

        Args:
            cursor: typing.Optional[str]
            limit: Number of items to return in a response
            address: str
            chain: typing_extensions.Literal["abstract", "apechain", "arbitrum", "avalanche", "base", "berachain", "bsc", "ethereum", "linea", "monad", "polygon", "sei", "solana"]
        ...
        Examples:
        ```py
        client.developer.nfts.users.tokens.list(address="string", chain="abstract")
        ```
        """
        _query: QueryParams = {}
        ...
        return self._base_client.request(
            method="GET",
            path=f"/api/v1/developer/nfts/users/{chain}/{address}/tokens",
...
class AsyncTokensClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.nfts.users.tokens.list(
