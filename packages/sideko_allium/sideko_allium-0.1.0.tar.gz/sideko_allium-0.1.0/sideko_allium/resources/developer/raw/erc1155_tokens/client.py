...
class Erc1155TokensClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.AlliumPageTerc1155Token_:
        """
        Get Erc1155 Tokens

        GET /api/v1/developer/{chain}/raw/erc1155-tokens
        ...
        Examples:
        ```py
        client.developer.raw.erc1155_tokens.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(address, type_utils.NotGiven):
            encode_query_param(
                _query,
                "address",
                to_encodable(item=address, dump_with=typing.Optional[str]),
                style="form",
                explode=True,
            )
        ...
        return self._base_client.request(
            method="GET",
            path=f"/api/v1/developer/{chain}/raw/erc1155-tokens",
            auth_names=["APIKeyBearer", "APIKeyBearer", "FirebaseAuthBearer"],
            query_params=_query,
            cast_to=models.AlliumPageTerc1155Token_,
    ...
    def get(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.Terc1155Token:
        """
        Get Erc1155 Token

        GET /api/v1/developer/{chain}/raw/erc1155-tokens/{address}
        ...
        Examples:
        ```py
        client.developer.raw.erc1155_tokens.get(address="string", chain="abstract")
        ```
        """
        return self._base_client.request(
            method="GET",
            path=f"/api/v1/developer/{chain}/raw/erc1155-tokens/{address}",
            auth_names=["APIKeyBearer", "APIKeyBearer", "FirebaseAuthBearer"],
            cast_to=models.Terc1155Token,
            request_options=request_options or default_request_options(),
        )


class AsyncErc1155TokensClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.raw.erc1155_tokens.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(address, type_utils.NotGiven):
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.raw.erc1155_tokens.get(
            address="string", chain="abstract"
        )
        ```
        """
        return await self._base_client.request(
