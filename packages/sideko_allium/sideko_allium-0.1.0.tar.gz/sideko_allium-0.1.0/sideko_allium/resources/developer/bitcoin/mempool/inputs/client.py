...
class InputsClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.AlliumPageTMempoolInput_:
        """
        Get Mempool Inputs

        GET /api/v1/developer/bitcoin/mempool/inputs
        ...
        Examples:
        ```py
        client.developer.bitcoin.mempool.inputs.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        encode_query_param(
        ...
        return self._base_client.request(
            method="GET",
            path="/api/v1/developer/bitcoin/mempool/inputs",
            auth_names=["APIKeyBearer", "APIKeyBearer", "FirebaseAuthBearer"],
            query_params=_query,
            cast_to=models.AlliumPageTMempoolInput_,
...
class AsyncInputsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.bitcoin.mempool.inputs.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        encode_query_param(
