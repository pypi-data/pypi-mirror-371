...
class InscriptionTransfersClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.AlliumPageTOrdinalsInscriptionTransfer_:
        """
        Get Ordinals Inscription Transfers

        GET /api/v1/developer/bitcoin/ordinals/inscription-transfers
        ...
        Examples:
        ```py
        client.developer.bitcoin.ordinals.inscription_transfers.list(chain="abstract")
        ```
        """
        _query: QueryParams = {}
        encode_query_param(
        ...
        return self._base_client.request(
            method="GET",
            path="/api/v1/developer/bitcoin/ordinals/inscription-transfers",
            auth_names=["APIKeyBearer", "APIKeyBearer", "FirebaseAuthBearer"],
            query_params=_query,
            cast_to=models.AlliumPageTOrdinalsInscriptionTransfer_,
            request_options=request_options or default_request_options(),
        )


class AsyncInscriptionTransfersClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.developer.bitcoin.ordinals.inscription_transfers.list(
            chain="abstract"
        )
        ```
        """
