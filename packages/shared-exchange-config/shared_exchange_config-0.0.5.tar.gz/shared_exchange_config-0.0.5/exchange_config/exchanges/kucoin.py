...
class KucoinConfig(BaseExchangeConfig):
    ...
    @property
    def networks_for_deposit_addresses(self) -> List[str]:
        """Get networks available for deposit addresses."""
        return list(self._config.get("networks_for_deposit_addresses", []))
    
    @networks_for_deposit_addresses.setter
    def networks_for_deposit_addresses(self, value: List[str]):
        """Set networks available for deposit addresses."""
        self._config["networks_for_deposit_addresses"] = list(value) 