...
class BatchNorm(Module):
    ...
    def __init__(self, num_features: int, batch_momentum: float = 0.9, epsilon: float = 1e-5):
        ...
        self.running_mean = ng.zeros((1, num_features), dtype=ng.float32, requires_grad=False)
        self.running_var = ng.ones((1, num_features), dtype=ng.float32, requires_grad=False)
...
class BatchNorm2D(Module):
    ...
    def __init__(self, num_features: int, batch_momentum: float = 0.9, epsilon: float = 1e-5):
        ...
        self.running_mean = ng.zeros((1, num_features, 1, 1), dtype=ng.float32, requires_grad=False)
        self.running_var = ng.ones((1, num_features, 1, 1), dtype=ng.float32, requires_grad=False)
