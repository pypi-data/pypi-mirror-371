...
class BatchNorm(Module):
    ...
    def __init__(self, num_features: int, batch_momentum: float = 0.9, epsilon: float = 1e-5):
        ...
        self.add_parameter(name="running_mean", param=ng.zeros((1, num_features), dtype=ng.float32, requires_grad=False))
        self.add_parameter(name="running_var", param=ng.ones((1, num_features), dtype=ng.float32, requires_grad=False))
...
class BatchNorm2D(Module):
    ...
    def __init__(self, num_features: int, batch_momentum: float = 0.9, epsilon: float = 1e-5):
        ...
        self.add_parameter(name="running_mean", param=ng.zeros((1, num_features, 1, 1), dtype=ng.float32, requires_grad=False))
        self.add_parameter(name="running_var", param=ng.ones((1, num_features, 1, 1), dtype=ng.float32, requires_grad=False))
