"""
Code from https://github.com/taoyds/test-suite-sql-eval/blob/master/evaluation.py
"""
...
from bigcode_eval.tasks.custom_metrics.spider_eval.process_sql import get_schema, Schema, get_sql
from bigcode_eval.tasks.custom_metrics.spider_eval.exec_eval import eval_exec_match
...
def evaluate(gold, predict, db_dir, etype, kmaps, plug_value, keep_distinct, progress_bar_for_each_datapoint):
    ...
    # Update so it works for Spider:
    include_turn_acc = len(glist[0]) > 1
