...
class ShellUsers:
    ...
    def delete(self, *, serverSlug: str, userId: int):
        return req(
            RequestOptions(
                token=self.parent.string_token,
    ...
    def list(self, *, serverSlug: str):
        return req(
            ...
            ListShellUsersResponseType
        )

    def edit(self, *, slug: str, id: int, keys: List[int]):
        return req(
            RequestOptions(
    ...
    def websshToken(self, *, serverSlug: str, username: str):
        return req(
            RequestOptions(
