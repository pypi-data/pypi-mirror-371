...
@click.group(
    ...
    - Synced to GitHub Actions via 'ai-gh-push' command
    - Deployed to AWS Lambda as environment variables
    - Never modified by this CLI (read-only)

    Environment prefixes: STAGING_ (staging), PROD_ (production)
