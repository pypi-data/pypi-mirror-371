...
class PageReplica(Replica):
    ...
    async def as_reply(
        ...
        teleprinter: Discuto = Contextual[Discuto](context)()
        ...
        buttons = [[]]
        buttons_handler = teleprinter.get_buttons_handler()
        ...
        if update.callback_query and update.callback_query.message:
            await teleprinter.bot().edit_message_text(
                chat_id=chat_id,
                message_id=message.message_id,
                text=items_as_text,
            )
            await teleprinter.bot().edit_message_reply_markup(
                chat_id=chat_id,
                message_id=message.message_id,
            ...
            temp_message = await teleprinter.bot().send_message(
                chat_id=chat_id,
                text="...",
            ...
            #############################
            await teleprinter.bot().send_message(
                chat_id=chat_id,
                text=items_as_text,
