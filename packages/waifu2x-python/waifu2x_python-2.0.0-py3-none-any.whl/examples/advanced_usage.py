...
def process_with_custom_model():
    ...
    config = ProcessingConfig(
        executable_path="/path/to/waifu2x-ncnn-vulkan",  # Optional, auto-download if not specified
        model_path="/path/to/custom/models",             # Optional, use default if not specified
