...
public:
    static void csr_strength(const Device& dev, COT_CSRRawMat<_ValT, _IdxT> A, const _ValT * diag, COT_CSRRawMat<_IdxT, _IdxT> S, typename TypeInfo<_ValT>::scalar_type eps, _IdxT row_shift, _IdxT col_shift);
