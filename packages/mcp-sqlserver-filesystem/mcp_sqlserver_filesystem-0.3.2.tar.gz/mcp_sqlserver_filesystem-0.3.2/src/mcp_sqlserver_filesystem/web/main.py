        ...
        <div class="content">
            ...
            <div class="feature-grid">
                <div class="feature-card">
                    <h3>🗄️ SQL 查询结果显示</h3>
                    <p>当AI助手执行SQL查询时，结果将自动显示在UI中。支持表格数据展示、表结构信息显示和大数据集的分页浏览。</p>
                </div>

                <div class="feature-card">
                    <h3>📊 实时数据展示</h3>
                    <p>通过 WebSocket 实现实时通信，SQL查询结果会立即显示，无需用户手动刷新或交互。</p>
                </div>

                <div class="feature-card">
                    <h3>🔍 纯显示界面</h3>
                    <p>UI专门用于结果展示，不包含用户交互功能。文件操作在后台进行，只有SQL操作结果会按需显示。</p>
                </div>

                <div class="feature-card">
                    <h3>🚀 自动启动</h3>
                    <p>支持桌面应用和Web界面两种模式，可通过MCP服务器自动启动，为AI助手提供可视化的数据展示。</p>
                </div>
            </div>
