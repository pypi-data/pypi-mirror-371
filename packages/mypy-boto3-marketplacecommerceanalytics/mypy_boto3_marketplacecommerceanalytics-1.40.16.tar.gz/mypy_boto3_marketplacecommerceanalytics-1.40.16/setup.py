...
setup(
    ...
    description="Type annotations for boto3 MarketplaceCommerceAnalytics 1.40.16 service generated with mypy-boto3-builder 8.11.0",
    classifiers=[
    ...
    keywords="boto3 marketplacecommerceanalytics boto3-stubs type-annotations mypy typeshed autocomplete",
