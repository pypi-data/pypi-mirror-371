...
from friendli_app.cli.backend.settings.schema import (
...
from friendli_app.cli.backend.settings.schema import (
    WorkingContext as WorkingContext,
)
...
class SettingsBackend:
    ...
    def __init__(self, settings_path: Path) -> None:
        ...
        if settings_path.exists():
            self._settings = ApplicationConfig.model_validate_json(settings_path.read_text("utf-8"))
        else:
