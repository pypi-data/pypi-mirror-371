from .imports import QTabWidget,QMainWindow,apiTab,reactRunnerConsole,ContentFinderConsole,clipitTab,windowManagerConsole
...
class abstractIde(QMainWindow):
    def __init__(self):
        ...
        self.apiConsole    = apiTab()                   # independent
