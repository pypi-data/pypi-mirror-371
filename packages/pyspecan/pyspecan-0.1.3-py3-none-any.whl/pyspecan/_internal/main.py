...
def define_args():
    ...
    parser.add_argument("-m", "--mode", default="psd", choices=["psd", "rt"])
...
def main_cli():
    ...
    SpecAn("c", args.mode, args.file, args.dtype, args.nfft, args.Fs, args.cf)

def main_gui():
    args = define_args().parse_args()
    SpecAn("g", args.mode, args.file, args.dtype, args.nfft, args.Fs, args.cf)
