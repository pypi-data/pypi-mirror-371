<a id="types-boto3-comprehend"></a>

# types-boto3-comprehend

[![PyPI - types-boto3-comprehend](https://img.shields.io/pypi/v/types-boto3-comprehend.svg?color=blue)](https://pypi.org/project/types-boto3-comprehend/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-comprehend.svg?color=blue)](https://pypi.org/project/types-boto3-comprehend/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-comprehend)](https://pypistats.org/packages/types-boto3-comprehend)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 Comprehend 1.40.15](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-comprehend docs](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-comprehend](#types-boto3-comprehend)
...
- Install `types-boto3[comprehend]` in your environment:
...
- Install `types-boto3[comprehend]` with services you use in your environment:
...
`types-boto3-comprehend` dependency in production. However, there is an issue
...
`types_boto3_comprehend.paginator` module contains type annotations for all
paginators.
...
from types_boto3_comprehend import ComprehendClient
from types_boto3_comprehend.paginator import (
...
`types_boto3_comprehend.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `Comprehend` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/literals/).
...
`types_boto3_comprehend.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `Comprehend` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/type_defs/).
...
`types-boto3-comprehend` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/)
