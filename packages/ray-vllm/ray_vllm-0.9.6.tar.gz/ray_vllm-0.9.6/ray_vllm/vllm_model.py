...
class VLLMModel:
    ...
    async def create_chat_completion(self, request: ChatCompletionRequest, raw_request: Optional[Request] = None):
    ...
    async def create_chat_completion_internal(self, request: Dict[str, Any]):
        ...
        return await self.create_chat_completion(chat_completion_request)
