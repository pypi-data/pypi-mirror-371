...
from zia import NLCatalogItemCreate, NLIRTaskCreate, Zia
...
async def main():
    ...
    async with Zia(api_key=api_key) as client:
        ...
        try:
            ...
            if not catalog_items:
                ...
                if test_image_path.exists():
                    ...
                    print("   ❌ No test image found. Cannot create test item.")
                    return
        ...
        try:
            ...
            created_task = await client.image_recognition.create_task(task)
        ...
        try:
            ...
            # Get results
            results = await client.image_recognition.get_task_results(
