...
class ColorDetectionConfig(BaseConfig):
    ...
    zone_config: Optional[ZoneConfig] = field(
        default_factory=lambda: ZoneConfig(zones={
            "default_zone": [[69, 428], [886, 390], [1048, 712], [106, 712]]
        })
    )
        ...
        try:
            ...
            while True:
                ...
                for detection in frame_detections:
                    ...
                    zone_polygon = config.zone_config['zones'].get("default_zone") if config.zone_config else None
                    if zone_polygon and not self._is_in_zone(bbox, zone_polygon):
                        continue
