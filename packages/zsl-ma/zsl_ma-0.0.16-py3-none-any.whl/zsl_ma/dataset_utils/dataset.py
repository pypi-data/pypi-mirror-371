...
class FactorLabelMapper:
    def __init__(self, label_maps_dir):
        """
        初始化映射管理器
        ...
        self.class_to_label = self._load_class_to_label(
            os.path.join(label_maps_dir, "classes_to_label.txt")
        )
...
if __name__ == '__main__':
    ...
    train_data = CustomDataset(root_dir=r'D:\Code\2-ZSL\Zero-Shot-Learning\data\split\data\unseen',
                               mode='val',
                               transform=transform)
