<a id="types-boto3-ssm-contacts"></a>

# types-boto3-ssm-contacts

[![PyPI - types-boto3-ssm-contacts](https://img.shields.io/pypi/v/types-boto3-ssm-contacts.svg?color=blue)](https://pypi.org/project/types-boto3-ssm-contacts/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-ssm-contacts.svg?color=blue)](https://pypi.org/project/types-boto3-ssm-contacts/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-ssm-contacts)](https://pypistats.org/packages/types-boto3-ssm-contacts)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 SSMContacts 1.40.15](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-ssm-contacts docs](https://youtype.github.io/types_boto3_docs/types_boto3_ssm_contacts/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-ssm-contacts](#types-boto3-ssm-contacts)
...
- Install `types-boto3[ssm-contacts]` in your environment:
...
- Install `types-boto3[ssm-contacts]` with services you use in your
  environment:
...
`types-boto3-ssm-contacts` dependency in production. However, there is an issue
...
from types_boto3_ssm_contacts import SSMContactsClient
...
`types_boto3_ssm_contacts.paginator` module contains type annotations for all
paginators.
...
from types_boto3_ssm_contacts import SSMContactsClient
from types_boto3_ssm_contacts.paginator import (
...
`types_boto3_ssm_contacts.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `SSMContacts` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_ssm_contacts/literals/).
...
`types_boto3_ssm_contacts.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `SSMContacts` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_ssm_contacts/type_defs/).
...
`types-boto3-ssm-contacts` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_ssm_contacts/)
