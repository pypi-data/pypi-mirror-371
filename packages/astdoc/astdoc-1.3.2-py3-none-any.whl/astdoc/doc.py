...
from astdoc.utils import find_item_by_name, merge_unique_names
...
TYPE_STRING_PATTERN = re.compile(r"\[__astdoc__.(\S+?)\]\[\]")
...
def _create_admonition(name: str, text: str) -> str:
    ...
    return astdoc.markdown.create_admonition(kind, name, text)
