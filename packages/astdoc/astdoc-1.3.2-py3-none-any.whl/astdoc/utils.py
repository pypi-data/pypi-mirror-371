...
def is_dataclass(name: str, module: str) -> bool:
    ...
    Examples:
        ...
        >>> is_dataclass("is_dataclass", "astdoc.utils")
        False
...
def get_base_classes(name: str, module: str) -> list[tuple[str, str]]:
    ...
    Examples:
        >>> base_classes = get_base_classes("Doc", "astdoc.doc")
        >>> base_classes
        [('Item', 'astdoc.doc')]
...
def split_module_name(name: str) -> tuple[str, str | None] | None:
    ...
    Examples:
        'Section' is a member of 'astdoc.doc'

        >>> split_module_name("astdoc.doc.Section")
        ('Section', 'astdoc.doc')

        Entire name is a valid module

        >>> split_module_name("astdoc.doc")
        ('astdoc.doc', None)
