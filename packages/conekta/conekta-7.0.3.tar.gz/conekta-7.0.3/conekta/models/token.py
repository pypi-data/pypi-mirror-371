...
class Token(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "card": TokenCard.from_dict(obj["card"]) if obj.get("card") is not None else None,
            "checkout": TokenCheckout.from_dict(obj["checkout"]) if obj.get("checkout") is not None else None
        })
        return _obj
