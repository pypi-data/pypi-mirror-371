...
class Namespace(Generic[T]):
    ...
    def __init__(self, name: str, filepath: str, serializer: Serializer[T], default_factory: Callable[[], T] | None = None, autosave: bool = False, backup_on_save: bool = False) -> None: ...
    def load(self) -> T: ...
    def save(self) -> None: ...
    def get(self) -> T: ...
...
class ConfigRepo:
    ...
    def register(self, name: str, serializer: Serializer[Any], filename: str | None = None, default_factory: Callable[[], Any] | None = None, autosave: bool = False, backup_on_save: bool = False) -> Namespace[Any]: ...
