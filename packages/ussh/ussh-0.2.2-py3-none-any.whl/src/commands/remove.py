...
@click.command()
@click.option('--alias', '-l', required=True, help='Host alias to remove.', shell_complete=get_host_aliases)
def host(alias):
    config = load_config()
...
@click.command()
@click.option('--alias', '-l', required=True, help='Port alias to remove.', shell_complete=get_port_aliases)
def port(alias):
    config = load_config()
...
@click.command()
@click.option('--alias', '-l', required=True, help='Username alias to remove.', shell_complete=get_username_aliases)
def username(alias):
    config = load_config()
...
@click.command()
@click.option('--alias', '-l', required=True, help='Password alias to remove.', shell_complete=get_password_aliases)
def password(alias):
    config = load_config()
...
@click.command()
@click.option('--alias', '-l', required=True, help='Keypair alias to remove.', shell_complete=get_keypair_aliases)
def keypair(alias):
    config = load_config()
...
@click.command()
@click.option('--alias', '-l', required=True, help='Environment alias to remove.', shell_complete=get_environment_aliases)
