...
def client(request: FixtureRequest) -> Iterator[FluidizeSDK]:
    ...
    with FluidizeSDK(base_url=base_url, api_token=api_token, _strict_response_validation=strict) as client:
        yield client
...
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncFluidizeSDK]:
    ...
    async with AsyncFluidizeSDK(
        base_url=base_url, api_token=api_token, _strict_response_validation=strict, http_client=http_client
    ) as client:
        yield client
