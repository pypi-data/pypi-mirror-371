...
class TestRuns:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_run_metadata_with_all_params(self, client: FluidizeSDK) -> None:
        run = client.runs.get_run_metadata(
            run_number=0,
            id="id",
            description="description",
...
class TestAsyncRuns:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_run_metadata_with_all_params(self, async_client: AsyncFluidizeSDK) -> None:
        run = await async_client.runs.get_run_metadata(
            run_number=0,
            id="id",
            description="description",
