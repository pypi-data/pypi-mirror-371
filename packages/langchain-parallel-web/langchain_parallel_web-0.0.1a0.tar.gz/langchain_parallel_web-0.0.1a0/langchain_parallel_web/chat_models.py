...
class ChatParallelWeb(BaseChatModel):
    ...
    """ParallelWeb chat model integration.

    The default implementation echoes the first `parrot_buffer_length` characters of the input.

    # TODO: Replace with relevant packages, env vars.
    Setup:
        Install ``langchain-parallel-web`` and set environment variable ``PARALLELWEB_API_KEY``.

        .. code-block:: bash

            pip install -U langchain-parallel-web
            export PARALLELWEB_API_KEY="your-api-key"

    # TODO: Populate with relevant params.
    Key init args — completion params:
        model: str
            Name of ParallelWeb model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            ParallelWeb API key. If not passed in will be read from env var PARALLELWEB_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatParallelWeb.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatParallelWeb.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatParallelWeb supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatParallelWeb supports async generation. Otherwise delete.
