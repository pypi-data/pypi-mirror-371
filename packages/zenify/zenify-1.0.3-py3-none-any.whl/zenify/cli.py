...
Examples:
  ...
  zen -s diamond              # Start with diamond shape
  zen -s mandala              # Start with mandala shape
...
Available shapes: diamond, star, wave_flow, tree, crystal, infinity, mandala, labyrinth, yin_yang, spiral, zen_circle
Available presets: 4-7-8, box, equal, custom
    ...
    parser.add_argument('-s', '--shape',
                       choices=['diamond', 'star', 'wave_flow', 'tree', 'crystal', 'infinity', 'mandala', 'labyrinth', 'yin_yang', 'spiral', 'zen_circle'],
