...
def start_meditation_with_params(params, lang):
    ...
    # Set shape function
    shape_map = {
        'diamond': shapes.create_diamond_shape,
        'star': shapes.create_star_shape,
        'wave_flow': shapes.create_wave_flow_shape,
        'tree': shapes.create_tree_shape,
        'crystal': shapes.create_crystal_shape,
        'infinity': shapes.create_infinity_shape,
        'mandala': shapes.create_mandala_shape,
        'labyrinth': shapes.create_labyrinth_shape,
        'yin_yang': shapes.create_yin_yang_shape,
        'spiral': shapes.create_spiral_pattern,
        'zen_circle': shapes.create_zen_circle_shape
    }
    
    if params.get('shape'):
        settings['shape_func'] = shape_map.get(params['shape'], shapes.create_diamond_shape)
    else:
        settings['shape_func'] = shapes.create_diamond_shape
    ...
    if result and result.get("duration", 0) > 0:
        ...
        shape_names = {
            "create_diamond_shape": "diamond",
            "create_star_shape": "star",
            "create_wave_flow_shape": "wave_flow",
            "create_tree_shape": "tree",
            "create_crystal_shape": "crystal",
            "create_infinity_shape": "infinity",
            "create_mandala_shape": "mandala",
            "create_labyrinth_shape": "labyrinth",
            "create_yin_yang_shape": "yin_yang",
            "create_spiral_pattern": "spiral",
