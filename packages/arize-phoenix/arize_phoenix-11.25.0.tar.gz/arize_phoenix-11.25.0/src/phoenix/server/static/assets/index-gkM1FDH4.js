...
`;function ua(){const{theme:l="dark"}=k();return o(f,{styles:g(ga,ca,l==="dark"?ea:ba,na(l),ra,ia,sa,ta,da,ma,pa)})}const fa=h(v(r(a,{path:"/",errorElement:o(n,{}),children:[o(a,{path:"/v1/*",element:o(x,{to:"/",replace:!0})}),o(a,{path:"/login",element:o(L,{})}),o(a,{path:"/logout",element:o(C,{})}),o(a,{path:"/reset-password",element:o(j,{}),loader:R}),o(a,{path:"/reset-password-with-token",element:o(E,{})}),o(a,{path:"/forgot-password",element:o(I,{})}),o(a,{element:o(Ko,{}),loader:D,children:r(a,{element:o(Ho,{}),children:[o(a,{path:"/profile",handle:{crumb:()=>"profile"},element:o(A,{})}),o(a,{index:!0,loader:F}),r(a,{path:"/model",handle:{crumb:()=>"model"},element:o(O,{}),children:[o(a,{index:!0,element:o(t,{})}),o(a,{element:o(t,{}),children:o(a,{path:"dimensions",children:o(a,{path:":dimensionId",element:o(G,{}),loader:T})})}),o(a,{path:"embeddings",children:o(a,{path:":embeddingDimensionId",element:o(_,{}),loader:M,handle:{crumb:l=>l.embedding.name}})})]}),r(a,{path:"/projects",handle:{crumb:()=>"Projects"},element:o(X,{}),children:[o(a,{index:!0,element:o(N,{})}),r(a,{path:":projectId",loader:V,handle:{crumb:l=>l.project.name},element:o(Q,{}),children:[o(a,{index:!0,element:o(q,{})}),r(a,{element:o(J,{}),children:[o(a,{path:"traces",element:o(U,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"spans",element:o(W,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"sessions",element:o(H,{}),children:o(a,{path:":sessionId",element:o($,{}),loader:B})}),o(a,{path:"config",element:o(K,{})}),o(a,{path:"metrics",element:o(Y,{})})]})]})]}),r(a,{path:"/dashboards",handle:{crumb:()=>"Dashboards"},element:o(co,{}),children:[o(a,{index:!0,element:o(oo,{}),loader:Z}),o(a,{path:"projects/:projectId",element:o(lo,{}),loader:ao,handle:{crumb:l=>l.project.name}}),o(a,{path:":dashboardId",handle:{crumb:()=>"dashboard"},element:o(ro,{})})]}),r(a,{path:"/datasets",handle:{crumb:()=>"Datasets"},children:[o(a,{index:!0,element:o(go,{})}),r(a,{path:":datasetId",loader:m,handle:{crumb:l=>l.dataset.name},children:[r(a,{element:o(to,{}),loader:m,children:[o(a,{index:!0,element:o(p,{})}),o(a,{path:"experiments",element:o(p,{})}),o(a,{path:"examples",element:o(no,{}),loader:eo,children:o(a,{path:":exampleId",element:o(bo,{})})}),o(a,{path:"versions",element:o(so,{}),loader:io})]}),o(a,{path:"compare",element:o(po,{}),loader:mo,handle:{crumb:()=>"compare"}})]})]}),r(a,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(a,{index:!0,element:o(uo,{})}),o(a,{path:"spans/:spanId",element:o(ho,{}),loader:fo,handle:{crumb:l=>l.span.__typename==="Span"?`span ${l.span.spanId}`:"span unknown"}})]}),r(a,{path:"/prompts",handle:{crumb:()=>"Prompts"},children:[o(a,{index:!0,element:o(yo,{}),loader:vo}),r(a,{path:":promptId",loader:xo,shouldRevalidate:()=>!0,handle:{crumb:l=>l.prompt.__typename==="Prompt"?l.prompt.name:"unknown"},children:[r(a,{element:o(Ro,{}),children:[o(a,{index:!0,element:o(zo,{})}),o(a,{path:"versions",loader:wo,element:o(So,{}),children:o(a,{path:":versionId",loader:Po,element:o(ko,{})})}),o(a,{path:"config",element:o(Co,{}),loader:Lo})]}),o(a,{path:"playground",element:o(Eo,{}),loader:jo,handle:{crumb:()=>"playground"}})]})]}),o(a,{path:"/apis",element:o(Io,{}),handle:{crumb:()=>"APIs"}}),o(a,{path:"/support",element:o(Do,{}),handle:{crumb:()=>"Support"}}),r(a,{path:"/settings",element:o(Uo,{}),handle:{crumb:()=>"Settings"},children:[o(a,{path:"general",loader:Ao,element:o(Fo,{}),handle:{crumb:()=>"General"}}),o(a,{path:"providers",loader:To,element:o(Go,{}),handle:{crumb:()=>"AI Providers"}}),o(a,{path:"models",loader:Mo,element:o(_o,{}),handle:{crumb:()=>"Models"}}),o(a,{path:"annotations",loader:Oo,element:o(No,{}),handle:{crumb:()=>"Annotations"}}),o(a,{path:"data",element:o(qo,{}),handle:{crumb:()=>"Data Retention"},loader:Vo})]}),o(a,{path:"/redirects/spans/:span_otel_id",loader:Wo,errorElement:o(n,{})}),o(a,{path:"/redirects/traces/:trace_otel_id",loader:Bo,errorElement:o(n,{})}),o(a,{path:"/redirects/sessions/:session_id",loader:$o,errorElement:o(n,{})})]})})]})),{basename:window.Config.basename});function ha(){return o(y,{router:fa})}function va(){return o(Yo,{children:o(Qo,{children:o(ya,{})})})}function ya(){const{theme:l}=Xo();return o(S,{theme:l,mountGlobalStyles:!1,children:r(w.RelayEnvironmentProvider,{environment:Zo,children:[o(ua,{}),o(oa,{children:o(aa,{children:o(Jo,{children:o(z.Suspense,{children:o(la,{children:o(ha,{})})})})})})]})})}const xa=document.getElementById("root"),za=P.createRoot(xa);za.render(o(va,{}));
