...
from pigeon.utils import setup_zipkin_transport
...
class RootMachine(BaseMachine):
    ...
    def stop_all_spans(self):
        for state in reversed(list(self._collect_states())):
            state.stop_span()
