...
This module provides the command-line interface for MyRandr.
"""
...
class MonitorConfigManager:
    ...
    def __init__(self):
        ...
        self.config_dir = Path.home() / '.config' / 'myrandr'
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="MyRandr - Monitor Configuration Manager for GNOME",
