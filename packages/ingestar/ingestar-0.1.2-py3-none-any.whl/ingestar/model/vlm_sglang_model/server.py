...
from .logit_processor import Ingestar2LogitProcessor

# ingestar2.0的chat_template与chatml在换行上有微小区别
...
_custom_logit_processor_str = Ingestar2LogitProcessor().to_str()
